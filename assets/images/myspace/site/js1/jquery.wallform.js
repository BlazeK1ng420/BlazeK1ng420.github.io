...
var exp=/<img[^>]+>/;expResult=data.match(exp);if(expResult==null)
{alert(data);}
else
$(options.target).prepend(data);$("#photoimg").val('');};}};$.fn.ajaxForm=function(options){if(this.length===0){var o={s:this.selector,c:this.context};if(!$.isReady&&o.s){log('DOM not ready, queuing ajaxForm');$(function(){$(o.s,o.c).ajaxForm(options);});return this;}
