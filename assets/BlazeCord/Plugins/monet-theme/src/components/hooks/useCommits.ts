...
//
// query {
//     repository(owner: "nexpid", name: "RelapseMonetTheme") {
...
const refetch = async () => {
	const commits = await safeFetch(
		"https://api.github.com/repos/nexpid/RelapseMonetTheme/commits?path=patches.jsonc",
		{
			cache: "no-store",
		},
	)
