import { logger } from "@relapse";
import { getDebugInfo } from "@relapse/debug";
import {
	clipboard,
	NavigationNative,
	React,
...
export function setColorsFromDynamic(clr: RelapseSysColors) {
	vstorage.colors = {
					...
					>
						{(props: any) => (
							<Commit
								...
								onPress={() =>
									navigation.push("RelapseCustomPage", {
										render: CommitsPage,
									})}
								contextProps={props}
							/>
