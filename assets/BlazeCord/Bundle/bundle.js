...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context16 = (0, import_react11.useContext)(HighlightContext);
    if (!context16) {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "4f4928494e3ee2ea3f25ba4bda85c43081510c50";
      branch = "IcOnS!";
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(module3, patcher16) {
              ...
              patcher16.instead(module3, "getIcons", () => mainIcons);
              patcher16.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher16.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
  ...
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings2 = definePluginSettings9({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher13.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      ...
      var settings3 = getPluginSettings(id);
      if (settings3 && pluginPatch2.predicate) {
        var { predicate } = pluginPatch2;
        var unsub = settings3.subscribe(() => predicate(), () => {
          if (predicate()) {
            apply();
          } else {
  ...
  function initializePlugins() {
    ...
    var { startPlugin: startPlugin2, settings: settings3 } = usePluginStore.getState();
    for (var id in PLUGINS) {
      if (settings3[id].enabled) {
        startPlugin2(id);
      }
    }
  }
  ...
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger19 = blzlogger.createChild("PluginStore");
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_parser2();
      logger21 = blzlogger.createChild("ThemeStore");
