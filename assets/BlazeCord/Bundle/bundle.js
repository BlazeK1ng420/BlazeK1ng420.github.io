...
${log.errorStack}`;
  ...
  function useShallow(selector) {
    var prev = import_react9.default.useRef();
    return (state2) => {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "a9bec3637a6fd168d3779585d64b53917f279c50";
      branch = "FuckNitro";
...
(${discord.build})`,
  ...
  var import_react16, settings_default;
      ...
      nitro_emojis_default = definePlugin4({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patchRealmoji(module3, patcher18, () => settings2.get().realshit);
            }
          }
        ],
        start() {
