        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger24 = new Logger2(name);
              logger24.parent = this;
              logger24.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger24;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger24) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger24.logHandlers.size > 0) {
                  for (var handler of logger24.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger24.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger24) => {
                logger24.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger24) => {
                logger24.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger24) => {
                if (logger24 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger24.logHandlers.has(handler)) {
                    logger24.logHandlers.delete(handler);
                  }
                }
              });
...
${log.errorStack}`;
  ...
  function LogsPage() {
    var [showDebug, setShowDebug] = (0, import_react6.useState)(false);
    var filteredLogs = (0, import_react6.useMemo)(() => {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsx(import_flash_list2.FlashList, {
        data: filteredLogs,
        ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native14.ScrollView, {
          contentContainerStyle: {
            gap: 12,
            paddingVertical: 12
          },
  ...
  var import_flash_list2, import_react6, import_react_native14;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
  ...
  function DemoToastComponent(props) {
    var [count, setCount] = (0, import_react7.useState)(0);
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react7.useState)({
      id: "toast-demo",
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native15.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast.update({
  ...
  var import_react7, import_react_native15, logger4;
  ...
  function AssetBrowser() {
    ...
    var assets = (0, import_react8.useMemo)(() => sortAssets(getAssets()).filter((a) => a.name.toLowerCase().includes(ref.query.toLowerCase()) || a.id.toString() === ref.query), [
      ref.query
    ]);
  ...
  var import_react8, import_react_native16, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native16.useWindowDimensions)().width - 24;
        var imageSize = {
  ...
  function useShallow(selector) {
    var prev = import_react9.default.useRef(void 0);
    return (state2) => {
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native17.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list4, import_react_native17;
  ...
  function DemoAlert() {
    var [understood, setUnderstood] = (0, import_react10.useState)(false);
  ...
  function useHighlight() {
    var context18 = (0, import_react11.useContext)(HighlightContext);
    if (!context18) {
  ...
  function ToastIcon({ icon }) {
    ...
    if (/* @__PURE__ */ (0, import_react12.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react12.useState)(false);
  ...
  var import_react12, import_react_native20;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_10575445024011_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx1","translationX","translationY","__closure","transform","translateX","value","translateY"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAwC0C,SAAAA,UAAA,QAAAC,YAAA,CAAAC,YAAA,OAAAC,SAAA,OAAK,CACnCC,SAAS,CAAE,CACP,CACIC,UAAU,CAAEJ,YAAY,CAACK,KAC7B,CAAC,CACD,CACIC,UAAU,CAAEL,YAAY,CAACI,KAC7B,CAAC,CAET,CAAC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12707892542287_init_data = {
      ...
      _worklet_2394815801719_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx3","event","translationX","__closure","value","changeX"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDwG,SAAAA,SAAQA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,CACxGD,YAAY,CAACE,KAAK,EAAIH,KAAK,CAACI,OAAO,CACvC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1148071943580_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12633554293434_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx5","finished","willDisappear","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AA+D8D,SAAAA,UAAQC,QAAG,QAAAC,aAAA,CAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CAC7D,GAAIJ,QAAQ,EAAIC,aAAa,CAAE,CAC3BC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1700014798715_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx8","finished","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAuEuE,SAAAA,UAAQC,QAAG,QAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CACtE,GAAIH,QAAQ,CAAE,CACVC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
      Toast_default = /* @__PURE__ */ (0, import_react13.memo)(/* @__PURE__ */ __name(function Toast({
        toast
      }) {
        ...
        var onceOnDismiss = (0, import_react13.useCallback)(() => {
          toast.onDismiss?.();
          hideToast(toast.id);
        }, [hideToast, toast]);
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3, "type", (_, res) => {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "51a41b2e12d07071cfdd8057abdb85f2eca5b9f8";
      branch = "main";
  ...
  function getVersions() {
    ...
    return {
      ...
      react: {
        version: import_react14.default.version
      },
      reactNative: {
  ...
  var import_react14, import_react_native23;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  // src/components/Blaze/Settings/pages/Blaze/InfoCard.tsx
  ...
  // src/components/Blaze/Settings/pages/Blaze/ClientInfoSheet.tsx
  ...
  function openURL(url) {
    import_react_native25.Linking.openURL(url);
  }
  ...
  function UpdaterPage() {
    ...
    (0, import_react15.useEffect)(() => void check(), []);
    return /* @__PURE__ */ jsxs(PageWrapper, {
      scrollable: true,
      containerStyle: {
        paddingTop: 16,
  ...
  var import_react_native26, import_react15;
  ...
  // src/components/Blaze/Settings/pages/Blaze/index.tsx
  var Blaze_exports = {};
...
(${discord.build})`,
  ...
  var import_react16, settings, settings_default;
      ...
      settings_default = definePlugin2({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3, "default", (_, ret) => {
                ...
                if (!settings.get().onTop) {
                  try {
                    ...
                    logger6.warn`Failed to insert settings sections next to account section: ${e3}`;
                  }
                }
                props.sections = [
                  ..._registeredSettingSections,
            ...
            registerSettingSection({
              ...
              settings: [
                registerSettingRenderer("BLAZECORD", {
                  ...
                  screen: {
                    route: "BLAZECORD",
                    getComponent: /* @__PURE__ */ __name(() => (init_Blaze(), __toCommonJS(Blaze_exports)).default, "getComponent")
                  }
                }),
        ...
        patches: [
          {
            ...
            patch(_, patcher18) {
              patcher18.after(window, "sampleMethod", () => {
  ...
  function patchRealmoji(module3, patcher18, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher18.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher18.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      init_parse();
      init_realshit();
      settings3 = definePluginSettings4({
        emojiSize: {
          type: "slider",
          label: "Display Size",
          points: [
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher18.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher18) {
              patcher18.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patchRealmoji(module3, patcher18, () => settings3.get().realshit);
            }
          }
        ],
        start() {
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native33.View, {
          style: styles.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native33.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native33.View, {
          style: styles.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native33.View, {
              style: styles.rowContainer,
              children: [
                /* @__PURE__ */ jsx(import_react_native33.Image, {
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native33.View, {
              style: styles.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native33.View, {
          style: styles.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native33.View, {
              style: styles.rowContainer,
  ...
  var import_react_native33, import_react_native_reanimated2, useStyles4;
  ...
  var import_react17, getMaxEmojiSlots;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native34.Keyboard.dismiss();
      ...
      children: /* @__PURE__ */ jsxs(import_react_native35.ScrollView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native35.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native35, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native37.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native37.Dimensions.get("window");
  ...
  var import_react18, expression_utils_default;
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher18.detached.after(props.header, "type", (_2, res) => {
                  (0, import_react18.useEffect)(() => unpatchReactionsHeader, []);
                  try {
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              ...
              patcher18.instead(module3, "getIcons", () => mainIcons);
              patcher18.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher18.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              ...
              patcher18.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var import_react_native38, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native38.processColor)(args[2]))
          ], "configure")
        }
      });
    }
  ...
  var settings4, chat_bubbles_default;
      ...
      chat_bubbles_default = definePlugin11({
        ...
        start() {
          ...
          var getBubbleColor = /* @__PURE__ */ __name(() => {
            var userColor = settings4.get().bubbleChatColor;
          ...
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            var { avatarRadius, bubbleChatRadius } = settings4.get();
  ...
  var import_react19, import_react_native40;
  ...
  var import_react20, import_react_native41;
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.after(module3.prototype, "render", function() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher18) {
              patcher18.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher18) {
              patcher18.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  // plugins-importer:/home/blaze/coding/discord/blazecord/src/plugins
  var plugins_exports = {};
  __export(plugins_exports, {
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger21.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger21.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger21.warn(`${plugin.$id} already started`);
      return;
    }
    logger21.debug(`Starting plugin '${plugin.$id}'`);
    try {
      applyPluginPatches(id, plugin);
      draft.states[id].running = true;
      plugin.start?.();
    } catch (e3) {
      logger21.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher18 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger21.debug(`Applying ${patcher18.id} patch`);
        patcher18.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher18);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger21.debug(`Disposing ${patcher18.id} patch`);
            patcher18.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger21.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger21.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger21.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher18 = getContextualPatcher(id, false);
      if (patcher18) {
        patcher18.dispose();
        patcher18.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger21.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger21, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger21 = blzlogger.createChild("PluginStore");
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher18 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher18.parent = this;
        this.children.push(patcher18);
        return patcher18;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher18);
    return patcher18;
  }
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger22.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native43.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native43, tokensModule, determineColorReference;
  ...
  var logger23, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger23 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta18 = a.asAddonMetadata();
              return meta18.name.localeCompare(meta18.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "components/Blaze/Settings/pages/Blaze/": createModuleProxy(() => (init_Blaze(), __toCommonJS(Blaze_exports))),
        "components/Blaze/Settings/pages/Blaze/ClientInfoSheet": createModuleProxy(() => (init_ClientInfoSheet(), __toCommonJS(ClientInfoSheet_exports))),
        "components/Blaze/Settings/pages/Blaze/InfoCard": createModuleProxy(() => (init_InfoCard(), __toCommonJS(InfoCard_exports))),
