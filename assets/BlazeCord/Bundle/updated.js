...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context15 = (0, import_react11.useContext)(HighlightContext);
    if (!context15) {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "ca52bab06cd3a2ffbdad52b4a6e7e91f73154906";
      branch = "main";
...
${inspect({
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher12.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger18 = blzlogger.createChild("PluginStore");
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger20 = blzlogger.createChild("ThemeStore");
