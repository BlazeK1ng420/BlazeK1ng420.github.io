...
(() => {
  ...
  function _extends() {
    return _extends = Object.assign ? Object.assign.bind() : /* @__PURE__ */ __name(function _extends2(n3) {
      for (var e3 = 1; e3 < arguments.length; e3++) {
        var t4 = arguments[e3];
        for (var r4 in t4) ({}).hasOwnProperty.call(t4, r4) && (n3[r4] = t4[r4]);
      }
      return n3;
    }, "_extends"), _extends.apply(null, arguments);
  }
  ...
  function FastImageBase({
    ...
    if (fallback) {
      ...
      var resolvedSource = import_react_native12.Image.resolveAssetSource(cleanedSource);
      return /* @__PURE__ */ import_react6.default.createElement(import_react_native12.View, {
        style: [
          styles.imageContainer,
          style
        ],
        ref: forwardedRef
      }, /* @__PURE__ */ import_react6.default.createElement(import_react_native12.Image, _extends({}, props, {
        style: [
    ...
    var resolvedSource1 = import_react_native12.Image.resolveAssetSource(source);
    ...
    return /* @__PURE__ */ import_react6.default.createElement(import_react_native12.View, {
      ...
      ref: forwardedRef
    }, /* @__PURE__ */ import_react6.default.createElement(FastImageView, _extends({}, props, {
      tintColor,
      style: import_react_native12.StyleSheet.absoluteFill,
      source: resolvedSource1,
  ...
  var import_react6, import_react_native12, resizeMode, priority, cacheControl, resolveDefaultSource, FastImageMemo, FastImageComponent, FastImage, styles, FastImageView, dist_default;
  var init_dist2 = __esm({
    "node_modules/react-native-fast-image/dist/index.js"() {
      ...
      resolveDefaultSource = /* @__PURE__ */ __name((defaultSource) => {
        if (!defaultSource) {
          return null;
        }
        if (import_react_native12.Platform.OS === "android") {
          var resolved = import_react_native12.Image.resolveAssetSource(defaultSource);
          if (resolved) {
            return resolved.uri;
          }
          return null;
      ...
      __name(FastImageBase, "FastImageBase");
      FastImageMemo = /* @__PURE__ */ (0, import_react6.memo)(FastImageBase);
      FastImageComponent = /* @__PURE__ */ (0, import_react6.forwardRef)((props, ref) => /* @__PURE__ */ import_react6.default.createElement(FastImageMemo, _extends({
        forwardedRef: ref
      }, props)));
      ...
      FastImage.preload = (sources) => import_react_native12.NativeModules.FastImageView.preload(sources);
      FastImage.clearMemoryCache = () => import_react_native12.NativeModules.FastImageView.clearMemoryCache();
      FastImage.clearDiskCache = () => import_react_native12.NativeModules.FastImageView.clearDiskCache();
      styles = import_react_native12.StyleSheet.create({
        imageContainer: {
          overflow: "hidden"
        }
      });
      FastImageView = (0, import_react_native12.requireNativeComponent)("FastImageView", FastImage, {
        nativeOnly: {
  ...
  function WallpaperPreviewSheet({ wallpaper: initialWallpaper }) {
    var { applyWallpaper, deleteWallpaper, categories } = useWallpaperStore();
    var [isProcessing, setIsProcessing] = (0, import_react7.useState)(false);
    var [previewSettings, setPreviewSettings] = (0, import_react7.useState)({
      blur: initialWallpaper.blur ?? 0,
      opacity: initialWallpaper.opacity ?? 1
    });
    var handleApply = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        setIsProcessing(true);
        yield applyWallpaper({
          ...initialWallpaper,
    ...
    var handleDelete = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        setIsProcessing(true);
        var category = categories.find((cat) => cat.wallpapers.some((w) => w.name === initialWallpaper.name));
        if (category) {
          yield deleteWallpaper(category.name, initialWallpaper.name);
    ...
    var blurStyle = import_react_native13.Platform.select({
      ios: {
        shadowColor: "#000",
    ...
    return /* @__PURE__ */ jsxs(import_react_native13.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(import_react_native13.View, {
          ...
          children: /* @__PURE__ */ jsx(dist_default, {
            source: {
              uri: initialWallpaper.image
            },
            style: [
        ...
        /* @__PURE__ */ jsxs(import_react_native13.View, {
          style: styles2.controlsContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native13.View, {
              style: styles2.sliderGroup,
              children: [
                /* @__PURE__ */ jsxs(Text_default, {
                  children: [
                    "Opacity: ",
                    previewSettings.opacity.toFixed(1)
                  ]
                }),
                /* @__PURE__ */ jsx(Slider_default, {
                  value: previewSettings.opacity,
                  onValueChange: /* @__PURE__ */ __name((val) => setPreviewSettings((p2) => ({
                    ...p2,
                    opacity: val
                  })), "onValueChange"),
                  minimumValue: 0.1,
            ...
            /* @__PURE__ */ jsxs(import_react_native13.View, {
              ...
              children: [
                /* @__PURE__ */ jsxs(Text_default, {
                  children: [
                    "Blur: ",
                    previewSettings.blur.toFixed(0),
                    "px"
                  ]
                }),
                /* @__PURE__ */ jsx(Slider_default, {
            ...
            /* @__PURE__ */ jsxs(import_react_native13.View, {
              ...
              children: [
                ...
                !initialWallpaper.isBuiltin && /* @__PURE__ */ jsx(Button_default, {
                  text: "Delete",
                  color: "danger",
  ...
  var import_react_native14, NativeDocumentPicker;
  var init_NativeDocumentPicker = __esm({
    "node_modules/react-native-document-picker/lib/module/NativeDocumentPicker.js"() {
      import_react_native14 = __toESM(require_react_native());
      NativeDocumentPicker = import_react_native14.TurboModuleRegistry.getEnforcing("RNDocumentPicker");
    }
  });
  ...
  var import_react_native15, import_invariant, types, E_DOCUMENT_PICKER_CANCELED, E_DOCUMENT_PICKER_IN_PROGRESS, module_default;
  var init_module2 = __esm({
    "node_modules/react-native-document-picker/lib/module/index.js"() {
      ...
      types = perPlatformTypes[import_react_native15.Platform.OS];
  ...
  var import_react_native16, NativeDocumentPicker2;
  var init_NativeDocumentPicker2 = __esm({
    "node_modules/@react-native-documents/picker/lib/module/spec/NativeDocumentPicker.js"() {
      "use strict";
      import_react_native16 = __toESM(require_react_native(), 1);
      NativeDocumentPicker2 = import_react_native16.TurboModuleRegistry.getEnforcing("RNDocumentPicker");
    }
  });
  ...
  var import_react_native17, mimeTypes2, utis2, perPlatformTypes2, types2;
  var init_fileTypes2 = __esm({
    "node_modules/@react-native-documents/picker/lib/module/fileTypes.js"() {
      ...
      types2 = perPlatformTypes2[import_react_native17.Platform.OS];
    }
  });
  ...
  function saveDocuments(options) {
    return _async_to_generator(function* () {
      var writeDocumentResponse = yield (() => _async_to_generator(function* () {
        if (import_react_native20.Platform.OS === "android") {
  ...
  function AddWallpaperSheet() {
    var [category, setCategory] = (0, import_react8.useState)("");
    var [name, setName] = (0, import_react8.useState)("");
    var [image, setImage] = (0, import_react8.useState)(null);
    var [opacity, setOpacity] = (0, import_react8.useState)(1);
    var [blur, setBlur] = (0, import_react8.useState)(0);
    ...
    var handlePickImage = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        if (module_exports2?.pickSingle) {
          ...
          if (file) {
            if (!file.uri) {
              import_react_native21.Alert.alert("Error", "Failed to get file URI");
              return;
            }
            setImage({
              uri: file.uri,
        ...
        import_react_native21.Alert.alert("Error", "Failed to select image");
      }
    })(), "handlePickImage");
    var handleAdd = /* @__PURE__ */ __name(() => {
      if (!image || !category || !name) return;
      if (!image.uri) {
        import_react_native21.Alert.alert("Error", "Invalid image URI");
        return;
      }
      ...
      children: /* @__PURE__ */ jsxs(import_react_native21.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Button_default, {
            ...
            style: styles3.selectButton
          }),
          image && /* @__PURE__ */ jsxs(import_react_native21.Text, {
            style: styles3.imageInfo,
            children: [
              "Selected: ",
              image.name
            ]
          ...
          /* @__PURE__ */ jsxs(import_react_native21.View, {
            ...
            children: [
              /* @__PURE__ */ jsxs(import_react_native21.Text, {
                children: [
                  "Opacity: ",
                  opacity.toFixed(1)
                ]
  ...
  function WallpaperManager() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native22.ScrollView, {
      ...
      children: [
        ...
        categories.map((category) => /* @__PURE__ */ jsxs(import_react_native22.View, {
          style: styles4.categoryContainer,
          children: [
            /* @__PURE__ */ jsx(Text_default, {
              variant: "heading-sm/semibold",
              style: styles4.categoryTitle,
              children: category.name
            }),
            /* @__PURE__ */ jsx(import_react_native22.ScrollView, {
              horizontal: true,
              showsHorizontalScrollIndicator: false,
              children: category.wallpapers.map((wallpaper) => /* @__PURE__ */ jsxs(import_react_native22.TouchableOpacity, {
                onPress: /* @__PURE__ */ __name(() => showSheet("WallpaperPreviewSheet", WallpaperPreviewSheet, {
                  wallpaper
                }), "onPress"),
                style: styles4.wallpaperThumb,
                children: [
                  /* @__PURE__ */ jsx(import_react_native22.Image, {
                    source: {
                      uri: wallpaper.image
                    },
                    style: styles4.thumbnail
                  }),
                  /* @__PURE__ */ jsx(Text_default, {
                    variant: "text-xs/medium",
                    style: styles4.wallpaperName,
  ...
  var import_react9, import_react_native22, styles4;
...
${log.errorStack}`;
  ...
  function LogsPage() {
    var [showDebug, setShowDebug] = (0, import_react10.useState)(false);
    var filteredLogs = (0, import_react10.useMemo)(() => {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsx(import_flash_list2.FlashList, {
        data: filteredLogs,
        ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native25.ScrollView, {
          contentContainerStyle: {
            gap: 12,
            paddingVertical: 12
          },
  ...
  var import_flash_list2, import_react10, import_react_native25;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast2 = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native26.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast2.update({
  ...
  var import_react11, import_react_native26, logger4;
  ...
  function AssetBrowser() {
    ...
    var assets = (0, import_react12.useMemo)(() => sortAssets(getAssets()).filter((a) => a.name.toLowerCase().includes(ref.query.toLowerCase()) || a.id.toString() === ref.query), [
      ref.query
    ]);
  ...
  var import_react12, import_react_native27, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native27.useWindowDimensions)().width - 24;
        var imageSize = {
          ...
          children: /* @__PURE__ */ jsxs(Stack_default, {
            children: [
              /* @__PURE__ */ jsx(import_react_native27.View, {
                ...
                children: /* @__PURE__ */ jsx(import_react_native27.Image, {
                  source: asset.id,
                  style: imageSize,
                  resizeMode: "contain"
                })
  ...
  function useShallow(selector) {
    var prev = import_react13.default.useRef(void 0);
    return (state2) => {
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native28.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list4, import_react_native28;
  ...
  function HighlightProvider({ children, result, searchTerms }) {
    var contextValue = (0, import_react15.useMemo)(() => ({
      result,
      searchTerms
    }), [
      result,
  ...
  function useHighlight() {
    var context25 = (0, import_react15.useContext)(HighlightContext);
    if (!context25) {
  ...
  function useHighlightedSearchTerm(index) {
    ...
    return (0, import_react15.useCallback)((textProps) => {
  ...
  var import_react15, HighlightContext;
  var init_SearchTermHighlight = __esm({
    "src/components/Blaze/Settings/pages/Addon/SearchTermHighlight.tsx"() {
      ...
      HighlightContext = /* @__PURE__ */ (0, import_react15.createContext)(null);
  ...
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        ListHeaderComponent: /* @__PURE__ */ jsxs(import_react_native30.View, {
          style: {
            gap: 8
          },
          children: [
  ...
  var import_react_native30, ItemSeparator;
  var init_Addon = __esm({
    "src/components/Blaze/Settings/pages/Addon/index.tsx"() {
      ...
      init_SearchTermHighlight();
      init_loader();
      ItemSeparator = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native30.View, {
        style: {
          height: 8
        }
      }), "ItemSeparator");
  ...
  function ToastIcon({ icon }) {
    ...
    if (typeof icon === "number" || typeof icon === "object" && "uri" in icon) {
      return /* @__PURE__ */ jsx(import_react_native31.Image, {
        style: {
          width: 18,
          height: 18
        },
    ...
    if (/* @__PURE__ */ (0, import_react16.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast: toast2 }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react16.useState)(false);
  ...
  var import_react16, import_react_native31;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react17.memo)(/* @__PURE__ */ __name(function Toast({
        toast: toast2
      }) {
        var styles5 = useStyles2();
        var {
          width
        } = (0, import_react_native32.useWindowDimensions)();
        ...
        var onceOnDismiss = (0, import_react17.useCallback)(() => {
          toast2.onDismiss?.();
          hideToast(toast2.id);
        }, [hideToast, toast2]);
        ...
        return /* @__PURE__ */ jsx(import_react_native_gesture_handler.GestureDetector, {
          ...
          children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
            ...
            children: /* @__PURE__ */ jsx(PressableScale_default, {
              ...
              children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
                layout: import_react_native_reanimated.LinearTransition.springify(500).dampingRatio(0.5),
                style: [animatedStyles, styles5.container, toast2.contentContainerStyle],
                children: /* @__PURE__ */ jsx(import_react_native32.View, {
                  style: styles5.contentContainer,
  ...
  var import_react_native33, isDiscordToastActive;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "abf6a8aeb878c74833834145ed6c698df2bf62c4";
      branch = "wallpapers";
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native34.Platform.constants.reactNativeVersion;
    ...
    return {
      ...
      react: {
        version: import_react18.default.version
      },
      reactNative: {
  ...
  function getAndroidDebugInfo() {
    var PlatformConstants = import_react_native34.Platform.constants;
    return {
      os: {
        name: "Android",
  ...
  function getDebugInfo() {
    return {
      ...getVersions(),
      ...import_react_native34.Platform.select({
        android: getAndroidDebugInfo(),
        ios: getIOSDebugInfo()
      })
    };
  }
  var import_react18, import_react_native34;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native35.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native35.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  function openURL(url) {
    import_react_native36.Linking.openURL(url);
  }
  ...
  function UpdaterPage() {
    ...
    (0, import_react19.useEffect)(() => void check(), []);
    return /* @__PURE__ */ jsxs(PageWrapper, {
      scrollable: true,
      containerStyle: {
        paddingTop: 16,
  ...
  var import_react_native37, import_react19;
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(import_react_native39.View, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(import_react_native39.View, {
              ...
              children: authors?.length && /* @__PURE__ */ jsxs(import_react_native39.View, {
                style: styles5.devsPill,
                children: [
  ...
  var import_react_native39, showUserProfileActionSheet, useStyles3, maybeFetchUser;
  ...
  function StringOptionRow({ opt, plugin, settingKey, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      label: /* @__PURE__ */ jsxs(import_react_native40.View, {
        style: {
          paddingHorizontal: 6,
          gap: 4
        },
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native41.View, {
          ...
          children: /* @__PURE__ */ jsx(Slider_default, {
            ...
            startIcon: /* @__PURE__ */ jsx(import_react_native41.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex - 1), "onPress"),
              children: /* @__PURE__ */ jsx(CircleMinusIcon, {})
            }),
            endIcon: /* @__PURE__ */ jsx(import_react_native41.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex + 1), "onPress"),
  ...
  function OptionSection({ plugin }) {
    ...
    return /* @__PURE__ */ jsx(InfoSection, {
      ...
      children: /* @__PURE__ */ jsx(import_react_native42.View, {
        style: {
          gap: 12
        },
        children: options.map((group, i2) => /* @__PURE__ */ jsx(import_react_native42.View, {
          children: group.map(([key, opt], i3) => /* @__PURE__ */ jsx(import_react_native42.View, {
  ...
  var import_react20, settings_default;
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native44.View, {
          style: styles5.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native44.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native44.View, {
          style: styles5.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native44.View, {
              style: styles5.rowContainer,
              children: [
                /* @__PURE__ */ jsx(import_react_native44.Image, {
                  source: findAssetId("CheckmarkLargeBoldIcon"),
                  style: styles5.checkmarkIcon
                }),
                /* @__PURE__ */ jsx(Text_default, {
                  variant: "text-lg/semibold",
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native44.View, {
              style: styles5.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native44.View, {
          style: styles5.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native44.View, {
              style: styles5.rowContainer,
  ...
  var import_react_native44, import_react_native_reanimated2, useStyles4;
  ...
  var import_react21, getMaxEmojiSlots;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native45.Keyboard.dismiss();
  ...
  function EmoteStealerActionSheet({ emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(BottomSheet_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native46.ScrollView, {
        style: {
          gap: 12
        },
        children: [
          /* @__PURE__ */ jsx(import_react_native46.View, {
            ...
            children: /* @__PURE__ */ jsxs(Text_default, {
              ...
              children: [
                ...
                ":",
                "  ",
                /* @__PURE__ */ jsx(import_react_native46.Image, {
                  resizeMode: "contain",
                  source: {
                    uri: emojiNode.src
                  },
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native46.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native46, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native48.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native48.Dimensions.get("window");
  ...
  var import_react22, expressions_default;
            ...
            patch(module3, patcher25) {
              patcher25.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher25.detached.after(props.header, "type", (_2, res) => {
                  (0, import_react22.useEffect)(() => unpatchReactionsHeader, []);
                  try {
  ...
  var View33, traverseAndModify, unpatchRender, spaces_in_channels_default;
  var init_spaces_in_channels2 = __esm({
    "src/plugins/spaces-in-channels/index.ts"() {
      ...
      spaces_in_channels_default = definePlugin9({
        ...
        start() {
          unpatchRender = after(View33, "render", (_, res) => {
  ...
  var import_react_native49, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native49.processColor)(args[2]))
          ], "configure")
        }
      });
    }
  ...
  function CollapsibleHandler({ collapsed, setCollapsed, onCopy }) {
    ...
    return /* @__PURE__ */ jsxs(import_react_native50.View, {
      style: {
        gap: 8,
        flexDirection: "row",
        justifyContent: "center",
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native50.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native51.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native51.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native51.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  function ErrorStackCard(props) {
    var [collapsed, setCollapsed] = (0, import_react24.useState)(true);
    var stack;
    try {
    ...
    return /* @__PURE__ */ jsx(Card_default, {
      children: /* @__PURE__ */ jsxs(import_react_native52.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native52.View, {
            style: {
              gap: 4
            },
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react24.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native52.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react24, import_react_native52;
  ...
  function ErrorBoundaryScreen(props) {
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        style: styles5.container,
        children: [
          /* @__PURE__ */ jsxs(import_react_native53.View, {
            style: {
              gap: 4
            },
            children: [
  ...
  var import_react_native53, useStyles5;
  ...
  function ChatBackgroundWrapper({ children }) {
    ...
    return /* @__PURE__ */ jsx(import_react_native54.ImageBackground, {
      source: {
        uri: bg.uri
      },
  ...
  function patchChatBackground() {
    patcher17.after(Messages, "render", (_, ret) => {
      ...
      if (node && bg?.opacity != null) {
        var flat = import_react_native54.StyleSheet.flatten(node.props.style);
  ...
  var import_react25, import_react_native54, Messages;
...
${inspect({
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native55.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native55, tokensModule, determineColorReference;
  var init_parser2 = __esm({
    "src/plugins/_core/painter/parser.ts"() {
      "use strict";
      import_react_native55 = __toESM(require_react_native(), 1);
      init_libraries();
      init_wrappers();
      init_parser();
