...
(() => {
  ...
  var import_react_native15, import_invariant, types, E_DOCUMENT_PICKER_CANCELED;
  ...
  function AddWallpaperSheet() {
    ...
    var handlePickImage = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        setError("");
        var result = yield pickSingle({
          type: [
            types.images
          ],
          copyTo: "documentDirectory"
        });
        if (!result.uri) throw new Error("No file selected");
        var exists = yield fileExists(result.uri);
        if (!exists) throw new Error("Cannot access selected file");
        var finalUri = import_react_native16.Platform.OS === "android" && !result.uri.startsWith("file://") ? `file://${result.uri}` : result.uri;
        setImage({
          uri: finalUri,
    ...
    var handleAdd = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      if (!image || !category.trim() || !name.trim()) {
        setError("Please fill all fields");
        return;
      }
      try {
        var exists = yield fileExists(image.uri);
        if (!exists) throw new Error("Image file no longer available");
    ...
    return /* @__PURE__ */ jsx(BottomSheet_default, {
      children: /* @__PURE__ */ jsxs(import_react_native16.View, {
        ...
        children: [
          error ? /* @__PURE__ */ jsx(import_react_native16.Text, {
          ...
          image && /* @__PURE__ */ jsx(import_react_native16.Image, {
            source: {
              uri: image.uri
            },
  ...
  var import_react8, import_react_native16, styles3;
  var init_AddWallpaperSheet = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet.tsx"() {
      ...
      styles3 = import_react_native16.StyleSheet.create({
        container: {
          padding: 16,
          gap: 12
        },
  ...
  function WallpaperManager() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native17.ScrollView, {
      ...
      children: [
        ...
        categories.map((category) => /* @__PURE__ */ jsxs(import_react_native17.View, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(import_react_native17.ScrollView, {
              ...
              children: category.wallpapers.map((wallpaper) => /* @__PURE__ */ jsxs(import_react_native17.TouchableOpacity, {
  ...
  var import_react9, import_react_native17, styles4;
  var init_Wallpapers = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/index.tsx"() {
      ...
      styles4 = import_react_native17.StyleSheet.create({
        container: {
          padding: 16
        },
        categoryContainer: {
...
${log.errorStack}`;
  ...
  var import_flash_list2, import_react10, import_react_native20;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast2 = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native21.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast2.update({
  ...
  var import_react11, import_react_native21, logger4;
  ...
  var import_react12, import_react_native22, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetDisplay = /* @__PURE__ */ __name(({ asset, start, end }) => /* @__PURE__ */ jsx(TableRow_default, {
        ...
        trailing: /* @__PURE__ */ jsx(import_react_native22.Image, {
          source: asset.id,
          style: {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native22.useWindowDimensions)().width - 24;
        var imageSize = {
          ...
          children: /* @__PURE__ */ jsxs(Stack_default, {
            children: [
              /* @__PURE__ */ jsx(import_react_native22.View, {
                ...
                children: /* @__PURE__ */ jsx(import_react_native22.Image, {
                  source: asset.id,
                  style: imageSize,
                  resizeMode: "contain"
                })
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native23.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list4, import_react_native23;
  ...
  var import_react16, import_react_native26;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "9185006c3e8066fd76a89963da2c71fbefe58998";
      branch = "wallpapers";
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native29.Platform.constants.reactNativeVersion;
  ...
  function getAndroidDebugInfo() {
    var PlatformConstants = import_react_native29.Platform.constants;
    return {
      os: {
        name: "Android",
  ...
  function getDebugInfo() {
    return {
      ...getVersions(),
      ...import_react_native29.Platform.select({
        android: getAndroidDebugInfo(),
        ios: getIOSDebugInfo()
      })
    };
  }
  var import_react18, import_react_native29;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native30.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native30.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  function openURL(url) {
    import_react_native31.Linking.openURL(url);
  }
  ...
  var import_react_native32, import_react19;
...
(${discord.build})`,
  ...
  var import_react_native34, showUserProfileActionSheet, useStyles3, maybeFetchUser;
  ...
  function StringOptionRow({ opt, plugin, settingKey, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      label: /* @__PURE__ */ jsxs(import_react_native35.View, {
        style: {
          paddingHorizontal: 6,
          gap: 4
        },
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native36.View, {
          ...
          children: /* @__PURE__ */ jsx(Slider_default, {
            ...
            startIcon: /* @__PURE__ */ jsx(import_react_native36.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex - 1), "onPress"),
              children: /* @__PURE__ */ jsx(CircleMinusIcon, {})
            }),
            endIcon: /* @__PURE__ */ jsx(import_react_native36.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex + 1), "onPress"),
  ...
  function OptionSection({ plugin }) {
    ...
    return /* @__PURE__ */ jsx(InfoSection, {
      ...
      children: /* @__PURE__ */ jsx(import_react_native37.View, {
        ...
        children: options.map((group, i2) => /* @__PURE__ */ jsx(import_react_native37.View, {
          children: group.map(([key, opt], i3) => /* @__PURE__ */ jsx(import_react_native37.View, {
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native39.View, {
          style: styles5.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native39.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native39.View, {
          style: styles5.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native39.View, {
              style: styles5.rowContainer,
              children: [
                /* @__PURE__ */ jsx(import_react_native39.Image, {
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native39.View, {
              style: styles5.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native39.View, {
          style: styles5.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native39.View, {
              style: styles5.rowContainer,
  ...
  var import_react_native39, import_react_native_reanimated2, useStyles4;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native40.Keyboard.dismiss();
      ...
      children: /* @__PURE__ */ jsxs(import_react_native41.ScrollView, {
        ...
        children: [
          /* @__PURE__ */ jsx(import_react_native41.View, {
            ...
            children: /* @__PURE__ */ jsxs(Text_default, {
              ...
              children: [
                ...
                ":",
                "  ",
                /* @__PURE__ */ jsx(import_react_native41.Image, {
                  resizeMode: "contain",
                  source: {
                    uri: emojiNode.src
                  },
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native41.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native41, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native43.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native43.Dimensions.get("window");
  ...
  var import_react_native44, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native44.processColor)(args[2]))
          ], "configure")
        }
      });
    }
  ...
  var import_react23, import_react_native46;
  ...
  var import_react24, import_react_native47;
  ...
  var import_react_native48, useStyles5;
  ...
  var import_react25, import_react_native49, Messages;
...
${inspect({
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native50.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native50, tokensModule, determineColorReference;
