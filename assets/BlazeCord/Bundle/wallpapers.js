...
(() => {
  ...
  var init_wallpaperStore = __esm({
    "src/plugins/_core/wallpapers/stores/wallpaperStore.ts"() {
      ...
      useWallpaperStore = create(persist((set2, get) => ({
        ...
        applyWallpaper: /* @__PURE__ */ __name((wallpaper) => {
          set2({
  ...
  function WallpaperPreviewSheet({ wallpaper: initialWallpaper }) {
    ...
    var closeSheet = (0, import_react6.useCallback)(() => hideSheet("WallpaperPreviewSheet"), []);
    (0, import_react6.useEffect)(() => {
      var backHandler = import_react_native12.BackHandler.addEventListener("hardwareBackPress", () => {
        closeSheet();
        return true;
      });
      return () => backHandler.remove();
    ...
    var handleAction = /* @__PURE__ */ __name((action, toastMsg) => _async_to_generator(function* () {
      try {
    ...
    var handleApply = /* @__PURE__ */ __name(() => handleAction(() => {
      applyWallpaper({
        ...initialWallpaper,
        blur: previewSettings.blur,
        opacity: previewSettings.opacity
      });
    }, "Wallpaper applied!"), "handleApply");
    var handleClear = /* @__PURE__ */ __name(() => handleAction(clearWallpaper, "Wallpaper cleared"), "handleClear");
    var handleDelete = /* @__PURE__ */ __name(() => handleAction(() => {
    ...
    }, "Wallpaper deleted"), "handleDelete");
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "edd92065ffcf3691b0f9404bb8b7e07066123c71";
      branch = "wallpapers";
