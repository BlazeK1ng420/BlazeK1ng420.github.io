    ...
    return /* @__PURE__ */ jsxs(import_react_native14.ScrollView, {
      ...
      children: [
        /* @__PURE__ */ jsxs(import_react_native14.View, {
          style: styles3.headerBar,
          children: [
            /* @__PURE__ */ jsx(import_react_native14.Text, {
              style: styles3.headerTitle,
              children: "Wallpapers"
            }),
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "b35b593c185c3e5b0a45b688369d848d7c7d0e07";
      branch = "WallpaperS";
