...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "7fb8dccdb93a3302f5e3179be6401742acf4085d";
      branch = "WallpaperS";
...
${inspect({
  ...
  function ChatBackgroundWrapper({ children }) {
    ...
    return /* @__PURE__ */ jsx(import_react_native46.ImageBackground, {
      source: {
        uri: bg.uri
      },
  ...
  function patchChatBackground() {
    patcher14.after(Messages, "render", (_, ret) => {
      ...
      if (node && bg?.opacity != null) {
        var flat = import_react_native46.StyleSheet.flatten(node.props.style);
  ...
  var import_react24, import_react_native46, Messages;
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native47.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native47, tokensModule, determineColorReference;
