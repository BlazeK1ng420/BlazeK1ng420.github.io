...
(() => {
        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger32 = new Logger2(name);
              logger32.parent = this;
              logger32.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger32;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger32) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger32.logHandlers.size > 0) {
                  for (var handler of logger32.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger32.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger32) => {
                logger32.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger32) => {
                logger32.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger32) => {
                if (logger32 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger32.logHandlers.has(handler)) {
                    logger32.logHandlers.delete(handler);
                  }
                }
              });
  ...
  var byProps, byName, byFilePath, bySingularProp, byWriteableProp, byStoreName;
  ...
  function lookupAll(filter) {
    var results = [];
    for (var { resolved } of _iterateModule(filter, true)) {
      results.push(resolved);
    }
    return results;
  }
  function lookupLazy(filter) {
    var module3 = new SingleMetroModule(filter);
    var lazyContext = new LazyModuleContext(module3);
    return lazyContext.proxy();
  }
  function iterateModules(filter) {
  ...
  var init_api = __esm({
    "src/metro/api.ts"() {
      ...
      __name(lookupAll, "lookupAll");
      __name(lookupLazy, "lookupLazy");
      __name(iterateModules, "iterateModules");
    }
  });
  ...
  __export(wrappers_exports, {
    ...
    lookupByFilePathAll: () => lookupByFilePathAll,
    lookupByFilePathLazy: () => lookupByFilePathLazy,
    lookupByName: () => lookupByName,
    lookupByNameAll: () => lookupByNameAll,
    lookupByNameLazy: () => lookupByNameLazy,
    lookupByProps: () => lookupByProps,
    lookupByPropsAll: () => lookupByPropsAll,
    lookupByPropsLazy: () => lookupByPropsLazy,
    lookupByStoreName: () => lookupByStoreName,
    lookupByStoreNameAll: () => lookupByStoreNameAll,
    lookupByStoreNameLazy: () => lookupByStoreNameLazy
  });
  var lookupByProps, lookupByPropsAll, lookupByPropsLazy, lookupByName, lookupByNameAll, lookupByNameLazy, lookupByStoreName, lookupByStoreNameAll, lookupByStoreNameLazy, lookupByFilePath, lookupByFilePathAll, lookupByFilePathLazy;
  var init_wrappers = __esm({
    "src/metro/common/wrappers.ts"() {
      "use strict";
      init_filters2();
      init_api();
      lookupByProps = /* @__PURE__ */ __name((...props) => lookup(byProps(props)), "lookupByProps");
      lookupByPropsAll = /* @__PURE__ */ __name((...props) => lookupAll(byProps(props)), "lookupByPropsAll");
      lookupByPropsLazy = /* @__PURE__ */ __name((...props) => lookupLazy(byProps(props)), "lookupByPropsLazy");
      lookupByName = /* @__PURE__ */ __name((name) => lookup(byName(name)), "lookupByName");
      lookupByNameAll = /* @__PURE__ */ __name((name) => lookupAll(byName(name)), "lookupByNameAll");
      lookupByNameLazy = /* @__PURE__ */ __name((name) => lookupLazy(byName(name)), "lookupByNameLazy");
      lookupByStoreName = /* @__PURE__ */ __name((name) => lookup(byStoreName(name)), "lookupByStoreName");
      lookupByStoreNameAll = /* @__PURE__ */ __name((name) => lookupAll(byStoreName(name)), "lookupByStoreNameAll");
      lookupByStoreNameLazy = /* @__PURE__ */ __name((name) => lookupLazy(byStoreName(name)), "lookupByStoreNameLazy");
      lookupByFilePath = /* @__PURE__ */ __name((path, options) => lookup(byFilePath(path, options)), "lookupByFilePath");
      lookupByFilePathAll = /* @__PURE__ */ __name((path, options) => lookupAll(byFilePath(path, options)), "lookupByFilePathAll");
      lookupByFilePathLazy = /* @__PURE__ */ __name((path, options) => lookupLazy(byFilePath(path, options)), "lookupByFilePathLazy");
    }
  });
  ...
  // src/data/BlazecordIcon.tsx
  var BlazecordIcon_exports = {};
  __export(BlazecordIcon_exports, {
    BlazecordIcon: () => BlazecordIcon,
    default: () => BlazecordIcon_default
  });
  var import_react_native4, BlazecordIcon, BlazecordIcon_default;
  var init_BlazecordIcon = __esm({
    "src/data/BlazecordIcon.tsx"() {
      "use strict";
      init_jsxRuntime();
      import_react_native4 = __toESM(require_react_native(), 1);
      BlazecordIcon = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native4.Image, {
      ...
      BlazecordIcon_default = BlazecordIcon;
    }
  });
  ...
  __export(icons_exports, {
    ...
    FiltersHorizontalIcon: () => FiltersHorizontalIcon,
    FireIcon: () => FireIcon,
    FlagIcon: () => FlagIcon,
    FlashIcon: () => FlashIcon,
    FoodIcon: () => FoodIcon,
    GifIcon: () => GifIcon,
    GridSquareIcon: () => GridSquareIcon,
    ...
    ImageSavedIcon: () => ImageSavedIcon,
    ImagesFileIcon: () => ImagesFileIcon,
  ...
  var ActivitiesIcon, ArrowSmallLeftIcon, AnalyticsIcon, AnnouncementsIcon, AtIcon, AttachmentIcon, BeakerIcon, BicycleIcon, BillIcon, BugIcon, BookmarkIcon, BoostTier1Icon, BoostTier2Icon, BoostTier3Icon, CircleCheckIcon, CircleInformationIcon, CircleMinusIcon, CirclePlusIcon, CircleQuestionIcon, CircleWarningIcon, CircleXIcon, DownloadIcon, DragIcon, EducationIcon, EyeIcon, FileUpIcon, FiltersHorizontalIcon, FireIcon, FlagIcon, FlashIcon, FoodIcon, GifIcon, GridSquareIcon, ImageIcon, ImagesIcon, ImagesFileIcon, ImagePlusIcon, ImageSavedIcon, HammerIcon, HashmarkIcon, HeartIcon, HomeIcon, HourglassIcon, LettersIcon, LinkIcon, ListViewIcon, MagicWandIcon, MagnifyingGlassIcon, MedalIcon, MenuIcon, MoreHorizontalIcon, MoreVerticalIcon, NatureIcon, NewUserIcon, NitroWheelIcon, ObjectIcon, PaintbrushThinIcon, PaintPaletteIcon, PaperIcon, PaperPlusIcon, PencilIcon, PencilSparkleIcon, PiggyBankIcon, PuzzlePieceIcon, RetryIcon, RefreshIcon, SettingsIcon, SignPostIcon, SlashIcon, SparkleIcon, StampIcon, StaffBadgeIcon, StarIcon, StarShootingIcon, StickerIcon, SuperReactionIcon, ThemeDarkIcon, ThemeLightIcon, ThemeMidnightIcon, TimerIcon, TrashIcon, TreehouseIcon, TopicsIcon, UploadIcon, WarningIcon, WebhookIcon, WrenchIcon;
  var init_icons = __esm({
    "src/metro/common/icons.ts"() {
      ...
      AnnouncementsIcon = getIcon("AnnouncementsIcon");
      AtIcon = getIcon("AtIcon");
      AttachmentIcon = getIcon("AttachmentIcon");
      BeakerIcon = getIcon("BeakerIcon");
      BicycleIcon = getIcon("BicycleIcon");
      BillIcon = getIcon("BillIcon");
      ...
      FileUpIcon = getIcon("FileUpIcon");
      FiltersHorizontalIcon = getIcon("FiltersHorizontalIcon");
      ...
      GridSquareIcon = getIcon("GridSquareIcon");
      ImageIcon = getIcon("ImageIcon");
      ImagesIcon = getIcon("ImagesIcon");
      ImagesFileIcon = getIcon("ImagesFileIcon");
      ImagePlusIcon = getIcon("ImagePlusIcon");
      ImageSavedIcon = getIcon("toast_image_saved");
      ...
      ListViewIcon = getIcon("ListViewIcon");
      MagicWandIcon = getIcon("MagicWandIcon");
      MagnifyingGlassIcon = getIcon("MagnifyingGlassIcon");
      MedalIcon = getIcon("MedalIcon");
      MenuIcon = getIcon("MenuIcon");
      MoreHorizontalIcon = getIcon("MoreHorizontalIcon");
      MoreVerticalIcon = getIcon("MoreVerticalIcon");
      NatureIcon = getIcon("NatureIcon");
      NewUserIcon = getIcon("NewUserIcon");
      NitroWheelIcon = getIcon("NitroWheelIcon");
      ...
      UploadIcon = getIcon("UploadIcon");
      WarningIcon = getIcon("WarningIcon");
      WebhookIcon = getIcon("WebhookIcon");
  ...
  // src/components/Blaze/Settings/pages/PageWrapper.tsx
    ...
    "src/plugins/_core/wallpapers/stores/wallpaperStore.ts"() {
      ...
      useWallpaperStore = create()(persist((set2, get) => ({
        ...
        deleteWallpaper: /* @__PURE__ */ __name((categoryName, name) => set2((state2) => {
          var updatedCategories = state2.categories.map((cat) => cat.name === categoryName ? {
            ...cat,
            wallpapers: cat.wallpapers.filter((w) => w.name !== name || w.isBuiltin)
          } : cat);
          var finalCategories = updatedCategories.filter((cat) => cat.wallpapers.length > 0 || cat.wallpapers.some((w) => w.isBuiltin));
          return {
        ...
        setCategories: /* @__PURE__ */ __name((categories) => set2({
          categories
        }), "setCategories"),
  ...
  // src/components/Blaze/Settings/pages/Wallpapers/WallpaperPreviewScreen.tsx
  var WallpaperPreviewScreen_exports = {};
  __export(WallpaperPreviewScreen_exports, {
    default: () => WallpaperPreviewScreen
  });
  function WallpaperPreviewScreen({ wallpaper }) {
    ...
    var exponentialBlur = /* @__PURE__ */ __name((value) => {
      return Math.pow(value, 1.5);
    }, "exponentialBlur");
    var sliderToBlur = /* @__PURE__ */ __name((blur) => {
      return Math.pow(blur, 1 / 1.5);
    }, "sliderToBlur");
    var [sliderValue, setSliderValue] = (0, import_react6.useState)(sliderToBlur(blurAmount));
    var handleSliderChange = /* @__PURE__ */ __name((value) => {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs(import_react_native13.View, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(Button_default, {
                  text: "Back",
                  onPress: /* @__PURE__ */ __name(() => navigation.goBack(), "onPress"),
                  color: "primary"
                })
              ]
            })
  ...
  var import_react_native13, import_react6, screenWidth, screenHeight, styles;
  var init_WallpaperPreviewScreen = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/WallpaperPreviewScreen.tsx"() {
      "use strict";
      init_jsxRuntime();
      ...
      init_toasts();
      init_icons();
      ({ width: screenWidth, height: screenHeight } = import_react_native13.Dimensions.get("window"));
      __name(WallpaperPreviewScreen, "WallpaperPreviewScreen");
      styles = import_react_native13.StyleSheet.create({
        container: {
          flex: 1
        },
        image: {
  ...
  function useShallow(selector) {
    var prev = import_react7.default.useRef(void 0);
    return (state2) => {
  ...
  function ToastIcon({ icon }) {
    ...
    if (/* @__PURE__ */ (0, import_react8.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast: toast2 }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react8.useState)(false);
    var onTextLayout = /* @__PURE__ */ __name(({ nativeEvent }) => {
      setIsMultiline(nativeEvent.lines.length > 1);
    }, "onTextLayout");
    return /* @__PURE__ */ jsx(import_react_native14.View, {
      style: [
        isMultiline && {
          paddingHorizontal: 12
        }
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react9.memo)(/* @__PURE__ */ __name(function Toast({
        toast: toast2
      }) {
        var styles4 = useStyles2();
        var {
          width
        } = (0, import_react_native15.useWindowDimensions)();
        ...
        var onceOnDismiss = (0, import_react9.useCallback)(() => {
          toast2.onDismiss?.();
          hideToast(toast2.id);
        }, [hideToast, toast2]);
  ...
  __export(stores_exports, {
    ...
    UserStore: () => UserStore,
    byStoreName: () => byStoreName2,
    getStore: () => getStore
  });
  function getStore(name, resolver) {
    return lookup(byStoreName2(name, {
      checkEsmDefault: true
    })).asLazy(resolver);
  }
  var byStoreName2, UserStore, ChannelStore, SelectedChannelStore, GuildStore, GuildMemberStore, SelectedGuildStore, RelationshipStore, MessageStore, DeveloperExperimentStore, ToastStore, PermissionStore, EmojiStore, ThemeStore;
  var init_stores = __esm({
    "src/metro/common/stores.ts"() {
      "use strict";
      init_filters();
      init_api();
      byStoreName2 = createModuleFilter(withInteropOptions({
        filter: /* @__PURE__ */ __name(([name, m2]) => m2.constructor?.displayName === name && m2.getName() === name, "filter"),
        stringify: /* @__PURE__ */ __name((arg) => `byStoreName(${arg})`, "stringify")
      }));
  ...
  var import_react_native16, isDiscordToastActive;
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.after(module3, "type", (_, res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              ...
              patcher26.attachDisposer(() => void uninject());
            }
          }
        ]
      });
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "d8d1a788ce45271b67a2606a9d57f9c36e462b56";
      branch = "main";
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native17.Platform.constants.reactNativeVersion;
    ...
    return {
      ...
      react: {
        version: import_react10.default.version
      },
      reactNative: {
  ...
  var import_react10, import_react_native17;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native18.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native18.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  function openURL(url) {
    import_react_native19.Linking.openURL(url);
  }
  ...
  var import_react_native20, import_react11;
...
${log.errorStack}`;
  ...
  function LogsPage() {
    var [showDebug, setShowDebug] = (0, import_react12.useState)(false);
    var filteredLogs = (0, import_react12.useMemo)(() => {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsx(import_flash_list2.FlashList, {
        data: filteredLogs,
        ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native23.ScrollView, {
          contentContainerStyle: {
            gap: 12,
            paddingVertical: 12
          },
  ...
  var import_flash_list2, import_react12, import_react_native23;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
...
(${discord.build})`,
  ...
  function useHighlight() {
    var context26 = (0, import_react13.useContext)(HighlightContext);
    if (!context26) {
  ...
  function CardHeader({ addon }) {
    var HeaderIcon = addon.asAddonMetadata().icon || BlazecordIcon_default;
  ...
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        ListHeaderComponent: /* @__PURE__ */ jsxs(import_react_native26.View, {
          style: {
            gap: 8
          },
          children: [
  ...
  var import_react_native26, ItemSeparator;
  var init_Addon = __esm({
    "src/components/Blaze/Settings/pages/Addon/index.tsx"() {
      ...
      init_SearchTermHighlight();
      init_loader();
      ItemSeparator = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native26.View, {
        style: {
          height: 8
        }
      }), "ItemSeparator");
  ...
  var init_parser = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/painter/parser.ts"() {
      init_shared();
      context4 = getPluginContext("painter");
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger7.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native32.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native32, tokensModule, determineColorReference;
  ...
  // src/plugins/_core/painter/themes/berry-bliss.ts
  var BERRY_BLISS;
  var init_berry_bliss = __esm({
    "src/plugins/_core/painter/themes/berry-bliss.ts"() {
      "use strict";
      BERRY_BLISS = {
        id: "berry.bliss",
  ...
  // src/plugins/_core/painter/themes/blood-terminal.ts
  var BLOOD_TERMINAL;
  var init_blood_terminal = __esm({
    "src/plugins/_core/painter/themes/blood-terminal.ts"() {
      "use strict";
      BLOOD_TERMINAL = {
        id: "blood.terminal",
  ...
  // src/plugins/_core/painter/themes/cyber-neon.ts
  var CYBER_NEON;
  ...
  // src/plugins/_core/painter/themes/dark-pink.ts
  var DARK_PINK;
  var init_dark_pink = __esm({
    "src/plugins/_core/painter/themes/dark-pink.ts"() {
      "use strict";
      DARK_PINK = {
        id: "dark.pink",
  ...
  // src/plugins/_core/painter/themes/forest-glow.ts
  var FOREST_GLOW;
  var init_forest_glow = __esm({
    "src/plugins/_core/painter/themes/forest-glow.ts"() {
      "use strict";
      FOREST_GLOW = {
        id: "forest.glow",
  ...
  // src/plugins/_core/painter/themes/hello-kitty.ts
  var HELLO_KITTY;
  var init_hello_kitty = __esm({
    "src/plugins/_core/painter/themes/hello-kitty.ts"() {
      "use strict";
      HELLO_KITTY = {
        id: "hello.kitty",
  ...
  var logger8, formDividerModule, tokenRefModule, UserSettingsActionCreators, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_parser2();
      init_themes();
      logger8 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta26 = a.asAddonMetadata();
              return meta26.name.localeCompare(meta26.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
  ...
  var import_react14, import_react_native33, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  ...
  var import_flash_list4, import_react_native34;
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react15.useState)({
      id: "toast-demo",
    ...
    var handleShowToast = /* @__PURE__ */ __name(() => {
      var options = {
        ...
        onDismiss() {
          logger9.info("Toast dismissed");
        },
        onPress() {
          logger9.info("Toast pressed");
        },
        onTimeout() {
          logger9.info("Toast timed out");
        }
      };
  ...
  var import_react15, import_react_native35, logger9;
  var init_ToastPlayground = __esm({
    "src/components/Blaze/Settings/pages/Developer/ToastPlayground.tsx"() {
      ...
      logger9 = blzlogger.createChild("ToastPlayground");
  ...
  function DemoAlert() {
    var [understood, setUnderstood] = (0, import_react16.useState)(false);
  ...
  var import_react17, settings_default;
      ...
      settings_default = definePlugin3({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher26) {
              patcher26.after(module3, "default", (_, ret) => {
          ...
          setImmediate(() => {
            registerSettingRenderer("BLAZECORD_CUSTOM_PAGE", {
              ...
              screen: {
                ...
                getComponent: memoize(() => /* @__PURE__ */ (0, import_react17.memo)(() => {
                  var navigation = NavigationNative.useNavigation();
                  var route = NavigationNative.useRoute();
                  var { render: PageComponent, ...args } = route.params;
                  (0, import_react17.useLayoutEffect)(() => void navigation.setOptions({
                    ...args
                  }), [
                    navigation
                  ]);
  ...
  var init_slash = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_api/commands/slash.ts"() {
      init_shared();
      context6 = getPluginContext("commands");
  ...
  function patchAppCommands() {
    var unpatch2 = patcher6.after(commands, "getBuiltInCommands", (args, res) => {
      var type = args[0];
      return [
        ...res,
  ...
  var init_commands2 = __esm({
    "src/plugins/_api/commands/index.ts"() {
      ...
      init_filters2();
      init_slash2();
      commands_default = definePlugin5({
        name: "Commands",
  ...
  var import_react18, getMaxEmojiSlots;
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth2, height: screenHeight2 } = import_react_native40.Dimensions.get("window");
  ...
  var init_openEmojiActionSheet = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expressions/utils/openEmojiActionSheet.tsx"() {
      init_shared();
      context8 = getPluginContext("expressions");
  ...
  function openEmojiActionSheet({ id, name, animated }) {
    try {
      ...
      logger13.error(`Failed to open emoji action sheet: ${err}`);
    }
  }
  ...
  var import_react19, expressions_default;
  var init_expressions2 = __esm({
    "src/plugins/expressions/index.tsx"() {
      ...
      expressions_default = definePlugin7({
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher26) {
              patcher26.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher26.detached.after(props.header, "type", (_2, res) => {
                  (0, import_react19.useEffect)(() => unpatchReactionsHeader, []);
                  try {
                    ...
                    logger12.error`Failed to patch reaction header: ${e3}`;
                  }
                });
              });
            }
        ...
        start() {
          patcher7.attachDisposer(useEmojiAdderStore.subscribe((s, p2) => {
  ...
  var init_silent_typing = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/silent-typing/index.ts"() {
      init_shared();
      context9 = getPluginContext("silent-typing");
  ...
  var init_silent_typing2 = __esm({
    "src/plugins/silent-typing/index.ts"() {
      ...
      silent_typing_default = definePlugin9({
        name: "Stealth Mode",
  ...
  var init_spaces_in_channels = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/spaces-in-channels/index.ts"() {
      init_shared();
      context10 = getPluginContext("spaces-in-channels");
  ...
  var View30, traverseAndModify, unpatchRender, spaces_in_channels_default;
  var init_spaces_in_channels2 = __esm({
    "src/plugins/spaces-in-channels/index.ts"() {
      ...
      spaces_in_channels_default = definePlugin10({
        name: "Channel Spaces",
        ...
        start() {
          unpatchRender = after(View30, "render", (_, res) => {
  ...
  var init_nitro_emojis = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emojis/index.ts"() {
      init_shared();
      context11 = getPluginContext("nitro-emojis");
  ...
  function patchRealmoji(module3, patcher26, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher26.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher26.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      init_parse();
      init_realshit();
      settings = definePluginSettings11({
        emojiSize: {
          type: "slider",
          label: "Display Size",
          points: [
      ...
      haveNitro = false;
      nitro_emojis_default = definePlugin11({
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher26.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher26) {
              patcher26.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher26) {
              patcher26.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher26) {
              patchRealmoji(module3, patcher26, () => settings.get().realshit);
            }
          }
        ],
        start() {
          ...
          waitFor(byStoreName2("UserStore"), (UserStore2) => {
  ...
  // plugins-context-provider:#plugin-context#src/plugins/chat-tweaks/index.ts
  var context12, meta12, definePlugin12, definePluginSettings12, logger17, patcher12;
  var init_chat_tweaks = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/chat-tweaks/index.ts"() {
      init_shared();
      context12 = getPluginContext("chat-tweaks");
  ...
  // src/plugins/chat-tweaks/index.ts
  var chat_tweaks_exports = {};
  __export(chat_tweaks_exports, {
    default: () => chat_tweaks_default
  });
  var settings2, chat_tweaks_default;
  var init_chat_tweaks2 = __esm({
    "src/plugins/chat-tweaks/index.ts"() {
      "use strict";
      init_chat_tweaks();
      init_constants();
      ...
      init_modules();
      init_shallow3();
      settings2 = definePluginSettings12({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
      ...
      chat_tweaks_default = definePlugin12({
        name: "Chat Tweaks",
        ...
        start() {
          ...
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            ...
            BubbleModule_default.configure(avatarRadius, bubbleChatRadius, color).catch(logger17.error);
          }, "updateBubbleAppearance");
          waitFor(byStoreName2("ThemeStore"), (ThemeStore2) => {
  ...
  var init_nitro_icons = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-icons/index.ts"() {
      init_shared();
      context13 = getPluginContext("nitro-icons");
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      init_toasts();
      init_constants();
      nitro_icons_default = definePlugin13({
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              ...
              patcher26.instead(module3, "getIcons", () => mainIcons);
              patcher26.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher26.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
  ...
  var init_nitro_themes = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-themes/index.ts"() {
      init_shared();
      context14 = getPluginContext("nitro-themes");
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      init_stores();
      init_constants();
      nitro_themes_default = definePlugin14({
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              ...
              patcher26.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher26) {
              patcher26.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            id: "force-client-theme-experiment",
            target: byStoreName2("ExperimentStore"),
            patch(module3, patcher26) {
              patcher26.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        start() {
          ...
          var UserSettingsProtoStore = (init_filters(), __toCommonJS(filters_exports)).lookup(byStoreName2("UserSettingsProtoStore"));
  ...
  var init_experiments = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/experiments/index.ts"() {
      init_shared();
      context15 = getPluginContext("experiments");
  ...
  function reinitStore() {
    waitFor(byStoreName2("DeveloperExperimentStore", {
      checkEsmDefault: true
    }), (DeveloperExperimentStore2) => {
      var unpatch2 = patcher15.detached.instead(Object, "defineProperties", () => {
      });
  ...
  var init_experiments2 = __esm({
    "src/plugins/experiments/index.ts"() {
      ...
      experiments_default = definePlugin15({
        name: "Experiments",
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var init_error_boundary = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/error-boundary/index.tsx"() {
      init_shared();
      context16 = getPluginContext("error-boundary");
  ...
  var import_react20, import_react_native43;
  ...
  function ErrorStackCard(props) {
    var [collapsed, setCollapsed] = (0, import_react21.useState)(true);
    var stack;
    try {
  ...
  var import_react21, import_react_native44;
  ...
  var init_error_boundary2 = __esm({
    "src/plugins/_core/error-boundary/index.tsx"() {
      ...
      init_wrappers();
      error_boundary_default = definePlugin16({
        name: "ErrorBoundary",
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.after(module3.prototype, "render", function() {
                var { state: { error } } = this;
                if (!error) return null;
                logger21.error(error.stack);
        ...
        start() {
          ...
          patcher16.after.async(jsxRuntime2, "jsx", callback);
          patcher16.after.async(jsxRuntime2, "jsxs", callback);
        }
      });
    }
  });

  // plugins-context-provider:#plugin-context#src/plugins/_core/devtool/index.ts
  var context17, meta17, definePlugin17, definePluginSettings17, logger22, patcher17;
  var init_devtool = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/devtool/index.ts"() {
      init_shared();
      context17 = getPluginContext("devtool");
  ...
  // src/plugins/_core/devtool/repl-client.ts
  ...
  // src/plugins/_core/devtool/index.ts
  var devtool_exports = {};
  __export(devtool_exports, {
    default: () => devtool_default
  });
  var devtool_default;
  var init_devtool2 = __esm({
    "src/plugins/_core/devtool/index.ts"() {
      "use strict";
      init_devtool();
      init_constants();
      ...
      init_node_inspect_extracted();
      init_repl_client();
      devtool_default = definePlugin17({
        ...
        start() {
          ...
          Object.assign(window, {
            ...
            dk: {
              patcher: patcher17,
              snipe(mod, prop) {
                patcher17.after(mod, prop, (args, ret) => {
                  logger22.info(`Sniped ${prop}
${inspect({
                    args,
                    ret
                  })}`);
  ...
  var init_wallpapers = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/wallpapers/index.ts"() {
      init_shared();
      context18 = getPluginContext("wallpapers");
  ...
  function getFallbackThemeBackground() {
    ...
    console.log("[Wallpapers] Theme store state:", {
      appliedTheme: state2.appliedTheme,
      themeCount: state2.themes.length
    });
    var theme = state2.themes.find((t4) => t4.id === state2.appliedTheme);
    console.log("[Wallpapers] Found theme:", theme ? {
      id: theme.id
    } : "undefined");
    var background = theme?.main.background;
  ...
  function ThemeBackground({ children }) {
    ...
    var { appliedWallpaper, followTheme, blurAmount, opacity } = useWallpaperStore();
    ...
    var bg = !followTheme && appliedWallpaper ? {
      ...appliedWallpaper,
      blur: blurAmount,
      opacity
    ...
    console.log("[Wallpapers] Rendering ImageBackground with:", {
      ...
      imageType: bg.image.startsWith("content://") ? "content-uri" : bg.image.startsWith("file://") ? "file-uri" : bg.image.startsWith("http") ? "http-url" : "unknown"
    });
    return /* @__PURE__ */ jsx(import_react_native46.ImageBackground, {
      ...
      onLoad: /* @__PURE__ */ __name(() => console.log("[Wallpapers] ImageBackground loaded successfully"), "onLoad"),
      onLoadStart: /* @__PURE__ */ __name(() => console.log("[Wallpapers] ImageBackground loading started"), "onLoadStart"),
      onLoadEnd: /* @__PURE__ */ __name(() => console.log("[Wallpapers] ImageBackground loading ended"), "onLoadEnd"),
      onError: /* @__PURE__ */ __name((e3) => console.error("[Wallpapers] ImageBackground error:", e3.nativeEvent), "onError"),
      children
    });
  }
  function patchChatBackground() {
    ...
    patcher19.after(Messages, "render", (_, ret) => {
      ...
      var ChatScreen = findInReactTree(ret, (n3) => n3?.props?.style && "HACK_fixModalInteraction" in n3.props);
      ...
      var { appliedWallpaper, followTheme, blurAmount, opacity } = useWallpaperStore.getState();
      ...
      if (ChatScreen && bg?.opacity != null) {
        ...
        try {
          var flat = import_react_native46.StyleSheet.flatten(ChatScreen.props.style);
  ...
  var import_react_native46, Messages;
  ...
  var init_wallpapers2 = __esm({
    "src/plugins/_core/wallpapers/index.ts"() {
      ...
      init_constants();
      init_background2();
      wallpapers_default = definePlugin18({
        name: "Wallpapers",
  ...
  var init_dummy = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/dummy/index.ts"() {
      init_shared();
      context20 = getPluginContext("dummy");
  ...
  var init_dummy2 = __esm({
    "src/plugins/_core/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings3 = definePluginSettings20({
        stonerName: {
          type: "string",
          label: "Stoner Name",
        ...
        patches: [
          {
            ...
            patch(_, patcher26) {
              patcher26.after(window, "sampleMethod", () => {
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context21 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin21({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher26) {
              patcher26.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher26) {
              patcher26.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher24.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher24.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher23.before(isThemeModule, "isThemeDark", callback);
    patcher23.before(isThemeModule, "isThemeLight", callback);
    patcher23.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher23.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin22({
        name: "Painter",
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/new/src/plugins"() {
      plugins_default = {
        ...
        "chat-tweaks": (init_chat_tweaks2(), __toCommonJS(chat_tweaks_exports)).default("/chat-tweaks"),
        ...
        "devtool": (init_devtool2(), __toCommonJS(devtool_exports)).default("/_core/devtool"),
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher26 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger30.debug(`Applying ${patcher26.id} patch`);
        patcher26.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher26);
        });
      }, "apply");
      ...
      if (settings4 && pluginPatch2.predicate) {
        ...
        var unsub = settings4.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger30.debug(`Disposing ${patcher26.id} patch`);
            patcher26.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    ...
    try {
      var patcher26 = getContextualPatcher(id, false);
      if (patcher26) {
        patcher26.dispose();
        patcher26.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher26 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher26.parent = this;
        this.children.push(patcher26);
        return patcher26;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher26);
    return patcher26;
  }
  ...
  // plugins-context-provider:#plugin-context#src/components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet.tsx
  var context25, meta25, definePlugin25, definePluginSettings25, logger31, patcher25;
  var init_AddWallpaperSheet = __esm({
    "plugins-context-provider:#plugin-context#src/components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet.tsx"() {
      init_shared();
      context25 = getPluginContext("..");
      ({ meta: meta25, definePlugin: definePlugin25, definePluginSettings: definePluginSettings25, logger: logger31, patcher: patcher25 } = context25);
    }
  });

  // node_modules/@react-native-documents/picker/lib/module/spec/NativeDocumentPicker.js
  var import_react_native47, NativeDocumentPicker;
  var init_NativeDocumentPicker = __esm({
    "node_modules/@react-native-documents/picker/lib/module/spec/NativeDocumentPicker.js"() {
      "use strict";
      import_react_native47 = __toESM(require_react_native(), 1);
      NativeDocumentPicker = import_react_native47.TurboModuleRegistry.getEnforcing("RNDocumentPicker");
    }
  });
  ...
  var import_react_native48, mimeTypes, utis, perPlatformTypes, types;
  var init_fileTypes = __esm({
    "node_modules/@react-native-documents/picker/lib/module/fileTypes.js"() {
      ...
      types = perPlatformTypes[import_react_native48.Platform.OS];
    }
  });

  // node_modules/@react-native-documents/picker/lib/module/errors.js
  var OPERATION_CANCELED, IN_PROGRESS, UNABLE_TO_OPEN_FILE_TYPE, errorCodes;
  ...
  function pick2(options) {
    return _async_to_generator(function* () {
      ...
      var response = NativeDocumentPicker.pick(newOpts);
      var awaitedResult = yield response;
      for (var res of awaitedResult) {
        if (import_react_native50.Platform.OS === "android") {
  ...
  function AddWallpaperSheet() {
    var [category, setCategory] = (0, import_react22.useState)("");
    var [name, setName] = (0, import_react22.useState)("");
    var [uploading, setUploading] = (0, import_react22.useState)(false);
    var [cdnUrl, setCdnUrl] = (0, import_react22.useState)(null);
    var addWallpaper = useWallpaperStore((state2) => state2.addWallpaper);
    var handlePickAndUpload = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        setUploading(true);
        var files = yield pick2({
          type: [
            types.images
          ],
        ...
        var res = yield fetch(WEBHOOK_URL, {
          method: "POST",
          body: formData,
          headers: {
        ...
        if (!res.ok) {
          logger31.error(`Upload failed: ${yield res.text()}`);
          showToast("Upload failed");
          return;
        }
        var data = yield res.json();
        var url = data.attachments?.[0]?.url;
        if (!url) {
        ...
        console.error("Error Saving Wallpaper:", e3);
    ...
    var handleAdd = /* @__PURE__ */ __name(() => {
      if (!cdnUrl || !category || !name) {
        import_react_native52.Alert.alert("Empty Fields Remaining!", "Category AND Wallpaper must have complete name fields to save.");
        return;
      }
    ...
    return /* @__PURE__ */ jsx(BottomSheet_default, {
      children: /* @__PURE__ */ jsxs(import_react_native52.View, {
        ...
        children: [
          ...
          cdnUrl && /* @__PURE__ */ jsx(Text_default, {
            style: styles2.imageInfo,
            children: "Uploaded image ready!"
          }),
          /* @__PURE__ */ jsx(Button_default, {
            text: "Add Wallpaper",
            onPress: handleAdd,
  ...
  var import_react22, import_react_native52, WEBHOOK_URL, styles2;
  var init_AddWallpaperSheet2 = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet.tsx"() {
      "use strict";
      init_async_to_generator();
      init_jsxRuntime();
      ...
      init_module2();
      init_icons();
      WEBHOOK_URL = "https://discord.com/api/webhooks/1412056050177278023/VpVQ-AMvSEi7xUmFloFKtyvqUU1Q9DVq6e276HAGApgRPA29RWg_PdaKK_2XEcFSvjKw";
  ...
  function WallpaperManager() {
    ...
    (0, import_react23.useLayoutEffect)(() => {
      navigation.setOptions({
        headerRight: /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(ContextMenu_default, {
          items: [
            {
              label: followTheme ? "Disable Follow Theme" : "Enable Follow Theme",
              iconSource: findAssetId("CheckmarkSmallBoldIcon"),
              action: /* @__PURE__ */ __name(() => setFollowTheme(!followTheme), "action")
            }
          ],
          children: /* @__PURE__ */ __name((props) => /* @__PURE__ */ jsx(import_react_native53.TouchableOpacity, {
            ...props,
            children: /* @__PURE__ */ jsx(IconButton_default, {
              onPress: /* @__PURE__ */ __name(() => {
              }, "onPress"),
              size: "small",
    ...
    return /* @__PURE__ */ jsx(import_react_native53.View, {
      style: {
        flex: 1
      },
      children: /* @__PURE__ */ jsxs(import_react_native53.ScrollView, {
        style: styles3.container,
        children: [
          categories.map((category) => /* @__PURE__ */ jsxs(import_react_native53.View, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(import_react_native53.ScrollView, {
                horizontal: true,
                showsHorizontalScrollIndicator: false,
                children: category.wallpapers.map((wallpaper) => /* @__PURE__ */ jsxs(import_react_native53.TouchableOpacity, {
                  onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZECORD_CUSTOM_PAGE", {
                    title: wallpaper.name,
                    render: /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(WallpaperPreviewScreen, {
                      wallpaper
                    }), "render")
                  }), "onPress"),
                  style: styles3.wallpaperThumb,
                  children: [
                    /* @__PURE__ */ jsx(import_react_native53.Image, {
                      source: {
                        uri: wallpaper.image
                      },
  ...
  var import_react_native53, import_react23, styles3;
  var init_Wallpapers = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/index.tsx"() {
      "use strict";
      init_jsxRuntime();
      ...
      init_wallpaperStore();
      init_Discord();
      init_AddWallpaperSheet2();
      init_WallpaperPreviewScreen();
      init_sheets();
      init_libraries();
      init_assets();
      init_ContextMenu();
      ...
      styles3 = import_react_native53.StyleSheet.create({
        container: {
          padding: 16
        },
        categoryContainer: {
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "data/BlazecordIcon": createModuleProxy(() => (init_BlazecordIcon(), __toCommonJS(BlazecordIcon_exports))),
        ...
        "components/Blaze/Settings/pages/PageWrapper": createModuleProxy(() => (init_PageWrapper(), __toCommonJS(PageWrapper_exports))),
        "components/Blaze/Settings/pages/Wallpapers/WallpaperPreviewScreen": createModuleProxy(() => (init_WallpaperPreviewScreen(), __toCommonJS(WallpaperPreviewScreen_exports))),
        "components/Blaze/Settings/pages/Wallpapers/": createModuleProxy(() => (init_Wallpapers(), __toCommonJS(Wallpapers_exports))),
        "components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet": createModuleProxy(() => (init_AddWallpaperSheet2(), __toCommonJS(AddWallpaperSheet_exports))),
