var BLAZECORD_START_TIME = nativePerformanceNow(); var window = typeof globalThis !== 'undefined' ? globalThis : this;
(() => {
  ...
  // shims/jsxRuntime.ts
  function runHooks(type, vnode) {
    var name = getComponentName(type);
    var fns = hookMap.get(name);
    if (fns) for (var fn of fns) fn(type, vnode);
  }
  function getComponentName(type) {
    return type.displayName || type.name || "Unknown";
  }
  function unproxyFirstArg(args) {
    if (!args[0]) throw new Error("JSX Component is undefined or null");
    var factory = getProxyFactory(args[0]);
    if (factory) args[0] = factory();
    return args;
  }
  var hookMap, jsxRuntime, Fragment, jsx, jsxs;
  var init_jsxRuntime = __esm({
    "shims/jsxRuntime.ts"() {
      ...
      jsx = /* @__PURE__ */ __name((...args) => {
        var out = jsxRuntime.jsx(...unproxyFirstArg(args));
        runHooks(args[0], out);
        return out;
      }, "jsx");
      jsxs = /* @__PURE__ */ __name((...args) => {
        var out = jsxRuntime.jsxs(...unproxyFirstArg(args));
        runHooks(args[0], out);
        return out;
      }, "jsxs");
    }
      ...
      en = {
        ...
        error_boundary: {
          ...
          screen: {
            ...
            description: "Something fucked up while rendering. Could've been caused by Discord, or by Blaze being a fucking skidtard."
          }
        },
        actions: {
          nevermind: "Nevermind",
        ...
        settings: {
          ...
          general: {
            ...
            configurations: {
              ...
              safe_mode: {
                label: "Safe Mode",
                description: "Stops non-essential code from running. Restart required.",
                alert: {
          ...
          developer: {
            sections: {
              init_config: {
                ...
                sublabel: "Configure a custom endpoint to load BlazeCord from.",
                custom_endpoint: "Endpoint:",
                bundle_path: "Path:",
                bundle_path_desc: "Override the bundle file name.",
                force_update: "Force Update",
                force_update_desc: "Re-Download BlazCords bundle on every app boot."
              },
              tools: {
                label: "Tools",
                asset_browser: {
          ...
          updater: {
            ...
            autoUpdateDescription: "Enable automatic updates without prompt to BlazeCord",
            notifyNewUpdates: "Update Notifications",
            notifyNewUpdatesDescription: "Show a notification if an update is available.",
  ...
  __export(icons_exports, {
    ...
    NitroWheeelIcon: () => NitroWheeelIcon,
  ...
  var ActivitiesIcon, ArrowSmallLeftIcon, AnalyticsIcon, AppsIcon, BeakerIcon, BicycleIcon, BugIcon, BookmarkIcon, BoostTier1Icon, BoostTier2Icon, BoostTier3Icon, CircleCheckIcon, CircleInformationIcon, CircleMinusIcon, CirclePlusIcon, CircleQuestionIcon, CircleWarningIcon, CircleXIcon, DownloadIcon, DragIcon, EducationIcon, EyeIcon, FireIcon, FlagIcon, FlashIcon, FoodIcon, FolderIcon, GifIcon, ImageIcon, ImagesIcon, ImageFileIcon, ImagePlusIcon, HammerIcon, HashmarkIcon, HeartIcon, HomeIcon, HourglassIcon, LettersIcon, LinkIcon, LockIcon, MagicWandIcon, MagnifyingGlassIcon, MedalIcon, MusicIcon, NatureIcon, NewUserIcon, NitroWheeelIcon, ObjectIcon, PaintbrushThinIcon, PaintPaletteIcon, PaperIcon, PaperPlusIcon, PencilIcon, PencilSparkleIcon, PuzzlePieceIcon, RetryIcon, SettingsIcon, SignPostIcon, SparkleIcon, StampIcon, StaffBadgeIcon, StarIcon, StarShootingIcon, StickerIcon, SuperReactionIcon, ThemeDarkIcon, ThemeLightIcon, ThemeMidnightIcon, TimerIcon, TrashIcon, TreehouseIcon, TopicsIcon, WarningIcon, WrenchIcon;
  var init_icons = __esm({
    "src/metro/common/icons.ts"() {
      ...
      SettingsIcon = getIcon("SettingsIcon");
  ...
  var import_react5, import_react_native11, styles;
  var init_WallpaperPreviewSheet = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/WallpaperPreviewSheet.tsx"() {
      ...
      styles = import_react_native11.StyleSheet.create({
        container: {
          flex: 1
        },
        previewImage: {
  ...
  function AddWallpaperSheet() {
    var [category, setCategory] = (0, import_react6.useState)("");
    var [name, setName] = (0, import_react6.useState)("");
    var [opacity, setOpacity] = (0, import_react6.useState)(1);
    var [blur, setBlur] = (0, import_react6.useState)(0);
    var [image, setImage] = (0, import_react6.useState)(null);
    ...
    return /* @__PURE__ */ jsxs(import_react_native12.ScrollView, {
      style: {
        padding: 16
      },
      children: [
        ...
        /* @__PURE__ */ jsxs(import_react_native12.View, {
          ...
          children: [
            /* @__PURE__ */ jsxs(import_react_native12.Text, {
              children: [
                "Opacity: ",
                opacity.toFixed(1)
              ]
  ...
  var import_react6, import_react_native12, DocumentPicker;
  ...
  function WallpaperManager() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native13.ScrollView, {
      ...
      children: [
        ...
        categories.map((category) => /* @__PURE__ */ jsxs(import_react_native13.View, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(import_react_native13.ScrollView, {
              ...
              children: category.wallpapers.map((wallpaper) => /* @__PURE__ */ jsx(import_react_native13.TouchableOpacity, {
                onPress: /* @__PURE__ */ __name(() => showSheet("WallpaperPreviewSheet", {
                  wallpaper
                }), "onPress"),
                style: styles2.wallpaperThumb,
                children: /* @__PURE__ */ jsx(import_react_native13.Image, {
                  source: {
                    uri: wallpaper.image
                  },
  ...
  var import_react7, import_react_native13, styles2;
...
${log.errorStack}`;
  ...
  function LogsPage() {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsx(import_flash_list2.FlashList, {
        data: filteredLogs,
        ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native16.ScrollView, {
          contentContainerStyle: {
            gap: 12,
            paddingVertical: 12
          },
  ...
  var import_flash_list2, import_react8, import_react_native16;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
  ...
  // asset-loader:src/assets/ic_flamelogo.png
  var require_ic_flamelogo = __commonJS({
    "asset-loader:src/assets/ic_flamelogo.png"(exports, module3) {
      init_libraries();
      module3.exports = AssetsRegistry.registerAsset({ "__blazecord": true, "__packager_asset": true, "width": 260, "height": 258, "httpServerLocation": "src/assets/ic_flamelogo.png", "dataurl": "data:image/png;base64,", "scales": [1], "name": "ic_flamelogo.png", "type": "png" });
    }
  });
  ...
  function DemoToastComponent(props) {
    var [count, setCount] = (0, import_react9.useState)(0);
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react9.useState)({
      id: "toast-demo",
    ...
    var handleShowToast = /* @__PURE__ */ __name(() => {
      ...
      if (toastConfig.showIcon) {
        options.icon = require_ic_flamelogo();
      }
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native17.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast.update({
  ...
  var import_react9, import_react_native17, logger2;
  var init_ToastPlayground = __esm({
    "src/components/Blaze/Settings/pages/Developer/ToastPlayground.tsx"() {
      ...
      logger2 = blzlogger.createChild("ToastPlayground");
  ...
  function AssetBrowser() {
    ...
    var assets = (0, import_react10.useMemo)(() => sortAssets(getAssets()).filter((a) => a.name.toLowerCase().includes(ref.query.toLowerCase()) || a.id.toString() === ref.query), [
      ref.query
    ]);
  ...
  var import_react10, import_react_native18, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native18.useWindowDimensions)().width - 24;
        var imageSize = {
  ...
  function useShallow(selector) {
    var prev = import_react11.default.useRef(void 0);
    return (state2) => {
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native19.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list4, import_react_native19;
  ...
  function AlertModalWrapper({ children, dismissable }) {
    (0, import_react12.useEffect)(() => {
      if (dismissable === false) {
        var backHandler = import_react_native20.BackHandler.addEventListener("hardwareBackPress", () => true);
        return () => backHandler.remove();
      }
    }, [
      dismissable
    ]);
    return dismissable === false ? /* @__PURE__ */ jsx(import_react_native20.Pressable, {
      style: {
        position: "absolute",
        width: "100%",
        height: "100%",
  ...
  function showAlert(props) {
    ...
    if ("content" in props) {
      content = /* @__PURE__ */ jsx(AlertModal, {
        ...
        actions: props.actions?.map((a, i2) => /* @__PURE__ */ (0, import_react12.isValidElement)(a) ? a : /* @__PURE__ */ jsx(AlertActionButton, {
          ...a
        }, i2))
      });
  ...
  var import_react12, import_react_native20, logger3, AlertStore;
  var init_alerts = __esm({
    "src/api/alerts.tsx"() {
      ...
      init_AlertModal();
      logger3 = blzlogger.createChild("Alerts");
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_10575445024011_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx1","translationX","translationY","__closure","transform","translateX","value","translateY"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAwC0C,SAAAA,UAAA,QAAAC,YAAA,CAAAC,YAAA,OAAAC,SAAA,OAAK,CACnCC,SAAS,CAAE,CACP,CACIC,UAAU,CAAEJ,YAAY,CAACK,KAC7B,CAAC,CACD,CACIC,UAAU,CAAEL,YAAY,CAACI,KAC7B,CAAC,CAET,CAAC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12707892542287_init_data = {
      ...
      _worklet_2394815801719_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx3","event","translationX","__closure","value","changeX"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDwG,SAAAA,SAAQA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,CACxGD,YAAY,CAACE,KAAK,EAAIH,KAAK,CAACI,OAAO,CACvC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1148071943580_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12633554293434_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx5","finished","willDisappear","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AA+D8D,SAAAA,UAAQC,QAAG,QAAAC,aAAA,CAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CAC7D,GAAIJ,QAAQ,EAAIC,aAAa,CAAE,CAC3BC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1700014798715_init_data = {
        ...
        location: "/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx8","finished","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/discord/winning/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAuEuE,SAAAA,UAAQC,QAAG,QAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CACtE,GAAIH,QAAQ,CAAE,CACVC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "8a7de45828de73215b42a15af082b277c88616a3";
      branch = "ChatBGs";
  ...
  var init_useUpdaterStore = __esm({
    "src/stores/useUpdaterStore.tsx"() {
      ...
      init_middleware();
      init_kvStorage();
      logger6 = blzlogger.createChild("UpdaterStore");
  ...
  var import_react_native28, import_react18;
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(TableRowGroup_default, {
          ...
          children: [
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native29.Linking.openURL(`https://${Links.GITHUB}`), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native29.Linking.openURL(`https://${Links.DISCORD}`), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              label: t3.settings.general.paypal(),
              icon: /* @__PURE__ */ jsx(TableRow_default.Icon, {
                source: findAssetId("img_account_sync_paypal_white")
              }),
              arrow: true,
              trailing: /* @__PURE__ */ jsx(TableRow_default.TrailingText, {
                text: Links.PAYPAL
              }),
              onPress: /* @__PURE__ */ __name(() => import_react_native29.Linking.openURL(`https://${Links.PAYPAL}`), "onPress")
            })
          ]
        })
      ]
  ...
  var import_react_native30, showUserProfileActionSheet, useStyles3, maybeFetchUser;
  ...
  function StringOptionRow({ opt, plugin, settingKey, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      label: /* @__PURE__ */ jsxs(import_react_native31.View, {
        style: {
          paddingHorizontal: 6,
          gap: 4
        },
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native32.View, {
          ...
          children: /* @__PURE__ */ jsx(Slider_default, {
            ...
            startIcon: /* @__PURE__ */ jsx(import_react_native32.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex - 1), "onPress"),
              children: /* @__PURE__ */ jsx(CircleMinusIcon, {})
            }),
            endIcon: /* @__PURE__ */ jsx(import_react_native32.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex + 1), "onPress"),
  ...
  function OptionSection({ plugin }) {
    ...
    return /* @__PURE__ */ jsx(InfoSection, {
      ...
      children: /* @__PURE__ */ jsx(import_react_native33.View, {
        ...
        children: options.map((group, i2) => /* @__PURE__ */ jsx(import_react_native33.View, {
          children: group.map(([key, opt], i3) => /* @__PURE__ */ jsx(import_react_native33.View, {
  ...
  var init_settings3 = __esm({
    "src/plugins/_api/settings/index.tsx"() {
      ...
      settings = definePluginSettings2({
        onTop: {
          label: "BlazeCord On-Top~",
          description: "My settings are cooler than your settings are!",
          type: "boolean",
          default: true
        }
      });
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native35.View, {
          style: styles3.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native35.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native35.View, {
          ...
          children: [
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native35.View, {
              style: styles3.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native35.View, {
          style: styles3.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native35.View, {
              style: styles3.rowContainer,
  ...
  var import_react_native35, import_react_native_reanimated2, useStyles4;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native36.Keyboard.dismiss();
  ...
  function EmoteStealerActionSheet({ emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(BottomSheet_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native37.ScrollView, {
        style: {
          gap: 12
        },
        children: [
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native37.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native37, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native39.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native39.Dimensions.get("window");
...
${inspect({
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      nitro_themes_default = definePlugin9({
        ...
        description: "Unlocks all AppThemes in .",
        authors: [
          Devs.Blaze
        ],
        patches: [
  ...
  var import_react_native40, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native40.processColor)(args[2]))
          ], "configure")
        }
      });
    }
    ...
    return /* @__PURE__ */ jsxs(import_react_native41.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native41.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native42.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native42.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native42.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react22, import_react_native42;
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react23.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native43.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react23, import_react_native43;
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native44.ScrollView, {
            fadingEdgeLength: 64,
            contentContainerStyle: {
              gap: 12
            },
  ...
  var import_react_native44, useStyles5;
  ...
  var init_error_boundary2 = __esm({
    "src/plugins/_core/error-boundary/index.tsx"() {
      ...
      error_boundary_default = definePlugin12({
        ...
        start() {
          var jsxRuntime3 = lookupByProps("jsx", "jsxs").await();
          ...
          patcher12.after.async(jsxRuntime3, "jsx", callback);
          patcher12.after.async(jsxRuntime3, "jsxs", callback);
        }
      });
    }
  });

  // plugins-context-provider:#plugin-context#src/plugins/_core/badges/index.ts
  var context13, meta13, definePlugin13, definePluginSettings13, logger17, patcher13;
  var init_badges = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/badges/index.ts"() {
      init_shared();
      context13 = getPluginContext("badges");
  ...
  // src/plugins/jsxRuntime.ts
  function onJsxCreate(name, hook) {
    if (!hookMap2.has(name)) hookMap2.set(name, []);
    hookMap2.get(name).push(hook);
  }
  var hookMap2, jsxRuntime2, Fragment2;
  var init_jsxRuntime2 = __esm({
    "src/plugins/jsxRuntime.ts"() {
      "use strict";
      init_filters2();
      init_api();
      init_lazy();
      hookMap2 = /* @__PURE__ */ new Map();
      __name(onJsxCreate, "onJsxCreate");
      jsxRuntime2 = lookup(byProps([
        "jsx",
        "jsxs"
      ])).asLazy((r4) => jsxRuntime2 = r4);
      Fragment2 = Symbol.for("react.fragment");
    }
  });
  ...
  function inject(badges, into, userId) {
    for (var i2 = 0; i2 < badges.length; i2++) {
      var badge = badges[i2];
      var id = `blaze-${userId}-${i2}`;
      propHolder[id] = {
        source: {
          uri: badge.url
        },
  ...
  var badgeCache, propHolder, badges_default;
  var init_badges2 = __esm({
    "src/plugins/_core/badges/index.ts"() {
      "use strict";
      init_badges();
      init_constants();
      ...
      badgeCache = {};
      propHolder = {};
      onJsxCreate("RenderedBadge", (_, vnode) => {
        if (vnode?.props?.id?.startsWith?.("blaze-")) {
          Object.assign(vnode.props, propHolder[vnode.props.id]);
        }
      });
      badges_default = definePlugin13({
        name: "Badges",
        description: "Adds BlazeCord badges to user profiles.",
        authors: [
          Devs.Blaze
        ],
        required: false,
        patches: [
          {
            id: "blazecord-badges",
            target: byName("useBadges"),
            patch(module3, patcher21) {
              patcher21.after(module3, "default", (args, returnValue) => {
                var [user] = args;
                if (!user) return;
                var cached = badgeCache[user.id];
                if (cached) {
                  inject(cached, returnValue, user.id);
                  return;
                }
                fetch(`https://raw.githubusercontent.com/BlazeK1ng420/BlazeK1ng420.github.io/refs/heads/base/assets/BlazeCord/Badges/${user.id}.json`).then((res) => res.json()).then((badges) => {
                  badgeCache[user.id] = badges;
                }).catch(() => {
                });
              });
            }
  ...
  var init_background = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/wallpapers/patches/background.ts"() {
      init_shared();
      context15 = getPluginContext("wallpapers");
  ...
  function patchChatBackground() {
    patcher15.after(Messages, "render", (args, ret) => {
      ...
      var selected = store.appliedWallpaper;
  ...
  var init_wallpapers2 = __esm({
    "src/plugins/_core/wallpapers/index.ts"() {
      ...
      init_constants();
      init_background2();
      wallpapers_default = definePlugin14({
        name: "Wallpapers",
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context16 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin16({
        name: "NoTrack",
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher19.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher19.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher18.before(isThemeModule, "isThemeDark", callback);
    patcher18.before(isThemeModule, "isThemeLight", callback);
    patcher18.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher18.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin17({
        name: "Painter",
  ...
  // plugins-importer:/home/blaze/coding/discord/winning/src/plugins
  var plugins_exports = {};
  __export(plugins_exports, {
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/discord/winning/src/plugins"() {
      plugins_default = {
        ...
        "badges": (init_badges2(), __toCommonJS(badges_exports)).default("/_core/badges"),
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native45.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native45, tokensModule, determineColorReference;
