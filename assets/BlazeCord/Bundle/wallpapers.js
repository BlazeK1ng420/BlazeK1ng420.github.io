...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "842495e62c3a76e830fad201cded6a9dc194c254";
      branch = "fix-themes";
...
(${discord.build})`,
  ...
  var init_ping = __esm({
    "src/plugins/_api/commands/coms/ping.ts"() {
      ...
      ping_default = /* @__PURE__ */ __name(() => ({
        ...
        execute(args, ctx) {
          return {
            content: "Ping these nuts, motherfucker~"
          };
        }
      }), "default");
    }
  ...
  var init_spaces_in_channels = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/spaces-in-channels/index.ts"() {
      init_shared();
      context7 = getPluginContext("spaces-in-channels");
  ...
  var View29, traverseAndModify, unpatchRender, spaces_in_channels_default;
  var init_spaces_in_channels2 = __esm({
    "src/plugins/spaces-in-channels/index.ts"() {
      ...
      spaces_in_channels_default = definePlugin7({
        name: "Channel Spaces",
        ...
        start() {
          unpatchRender = after(View29, "render", (_, res) => {
  ...
  var init_dummy = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/dummy/index.ts"() {
      init_shared();
      context8 = getPluginContext("dummy");
  ...
  var init_nitro_emojis = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emojis/index.ts"() {
      init_shared();
      context9 = getPluginContext("nitro-emojis");
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      haveNitro = false;
      nitro_emojis_default = definePlugin9({
  ...
  var init_expression_utils = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/index.tsx"() {
      init_shared();
      context10 = getPluginContext("expression-utils");
  ...
  var init_openEmojiActionSheet = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/utils/openEmojiActionSheet.tsx"() {
      init_shared();
      context11 = getPluginContext("expression-utils");
  ...
  function openEmojiActionSheet({ id, name, animated }) {
    try {
      ...
      logger15.error(`Failed to open emoji action sheet: ${err}`);
    }
  }
  ...
  var init_expression_utils2 = __esm({
    "src/plugins/expression-utils/index.tsx"() {
      ...
      expression_utils_default = definePlugin10({
              ...
              patcher25.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher25.detached.after(props.header, "type", (_2, res) => {
                  ...
                  try {
                    ...
                    logger14.error`Failed to patch reaction header: ${e3}`;
                  }
                });
              });
            }
        ...
        start() {
          patcher10.attachDisposer(useEmojiAdderStore.subscribe((s, p2) => {
  ...
  var init_devtoolkit = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/devtoolkit/index.ts"() {
      init_shared();
      context12 = getPluginContext("devtoolkit");
  ...
  var init_devtoolkit2 = __esm({
    "src/plugins/devtoolkit/index.ts"() {
      ...
      init_node_inspect_extracted();
      init_repl_client();
      devtoolkit_default = definePlugin12({
        name: "DevToolkit",
        ...
        start() {
          ...
          Object.assign(window, {
            ...
            dk: {
              patcher: patcher12,
              snipe(mod, prop) {
                patcher12.after(mod, prop, (args, ret) => {
                  logger16.info(`Sniped ${prop}
${inspect({
                    args,
                    ret
                  })}`);
  ...
  var init_chat_bubbles = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/chat-bubbles/index.ts"() {
      init_shared();
      context16 = getPluginContext("chat-bubbles");
  ...
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings4 = definePluginSettings16({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
      ...
      chat_bubbles_default = definePlugin16({
        name: "ChatBubbles",
        ...
        start() {
          ...
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            ...
            BubbleModule_default.configure(avatarRadius, bubbleChatRadius, color).catch(logger20.error);
  ...
  var logger30, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
        ...
        onRehydrateStorage() {
          return (state2) => {
            if (state2 && state2.themes.length !== 0) {
              ...
              try {
                var storedId = state2.appliedTheme;
                if (storedId) {
                  applyTheme(storedId, true);
                  logger30.debug(`Applied theme on rehydrate: ${storedId}`);
                }
              } catch (e3) {
                logger30.error(`Failed to restore theme on rehydration! ${e3}`);
              }
            }
          };
        },
