...
(() => {
        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger30 = new Logger2(name);
              logger30.parent = this;
              logger30.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger30;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger30) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger30.logHandlers.size > 0) {
                  for (var handler of logger30.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger30.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger30) => {
                logger30.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger30) => {
                logger30.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger30) => {
                if (logger30 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger30.logHandlers.has(handler)) {
                    logger30.logHandlers.delete(handler);
                  }
                }
              });
  ...
  function applyRuntimeHook(method, args, ret) {
    var [Component] = unproxyFirstArg(args);
    if (!Component) throw new Error("Invalid JSX component (null/undefined).");
    if (typeof ret?.type === "undefined") ret.type = "RCTView";
    var name = typeof Component === "function" ? Component.name : null;
    if (name && callbacks.has(name)) {
      for (var cb of callbacks.get(name)) {
        var result = cb(Component, ret);
        if (result !== void 0) ret = result;
      }
    }
    return ret;
  }
  var callbacks, jsxRuntime, Fragment, jsx, jsxs;
  var init_jsxRuntime = __esm({
    "shims/jsxRuntime.ts"() {
      ...
      __name(applyRuntimeHook, "applyRuntimeHook");
      Fragment = Symbol.for("react.fragment");
      jsx = /* @__PURE__ */ __name((...args) => applyRuntimeHook("jsx", args, jsxRuntime.jsx(...args)), "jsx");
      jsxs = /* @__PURE__ */ __name((...args) => applyRuntimeHook("jsxs", args, jsxRuntime.jsxs(...args)), "jsxs");
    }
  });
      ...
      children: /* @__PURE__ */ jsxs(import_react_native20.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native20.View, {
            ...
            children: [
              /* @__PURE__ */ jsxs(import_react_native20.Text, {
                children: [
                  "Opacity: ",
                  opacity.toFixed(1)
                ]
...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context24 = (0, import_react14.useContext)(HighlightContext);
    if (!context24) {
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3, "type", (_, res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              ...
              patcher24.attachDisposer(() => void uninject());
            }
          }
        ]
      });
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "bc4fbafd0621805f2786a72bf75faa73559c73c4";
      branch = "settings";
...
(${discord.build})`,
      ...
      settings_default = definePlugin3({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3, "default", (_, ret) => {
                var _loop = /* @__PURE__ */ __name(function(customSection2) {
                  if (!sections.some((sec) => sec.label === customSection2.label)) {
                    sections.unshift(customSection2);
                    logger7.info(`[Settings] Injected custom section: ${customSection2.label}`);
                  }
                }, "_loop");
                var node = findInReactTree(ret, (i2) => i2?.props?.sections);
                if (!node || !Array.isArray(node.props.sections)) {
                  logger7.warn("[Settings] Failed to find sections in SettingsOverviewScreen");
                  return;
                }
                var sections = node.props.sections;
                for (var customSection of _registeredSettingSections) _loop(customSection);
              });
            }
          }
        ],
      ...
      eval_default = /* @__PURE__ */ __name(() => ({
        ...
        execute(_0, _1) {
          return _async_to_generator(function* ([code, async], ctx) {
            try {
              var res = util2.inspect(async?.value ? yield AsyncFunction(code.value)() : eval?.(code.value));
  ...
  var init_ping = __esm({
    "src/plugins/_api/commands/coms/ping.ts"() {
      ...
      pingCommand = {
        ...
        options: [],
        shouldHide: /* @__PURE__ */ __name(() => false, "shouldHide"),
        execute(args, ctx) {
          return {
            content: "Pong!"
          };
  ...
  var init_silent_typing = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/silent-typing/index.ts"() {
      init_shared();
      context6 = getPluginContext("silent-typing");
  ...
  var init_silent_typing2 = __esm({
    "src/plugins/silent-typing/index.ts"() {
      ...
      settings = definePluginSettings6({
        silentTypingActive: {
          label: "Silent Typing",
      ...
      silent_typing_default = definePlugin6({
        name: "SilentTyping",
  ...
  function patchRealmoji(module3, patcher24, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher24.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher24.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      init_parse();
      init_realshit();
      settings2 = definePluginSettings7({
        emojiSize: {
          type: "slider",
          label: "Display Size",
          points: [
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher24.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher24) {
              patcher24.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher24) {
              patcher24.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher24) {
              patchRealmoji(module3, patcher24, () => settings2.get().realshit);
            }
          }
        ],
        start() {
          settings2.subscribe((state2) => state2, (newState) => {
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native47.Dimensions.get("window");
  ...
  var init_openEmojiActionSheet = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/utils/openEmojiActionSheet.tsx"() {
      init_shared();
      context9 = getPluginContext("expression-utils");
  ...
  var init_expression_utils2 = __esm({
    "src/plugins/expression-utils/index.tsx"() {
      ...
      expression_utils_default = definePlugin8({
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher24.detached.after(props.header, "type", (_2, res) => {
        ...
        start() {
          patcher8.attachDisposer(useEmojiAdderStore.subscribe((s, p2) => {
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              ...
              patcher24.instead(module3, "getIcons", () => mainIcons);
              patcher24.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher24.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              ...
              patcher24.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher24) {
              patcher24.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings3 = definePluginSettings14({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.after(module3.prototype, "render", function() {
  ...
  var init_dummy2 = __esm({
    "src/plugins/_core/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings4 = definePluginSettings18({
        bunnyName: {
          type: "string",
          label: "Bunny Name",
      ...
      dummy_default = definePlugin18({
        ...
        patches: [
          {
            id: "sample-patch",
            predicate: /* @__PURE__ */ __name(() => settings4.get().winterCoat === true, "predicate"),
            target: byProps([
              "toString"
            ]),
            patch(_, patcher24) {
              patcher24.after(window, "sampleMethod", () => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher24) {
              patcher24.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher24) {
              patcher24.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher22.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher22.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher21.before(isThemeModule, "isThemeDark", callback);
    patcher21.before(isThemeModule, "isThemeLight", callback);
    patcher21.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher21.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin20({
        name: "Painter",
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger27.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger27.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger27.warn(`${plugin.$id} already started`);
      return;
    }
    logger27.debug(`Starting plugin '${plugin.$id}'`);
    try {
      ...
      logger27.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
    ...
    var _loop = /* @__PURE__ */ __name(function(eventName2, cb2) {
      var unintercept = interceptFluxEvent((event) => {
        try {
          ...
          logger27.error`${id}: Error while handling ${event.type}: ${e3}`;
        }
      });
      logger27.debug(`Intercepted flux event '${eventName2}' for plugin '${id}'`);
      pluginPatcherContext.attachDisposer(() => {
        unintercept();
        logger27.debug(`Intercepted from flux event '${eventName2}' for plugin '${id}'`);
      });
    }, "_loop");
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher24 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger27.debug(`Applying ${patcher24.id} patch`);
        patcher24.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher24);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger27.debug(`Disposing ${patcher24.id} patch`);
            patcher24.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger27.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger27.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger27.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher24 = getContextualPatcher(id, false);
      if (patcher24) {
        patcher24.dispose();
        patcher24.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger27.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger27, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_utils2();
      init_flux();
      logger27 = blzlogger.createChild("PluginStore");
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher24 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher24.parent = this;
        this.children.push(patcher24);
        return patcher24;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher24);
    return patcher24;
  }
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger28.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var logger29, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger29 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta24 = a.asAddonMetadata();
              return meta24.name.localeCompare(meta24.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
