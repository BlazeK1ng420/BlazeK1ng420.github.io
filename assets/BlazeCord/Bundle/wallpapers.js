        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger26 = new Logger2(name);
              logger26.parent = this;
              logger26.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger26;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger26) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger26.logHandlers.size > 0) {
                  for (var handler of logger26.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger26.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger26) => {
                logger26.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger26) => {
                logger26.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger26) => {
                if (logger26 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger26.logHandlers.has(handler)) {
                    logger26.logHandlers.delete(handler);
                  }
                }
              });
...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context20 = (0, import_react14.useContext)(HighlightContext);
    if (!context20) {
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3, "type", (_, res) => {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "0301a2b07757df623dd8bacbe0a6957b9ea5211b";
      branch = "WallpaperS";
...
(${discord.build})`,
      ...
      settings_default = definePlugin2({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3, "default", (_, ret) => {
        ...
        patches: [
          {
            ...
            patch(_, patcher20) {
              patcher20.after(window, "sampleMethod", () => {
  ...
  function patchRealmoji(module3, patcher20, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher20.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher20.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher20.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher20) {
              patcher20.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher20) {
              patcher20.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher20) {
              patchRealmoji(module3, patcher20, () => settings2.get().realshit);
            }
          }
        ],
        start() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher20.detached.after(props.header, "type", (_2, res) => {
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              ...
              patcher20.instead(module3, "getIcons", () => mainIcons);
              patcher20.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher20.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              ...
              patcher20.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher20) {
              patcher20.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.instead(module3, "isStaffEnv", ([user]) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.after(module3.prototype, "render", function() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher20) {
              patcher20.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher20) {
              patcher20.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger23.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger23.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger23.warn(`${plugin.$id} already started`);
      return;
    }
    logger23.debug(`Starting plugin '${plugin.$id}'`);
    try {
      applyPluginPatches(id, plugin);
      draft.states[id].running = true;
      plugin.start?.();
    } catch (e3) {
      logger23.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher20 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger23.debug(`Applying ${patcher20.id} patch`);
        patcher20.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher20);
        });
      }, "apply");
      ...
      if (settings4 && pluginPatch2.predicate) {
        ...
        var unsub = settings4.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger23.debug(`Disposing ${patcher20.id} patch`);
            patcher20.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger23.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger23.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger23.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher20 = getContextualPatcher(id, false);
      if (patcher20) {
        patcher20.dispose();
        patcher20.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger23.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger23, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger23 = blzlogger.createChild("PluginStore");
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher20 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher20.parent = this;
        this.children.push(patcher20);
        return patcher20;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher20);
    return patcher20;
  }
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger24.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var logger25, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger25 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta20 = a.asAddonMetadata();
              return meta20.name.localeCompare(meta20.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
