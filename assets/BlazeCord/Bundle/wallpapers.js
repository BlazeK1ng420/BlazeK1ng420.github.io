...
(() => {
  ...
  var import_react_native13, screenWidth, screenHeight, styles;
  ...
  function useShallow(selector) {
    var prev = import_react6.default.useRef(void 0);
    return (state2) => {
  ...
  function ToastIcon({ icon }) {
    ...
    if (/* @__PURE__ */ (0, import_react7.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast: toast2 }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react7.useState)(false);
  ...
  var import_react7, import_react_native14;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react8.memo)(/* @__PURE__ */ __name(function Toast({
        toast: toast2
      }) {
        ...
        var onceOnDismiss = (0, import_react8.useCallback)(() => {
          toast2.onDismiss?.();
          hideToast(toast2.id);
        }, [hideToast, toast2]);
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "aaf545ec1e948ddf0d503bc180c194e7fe3eca01";
      branch = "main";
...
${log.errorStack}`;
  ...
  function LogsPage() {
    var [showDebug, setShowDebug] = (0, import_react11.useState)(false);
    var filteredLogs = (0, import_react11.useMemo)(() => {
  ...
  var import_flash_list2, import_react11, import_react_native23;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
...
(${discord.build})`,
  ...
  function useHighlight() {
    var context26 = (0, import_react12.useContext)(HighlightContext);
    if (!context26) {
  ...
  var import_react13, import_react_native33, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  ...
  var import_react14, import_react_native35, logger9;
  ...
  var import_react18, expressions_default;
  ...
  var import_react19, import_react_native43;
  ...
  var import_react20, import_react_native44;
...
${inspect({
  ...
  function AddWallpaperSheet() {
    var [category, setCategory] = (0, import_react21.useState)("");
    var [name, setName] = (0, import_react21.useState)("");
    var [uploading, setUploading] = (0, import_react21.useState)(false);
    var [cdnUrl, setCdnUrl] = (0, import_react21.useState)(null);
  ...
  var import_react21, import_react_native52, WEBHOOK_URL, styles2;
  ...
  function WallpaperManager() {
    ...
    var navigation = NavigationNative.useNavigation();
    return /* @__PURE__ */ jsxs(import_react_native53.View, {
      style: {
        flex: 1
      },
      children: [
        /* @__PURE__ */ jsx("view", {
          children: /* @__PURE__ */ jsx(import_react_native53.View, {
            style: styles3.topBar,
            children: /* @__PURE__ */ jsx(ContextMenu_default, {
              items: [
                {
        ...
        /* @__PURE__ */ jsxs(import_react_native53.ScrollView, {
  ...
  var import_react_native53, styles3;
  var init_Wallpapers = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/index.tsx"() {
      "use strict";
      init_jsxRuntime();
