...
(() => {
  ...
  function WallpaperPreviewSheet({ wallpaper: initialWallpaper }) {
    var { applyWallpaper, deleteWallpaper, clearWallpaper, categories } = useWallpaperStore();
    var [isProcessing, setIsProcessing] = (0, import_react6.useState)(false);
    var [imageError, setImageError] = (0, import_react6.useState)(false);
    var [previewSettings, setPreviewSettings] = (0, import_react6.useState)({
      blur: initialWallpaper?.blur || 0,
      opacity: initialWallpaper?.opacity || 1
    });
    var closeSheet = /* @__PURE__ */ __name(() => hideSheet("WallpaperPreviewSheet"), "closeSheet");
    var blurStyle = import_react_native12.Platform.select({
      ios: {
        shadowColor: "#000",
    ...
    var handleClear = /* @__PURE__ */ __name(() => _async_to_generator(function* () {
      try {
        setIsProcessing(true);
        yield clearWallpaper();
      ...
      children: [
        /* @__PURE__ */ jsx(import_react_native12.View, {
          ...
          children: /* @__PURE__ */ jsx(import_react_native12.View, {
            ...
            children: /* @__PURE__ */ jsx(import_react_native12.Image, {
              source: {
              ...
              resizeMode: "cover",
              onError: /* @__PURE__ */ __name(() => setImageError(true), "onError")
            })
          })
        }),
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "dcf02423cd8c6cc55c6a3fb6bbbd504351a7ebcb";
      branch = "wallpapers";
