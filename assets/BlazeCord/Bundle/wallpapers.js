...
(() => {
  ...
  function PageWrapper(props) {
    ...
    if (props.scrollable) {
      node = /* @__PURE__ */ jsx(import_react_native11.ScrollView, {
        contentContainerStyle: containerStyle,
        children: node
      });
    } else {
      node = /* @__PURE__ */ jsx(import_react_native11.View, {
        style: [
          {
            flex: 1,
            maxHeight: height
  ...
  var import_react_native12, screenWidth, screenHeight, styles;
  ...
  var import_react6, import_react_native20, styles2;
  ...
  var import_react_native21, styles3;
...
${log.errorStack}`;
  ...
  function LogsPage() {
    var [showDebug, setShowDebug] = (0, import_react7.useState)(false);
    var filteredLogs = (0, import_react7.useMemo)(() => {
  ...
  var import_flash_list2, import_react7, import_react_native24;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
  ...
  function DemoToastComponent(props) {
    var [count, setCount] = (0, import_react8.useState)(0);
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react8.useState)({
      id: "toast-demo",
  ...
  var import_react8, import_react_native25, logger4;
  ...
  var import_react9, import_react_native26, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  ...
  function useHighlight() {
    var context25 = (0, import_react12.useContext)(HighlightContext);
    if (!context25) {
  ...
  function ToastIcon({ icon }) {
    ...
    if (/* @__PURE__ */ (0, import_react13.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast: toast2 }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react13.useState)(false);
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react14.memo)(/* @__PURE__ */ __name(function Toast({
        toast: toast2
      }) {
        ...
        var onceOnDismiss = (0, import_react14.useCallback)(() => {
          toast2.onDismiss?.();
          hideToast(toast2.id);
        }, [hideToast, toast2]);
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "b0aa974b17555f1dbedf9e9f65db79866fcd0891";
      branch = "main";
  ...
  function getVersions() {
    ...
    return {
      ...
      react: {
        version: import_react15.default.version
      },
      reactNative: {
  ...
  var import_react15, import_react_native33;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  function UpdaterPage() {
    ...
    (0, import_react16.useEffect)(() => void check(), []);
    return /* @__PURE__ */ jsxs(PageWrapper, {
      scrollable: true,
      containerStyle: {
        paddingTop: 16,
  ...
  var import_react_native36, import_react16;
...
(${discord.build})`,
  ...
  var init_chat_tweaks = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/chat-tweaks/index.ts"() {
      init_shared();
      context11 = getPluginContext("chat-tweaks");
  ...
  var init_chat_tweaks2 = __esm({
    "src/plugins/chat-tweaks/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings2 = definePluginSettings11({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
      ...
      chat_tweaks_default = definePlugin11({
        name: "Chat Tweaks",
  ...
  var init_nitro_icons = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-icons/index.ts"() {
      init_shared();
      context12 = getPluginContext("nitro-icons");
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      init_toasts();
      init_constants();
      nitro_icons_default = definePlugin12({
  ...
  var init_nitro_themes = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-themes/index.ts"() {
      init_shared();
      context13 = getPluginContext("nitro-themes");
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      init_stores();
      init_constants();
      nitro_themes_default = definePlugin13({
  ...
  var init_experiments = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/experiments/index.ts"() {
      init_shared();
      context14 = getPluginContext("experiments");
  ...
  function reinitStore() {
    waitFor(byStoreName("DeveloperExperimentStore", {
      ...
      var unpatch2 = patcher14.detached.instead(Object, "defineProperties", () => {
      });
  ...
  var init_experiments2 = __esm({
    "src/plugins/experiments/index.ts"() {
      ...
      experiments_default = definePlugin14({
        name: "Experiments",
  ...
  var import_react20, import_react_native50;
  ...
  var import_react21, import_react_native51;
  ...
  var init_devtool = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/devtool/index.ts"() {
      init_shared();
      context16 = getPluginContext("devtool");
  ...
  var init_devtool2 = __esm({
    "src/plugins/_core/devtool/index.ts"() {
      ...
      init_node_inspect_extracted();
      init_repl_client();
      devtool_default = definePlugin16({
        ...
        start() {
          ...
          Object.assign(window, {
            ...
            dk: {
              patcher: patcher16,
              snipe(mod, prop) {
                patcher16.after(mod, prop, (args, ret) => {
                  logger20.info(`Sniped ${prop}
${inspect({
                    args,
                    ret
                  })}`);
  ...
  function patchChatBackground() {
    ...
    patcher18.after(Messages, "render", (_, ret) => {
      ...
      if (ChatScreen && bg?.opacity != null) {
        ...
        try {
          var flat = import_react_native53.StyleSheet.flatten(ChatScreen.props.style);
  ...
  var import_react_native53, Messages;
  ...
  var init_wallpapers2 = __esm({
    "src/plugins/_core/wallpapers/index.ts"() {
      ...
      init_constants();
      init_background2();
      wallpapers_default = definePlugin17({
        name: "Wallpapers",
  ...
  var init_dummy = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/dummy/index.ts"() {
      init_shared();
      context19 = getPluginContext("dummy");
  ...
  var init_dummy2 = __esm({
    "src/plugins/_core/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings3 = definePluginSettings19({
        stonerName: {
          type: "string",
          label: "Stoner Name",
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context20 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin20({
        name: "NoTrack",
