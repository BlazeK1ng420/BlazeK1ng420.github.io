        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger25 = new Logger2(name);
              logger25.parent = this;
              logger25.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger25;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger25) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger25.logHandlers.size > 0) {
                  for (var handler of logger25.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger25.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger25) => {
                logger25.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger25) => {
                logger25.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger25) => {
                if (logger25 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger25.logHandlers.has(handler)) {
                    logger25.logHandlers.delete(handler);
                  }
                }
              });
...
${log.errorStack}`;
  ...
  function showAlert(props) {
    ...
    if ("content" in props) {
      content = /* @__PURE__ */ jsx(AlertModal, {
        ...
        actions: props.actions?.map((a, i2) => /* @__PURE__ */ (0, import_react9.isValidElement)(a) ? a : /* @__PURE__ */ jsx(AlertActionButton, {
          ...a
        }, i2))
      });
  ...
  var import_react9, import_react_native17, logger3, AlertStore;
  ...
  function useHighlight() {
    var context19 = (0, import_react11.useContext)(HighlightContext);
    if (!context19) {
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "type", (_, res) => {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "d1202137328194b784c7a235cccf376220780f63";
      branch = "ChatBGs";
  ...
  var import_react_native25, import_react15;
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(TableRowGroup_default, {
          ...
          children: [
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native26.Linking.openURL(`https://${Links.GITHUB}`), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native26.Linking.openURL(`https://${Links.DISCORD}`), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native26.Linking.openURL(`https://${Links.PAYPAL}`), "onPress")
            })
          ]
        })
      ]
      ...
      settings_default = definePlugin2({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "default", (_, ret) => {
        ...
        patches: [
          {
            ...
            patch(_, patcher19) {
              patcher19.after(window, "sampleMethod", () => {
  ...
  function patchRealmoji(module3, patcher19, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher19.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher19.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher19.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher19) {
              patcher19.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher19) {
              patchRealmoji(module3, patcher19, () => settings3.get().realshit);
            }
          }
        ],
        start() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher19.detached.after(props.header, "type", (_2, res) => {
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              ...
              patcher19.instead(module3, "getIcons", () => mainIcons);
              patcher19.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher19.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              ...
              patcher19.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var import_react19, import_react_native39;
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3.prototype, "render", function() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "default", (args, returnValue) => {
                var [user] = args;
                if (!user) return;
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context14 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin14({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher17.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher17.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher16.before(isThemeModule, "isThemeDark", callback);
    patcher16.before(isThemeModule, "isThemeLight", callback);
    patcher16.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher16.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin15({
        name: "Painter",
  ...
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher19 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger22.debug(`Applying ${patcher19.id} patch`);
        patcher19.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher19);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger22.debug(`Disposing ${patcher19.id} patch`);
            patcher19.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    ...
    try {
      var patcher19 = getContextualPatcher(id, false);
      if (patcher19) {
        patcher19.dispose();
        patcher19.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher19 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher19.parent = this;
        this.children.push(patcher19);
        return patcher19;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher19);
    return patcher19;
  }
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger23.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var import_react_native42, tokensModule, determineColorReference;
  ...
  var logger24, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger24 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta19 = a.asAddonMetadata();
              return meta19.name.localeCompare(meta19.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
