...
${log.errorStack}`;
  ...
  function getAddonMeta(addon) {
    var meta15 = addon.asAddonMetadata?.();
    return {
      id: meta15?.id ?? addon.id,
      name: meta15?.name ?? addon.name ?? "StonerMoment",
      description: meta15?.description ?? addon.description ?? "",
      authors: meta15?.authors ?? addon.authors ?? null
    };
  }
  ...
  function CardDevs({ addon }) {
    var { authors } = getAddonMeta(addon);
  ...
  function CardSwitch({ addon, pageProps }) {
    var { id } = getAddonMeta(addon);
    var canToggle = pageProps.useCanHandleAddon(id);
    var [enabled, setEnabled] = pageProps.useToggler(id);
    return /* @__PURE__ */ jsx(import_react_native18.View, {
  ...
  function AddonCard(props) {
    ...
    var { id } = getAddonMeta(addon);
    var handleable = pageProps.useCanHandleAddon(id);
    return /* @__PURE__ */ jsx(Card_default, {
      style: {
  ...
  var init_AddonCard = __esm({
    "src/components/Wintry/Settings/pages/Addon/AddonCard.tsx"() {
      ...
      __name(getAddonMeta, "getAddonMeta");
  ...
  function getAddonMeta2(addon) {
    var meta15 = addon.asAddonMetadata?.();
    return {
      id: meta15?.id ?? addon.id,
      name: meta15?.name ?? addon.name ?? "StonerMoment",
      description: meta15?.description ?? addon.description ?? "",
      authors: meta15?.authors ?? addon.authors ?? []
    };
  }
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        keyExtractor: /* @__PURE__ */ __name((i2) => getAddonMeta2(i2.obj).id, "keyExtractor"),
  ...
  var init_Addon = __esm({
    "src/components/Wintry/Settings/pages/Addon/index.tsx"() {
      ...
      __name(getAddonMeta2, "getAddonMeta");
  ...
  function createAddonCollectionManager({ data, defaultSortOption, defaultFilterOptions, sortOptions, filterOptions, ...props }) {
    var searchTerms = [
      (v) => getAddonMeta3(v).name,
      (v) => getAddonMeta3(v).description,
      (v) => getAddonMeta3(v).authors.map((a) => a.name).join(", "),
      ...props.searchTerms ?? []
    ];
  ...
  var init_AddonCollectionManager = __esm({
    "src/components/Wintry/Settings/pages/Addon/AddonCollectionManager.tsx"() {
      ...
      __name(getAddonMeta3, "getAddonMeta");
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "4df9a21cb8bce3b0dcea4aaaf517eab4eb0eb4bd";
      branch = "stripped";
...
${inspect({
            ...
            if (state2 && state2.themes.length !== 0) {
              var _loop = /* @__PURE__ */ __name(function(theme2) {
                theme2.asAddonMetadata = memoize(() => ({
                  id: theme2.id,
                  name: theme2.display?.name ?? "StonerMoment",
  ...
  function getThemeMeta(theme) {
    if (typeof theme.asAddonMetadata === "function") {
      var meta15 = theme.asAddonMetadata();
      return {
        id: meta15.id ?? theme.id,
        name: meta15.name ?? "StonerMoment",
        description: meta15.description ?? ""
      };
    }
    return {
      id: theme.id,
      name: theme.name ?? "StonerMoment",
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var aName = getThemeMeta(a).name;
              var bName = getThemeMeta(b).name;
