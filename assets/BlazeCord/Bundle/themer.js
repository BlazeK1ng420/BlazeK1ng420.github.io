  ...
  var init_constants = __esm({
    "src/data/constants.ts"() {
      ...
      Links = {
        ...
        SITE: "https://BlazeK1ng420.github.io"
      };
    }
  });
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "8ffd6fc19822ae2490fcb45aec75acbdf08631d5";
      branch = "ThEmEz!";
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(TableRowGroup_default, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TableRow_default, {
              label: t3.settings.general.site(),
              icon: /* @__PURE__ */ jsx(TableRow_default.Icon, {
              ...
              onPress: /* @__PURE__ */ __name(() => openURL(`https://${Links.SITE}`), "onPress")
            })
          ]
        })
      ]
