...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "03bcecf86acfc6c33f716cd29c535baa633cc3d5";
      branch = "master";
...
${inspect({
  ...
  function safeWaitFor(filter, callback) {
    return _async_to_generator(function* () {
      return waitFor(filter, (mod) => {
        if (!mod) {
          console.warn("[UnlockPremiumIcons] Module not found:", filter);
          return;
        }
        try {
          callback(mod);
        } catch (e3) {
          console.error("[UnlockPremiumIcons] Patch error:", e3);
        }
      });
    })();
  }
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      alternateIcons = [];
      mainIcons = [];
      __name(safeWaitFor, "safeWaitFor");
        ...
        onLoad() {
          return _async_to_generator(function* () {
            yield safeWaitFor(byProps([
              ...
              if (!originalAlternate || !originalMain) {
                console.warn("[UnlockPremiumIcons] Icon methods returned undefined.");
                return;
              }
            ...
            yield safeWaitFor(byProps([
              ...
              if (!ids?.FreemiumAppIconIds || !ids?.MasterAppIconIds) {
                console.warn("[UnlockPremiumIcons] Freemium or Master icon IDs are missing.");
                return;
              }
