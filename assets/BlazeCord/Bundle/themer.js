  ...
  var init_constants = __esm({
    "src/data/constants.ts"() {
      ...
      Links = {
        ...
        DISCORD: "https://discord.gg/CxtkRvT6MU",
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "884b63991dc59753b39792665185654fb7d3ef37";
      branch = "ThEmEz!";
              ...
              settings: [
                registerSettingRenderer("BLAZECORD", {
                  ...
                  useTrailing: /* @__PURE__ */ __name(() => {
                    ...
                    var { version: version2, shortRevision, branch: branch2 } = getVersions().blaze;
...
${inspect({
  ...
  // src/plugins/_core/painter/catppuccin-mocha.ts
  var MOCHA_THEME;
    ...
    "src/plugins/_core/painter/catppuccin-mocha.ts"() {
      ...
      MOCHA_THEME = {
        ...
        display: {
          ...
          description: "A wholesome, unofficial, catppuccin theme",
          authors: [
            {
              name: "BlazeCord",
              id: "blazecord"
  ...
  // src/plugins/_core/painter/rose-pink.ts
        ...
        main: {
          ...
          colors: {
            ...
            raw: {
              ...
              GREEN_860: "#00FF8C",
              GREEN_900: "#00FF8C",
              GUILD_BOOSTING_BLUE: "#2D0034",
              GUILD_BOOSTING_BLUE_FOR_GRADIENTS: "#2D0034",
              GUILD_BOOSTING_PINK: "#FF2CD1",
              GUILD_BOOSTING_PURPLE: "#C86AFF",
              GUILD_BOOSTING_PURPLE_FOR_GRADIENTS: "#C86AFF",
              ORANGE_260: "#FA894B",
              ORANGE_300: "#FA894B",
              ORANGE_330: "#FA894B",
              ORANGE_345: "#FA894B",
  ...
  // src/plugins/_core/painter/material-midniight.ts
  var MATERIAL_MIDNIGHT;
  var init_material_midniight = __esm({
    "src/plugins/_core/painter/material-midniight.ts"() {
      "use strict";
      MATERIAL_MIDNIGHT = {
        ...
        display: {
          ...
          description: "Midnight blues with sky-lit accents.",
          authors: [
            {
              name: "BlazeCord",
              id: "blazecord"
        ...
        asAddonMetadata: /* @__PURE__ */ __name(function asAddonMetadata2() {
          throw new Error("Material Midnight is not an addon.");
        }, "asAddonMetadata")
      };
    }
  });

  // src/plugins/_core/painter/material-blossom.ts
  var MATERIAL_BLOSSOM;
  var init_material_blossom = __esm({
    "src/plugins/_core/painter/material-blossom.ts"() {
      "use strict";
      MATERIAL_BLOSSOM = {
        id: "material.blossom",
        type: "theme",
        display: {
          name: "Material Blossom",
          description: "Soft pinks and lavenders for a modern Material You vibe.",
          authors: [
            {
              name: "BlazeCord",
              id: "blazecord"
        ...
        asAddonMetadata: /* @__PURE__ */ __name(function asAddonMetadata3() {
          throw new Error("This theme isn't designed as an addon.");
        }, "asAddonMetadata")
      };
    }
  });

  // src/plugins/_core/painter/cyberwave.ts
  var CYBERWAVE;
  var init_cyberwave = __esm({
    "src/plugins/_core/painter/cyberwave.ts"() {
      "use strict";
      CYBERWAVE = {
        id: "cyberwave.blue",
        ...
        display: {
          name: "Cyberwave",
          description: "AMOLED dark meets neon teal & violet.",
          authors: [
            {
              name: "BlazeCord",
              id: "blazecord"
        ...
        asAddonMetadata: /* @__PURE__ */ __name(function asAddonMetadata4() {
          throw new Error("This theme isn't designed as an addon.");
        }, "asAddonMetadata")
      };
    }
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_rose_pink();
      init_purple_haze();
      init_material_midniight();
      init_material_blossom();
      init_cyberwave();
