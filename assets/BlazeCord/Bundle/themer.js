...
${log.errorStack}`;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_1148071943580_init_data = {
        ...
        location: "/home/blaze/coding/discord/redux/redux/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["/home/blaze/coding/discord/redux/redux/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.18.0"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "/home/blaze/coding/discord/redux/redux/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["/home/blaze/coding/discord/redux/redux/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.18.0"
      };
        ...
        return /* @__PURE__ */ jsx(import_react_native_gesture_handler.GestureDetector, {
          ...
          children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
            ...
            children: /* @__PURE__ */ jsx(PressableScale_default, {
              ...
              children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
                style: [animatedStyles, styles2.container, toast.contentContainerStyle],
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "f2131bfda654b926dfc1871bdfdd93f85416d41e";
      branch = "redux";
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native32.View, {
          style: styles2.centeredContainer,
          children: [
...
${inspect({
  ...
  function injectMetadata(theme) {
    if (!theme.asAddonMetadata) {
  ...
  function applyTheme(id, update) {
    ...
    if (id && ref) {
      ...
      tokenRefModule.wait((tokenRef) => {
        ...
        for (var k of Object.keys(tokenRef.Shadow)) {
          tokenRef.Shadow[k][ref.key] = tokenRef.Shadow[k][ref.color.reference];
        }
        for (var k1 of Object.keys(tokenRef.SemanticColor)) {
    ...
    if (update) {
      var allThemes = useThemeStore.getState().getAllThemes();
      var manifest = id ? allThemes.find((t4) => t4.id === id) ?? null : null;
      var base = ref?.color.reference || manifest?.main?.base || "darker";
      UserSettingsActionCreators.setShouldSyncAppearanceSettings(false);
      UserSettingsActionCreators.updateTheme(ref ? ref.key : base);
    }
  }
  var logger20, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, builtInThemes, useThemeStore;
    ...
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      useThemeStore = create()(persist((set2, get) => ({
        ...
        setThemeRef: /* @__PURE__ */ __name((id) => {
          ...
          if (id != null) {
            var theme = get().getAllThemes().find((t4) => t4.id === id);
            if (!theme) {
              throw new Error(`Theme is not installed: ${id}`);
            }
            set2({
              appliedTheme: id,
              currentRef: {
        ...
        addUserTheme: /* @__PURE__ */ __name((theme) => {
          injectMetadata(theme);
          if (!get().userThemes.some((t4) => t4.id === theme.id)) {
            set2((state2) => ({
              userThemes: [
                ...state2.userThemes,
                theme
        ...
        removeUserTheme: /* @__PURE__ */ __name((id) => {
          set2((state2) => ({
            userThemes: state2.userThemes.filter((t4) => t4.id !== id)
          }));
        }, "removeUserTheme")
      }), {
        name: "theme-store",
        ...
        storage: createJSONStorage(() => kvStorage),
        partialize: /* @__PURE__ */ __name((state2) => ({
          userThemes: state2.userThemes,
          appliedTheme: state2.appliedTheme
        }), "partialize"),
        onRehydrateStorage() {
          return (state2) => {
            if (state2?.userThemes?.length) {
              for (var theme of state2.userThemes) {
                injectMetadata(theme);
              }
            }
          };
  ...
  function Themes() {
    return /* @__PURE__ */ jsxs(import_react_native43.View, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native43.TouchableOpacity, {
          style: styles.fab,
          onPress: /* @__PURE__ */ __name(() => {
            console.log("Create Theme Pressed");
          }, "onPress"),
          children: /* @__PURE__ */ jsx(import_react_native43.Text, {
  ...
  var import_react_native43, themeCollectionManager, styles;
  var init_Themes = __esm({
    "src/components/Wintry/Settings/pages/Themes/index.tsx"() {
      ...
      themeCollectionManager = createAddonCollectionManager({
        data: /* @__PURE__ */ __name(() => useThemeStore.getState().getAllThemes(), "data"),
        defaultFilterOptions: [],
        defaultSortOption: "A-Z",
        sortOptions: [
          {
      ...
      styles = import_react_native43.StyleSheet.create({
        fab: {
          position: "absolute",
          bottom: 24,
          right: 24,
