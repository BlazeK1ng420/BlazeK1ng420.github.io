...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "cf77f51e3f085ea6e89393e2f8880292c584a0f4";
      branch = "stripped";
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      useThemeStore = create(persist((set2, get) => ({
        ...
        onRehydrateStorage() {
          return (state2) => {
            if (state2 && Array.isArray(state2.themes)) {
              var _loop = /* @__PURE__ */ __name(function(theme2) {
                Object.defineProperty(theme2, "asAddonMetadata", {
                  enumerable: false,
                  configurable: true,
                  writable: true,
                  value: memoize(() => ({
                    id: theme2.id,
                    name: theme2.display.name?.trim() || "Stoner Moment",
        ...
        partialize: /* @__PURE__ */ __name((s) => ({
          appliedTheme: s.appliedTheme,
          themes: s.themes,
          setThemeRef: s.setThemeRef,
          currentRef: null
        }), "partialize")
      }));
