...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "5eb63a6dc436709c9667fd54aeeda41f893b10dc";
      branch = "emojis";
...
(${discord.build})`,
  ...
  var init_nitroChecks2 = __esm({
    "src/plugins/nitro-emoji/patches/nitroChecks.ts"() {
      ...
      init_nitroChecks();
      init_wrappers();
      nitroInfo = lookupByProps("canUseEmojisEverywhere", "canUseAnimatedEmojis");
      nitroChecks_default = [
        patcher7.instead(nitroInfo, "canUseEmojisEverywhere", () => true),
        patcher7.instead(nitroInfo, "canUseAnimatedEmojis", () => true)
      ];
    }
  });
