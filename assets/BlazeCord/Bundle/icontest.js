...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context18 = (0, import_react13.useContext)(HighlightContext);
    if (!context18) {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "6e2a3156d371597d213a22d6280917271a049ba5";
      branch = "Nitro-Icons";
...
(${discord.build})`,
  ...
  // plugins-context-provider:#plugin-context#src/plugins/message-bubbles/index.ts
  var context3, meta3, definePlugin3, definePluginSettings3, logger7, patcher3;
  var init_message_bubbles = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/message-bubbles/index.ts"() {
      init_shared();
      context3 = getPluginContext("message-bubbles");
  ...
  var import_react_native32, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native32.processColor)(args[2]))
          ], "configure")
        }
      });
    }
  ...
  // src/loader/modules/BubbleHookManager.ts
  var BubbleHookManager_exports = {};
  __export(BubbleHookManager_exports, {
    configureBubbleModule: () => configureBubbleModule,
    safeHookBubbles: () => safeHookBubbles,
    safeUnhookBubbles: () => safeUnhookBubbles
  });
  function safeHookBubbles() {
    return _safeHookBubbles.apply(this, arguments);
  }
  function _safeHookBubbles() {
    _safeHookBubbles = _async_to_generator(function* () {
      if (activePluginCount === 0) {
        yield BubbleModule_default.hookBubbles();
      }
      activePluginCount++;
    });
    return _safeHookBubbles.apply(this, arguments);
  }
  function safeUnhookBubbles() {
    return _safeUnhookBubbles.apply(this, arguments);
  }
  function _safeUnhookBubbles() {
    _safeUnhookBubbles = _async_to_generator(function* () {
      activePluginCount = Math.max(activePluginCount - 1, 0);
      if (activePluginCount === 0) {
        yield BubbleModule_default.unhookBubbles();
      }
    });
    return _safeUnhookBubbles.apply(this, arguments);
  }
  function configureBubbleModule(_) {
    return _configureBubbleModule.apply(this, arguments);
  }
  function _configureBubbleModule() {
    _configureBubbleModule = _async_to_generator(function* ({ avatarRadius, bubbleRadius, bubbleColor }) {
      if (avatarRadius !== void 0) currentAvatar = avatarRadius;
      if (bubbleRadius !== void 0) currentBubble = bubbleRadius;
      if (bubbleColor !== void 0) currentColor = bubbleColor;
      yield BubbleModule_default.configure(currentAvatar, currentBubble, currentColor);
    });
    return _configureBubbleModule.apply(this, arguments);
  }
  var activePluginCount, currentAvatar, currentBubble, currentColor;
  var init_BubbleHookManager = __esm({
    "src/loader/modules/BubbleHookManager.ts"() {
      "use strict";
      init_async_to_generator();
      init_BubbleModule();
      activePluginCount = 0;
      currentAvatar = void 0;
      currentBubble = void 0;
      currentColor = void 0;
      __name(safeHookBubbles, "safeHookBubbles");
      __name(_safeHookBubbles, "_safeHookBubbles");
      __name(safeUnhookBubbles, "safeUnhookBubbles");
      __name(_safeUnhookBubbles, "_safeUnhookBubbles");
      __name(configureBubbleModule, "configureBubbleModule");
      __name(_configureBubbleModule, "_configureBubbleModule");
    }
  });

  // src/plugins/message-bubbles/index.ts
  var message_bubbles_exports = {};
  __export(message_bubbles_exports, {
    default: () => message_bubbles_default
  });
  var settings2, message_bubbles_default;
  var init_message_bubbles2 = __esm({
    "src/plugins/message-bubbles/index.ts"() {
      "use strict";
      init_async_to_generator();
      init_message_bubbles();
      init_constants();
      init_libraries();
      init_stores();
      init_modules();
      init_shallow3();
      init_BubbleHookManager();
      ...
      message_bubbles_default = definePlugin3({
        name: "ChatBubbles",
        ...
        start() {
          return _async_to_generator(function* () {
            ...
            var updateBubble = /* @__PURE__ */ __name(() => {
              var { bubbleChatRadius } = settings2.get();
              var color = getBubbleColor();
              configureBubbleModule({
                bubbleRadius: bubbleChatRadius,
                bubbleColor: color
              }).catch(logger7.error);
            }, "updateBubble");
            waitFor(byStoreName("ThemeStore"), (ThemeStore2) => {
              ThemeStore2.addChangeListener(updateBubble);
            });
...
${inspect({
  ...
  // plugins-context-provider:#plugin-context#src/plugins/avatar-shape/index.ts
  var context10, meta10, definePlugin10, definePluginSettings10, logger14, patcher10;
  var init_avatar_shape = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/avatar-shape/index.ts"() {
      init_shared();
      context10 = getPluginContext("avatar-shape");
  ...
  // src/plugins/avatar-shape/index.ts
  var avatar_shape_exports = {};
  __export(avatar_shape_exports, {
    default: () => avatar_shape_default
  });
  var settings4, avatar_shape_default;
  var init_avatar_shape2 = __esm({
    "src/plugins/avatar-shape/index.ts"() {
      "use strict";
      init_async_to_generator();
      init_avatar_shape();
      ...
      avatar_shape_default = definePlugin10({
        name: "AvatarCustomizer",
        description: "Customize in-chat avatar shapes~",
        authors: [
          Devs.Blaze
        ],
        start() {
          return _async_to_generator(function* () {
            yield safeHookBubbles();
            var updateAvatar = /* @__PURE__ */ __name(() => {
              var { avatarRadius } = settings4.get();
              configureBubbleModule({
                avatarRadius
              }).catch(logger14.error);
            }, "updateAvatar");
            waitFor(byProps([
              "_interceptors",
              "subscribe"
              ...
              for (var event of [
                ...
                FluxDispatcher2.subscribe(event, updateAvatar);
              }
            });
  ...
  var settings5, chat_bubbles_default;
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings5 = definePluginSettings11({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
      ...
      chat_bubbles_default = definePlugin11({
        ...
        start() {
          ...
          var getBubbleColor = /* @__PURE__ */ __name(() => {
            var userColor = settings5.get().bubbleChatColor;
            if (userColor) return userColor;
            var token = tokens.colors.BG_BASE_TERTIARY;
            return tokens.internal.resolveSemanticColor(ThemeStore.theme, token);
          }, "getBubbleColor");
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            var { avatarRadius, bubbleChatRadius } = settings5.get();
            var color = getBubbleColor();
  ...
  function patchDefinitionAndResolver() {
    ...
    patcher15.instead(tokensModule.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/discord/blazecord/src/plugins"() {
      plugins_default = {
        ...
        "message-bubbles": (init_message_bubbles2(), __toCommonJS(message_bubbles_exports)).default("/message-bubbles"),
        ...
        "avatar-shape": (init_avatar_shape2(), __toCommonJS(avatar_shape_exports)).default("/avatar-shape"),
  ...
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      ...
      var settings6 = getPluginSettings(id);
      if (settings6 && pluginPatch2.predicate) {
        var { predicate } = pluginPatch2;
        var unsub = settings6.subscribe(() => predicate(), () => {
          if (predicate()) {
            apply();
          } else {
  ...
  function initializePlugins() {
    ...
    var { startPlugin: startPlugin2, settings: settings6 } = usePluginStore.getState();
    for (var id in PLUGINS) {
      if (settings6[id].enabled) {
        startPlugin2(id);
      }
    }
  }
  ...
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger21 = wtlogger.createChild("PluginStore");
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      logger23 = wtlogger.createChild("useThemeStore");
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "loader/modules/BubbleHookManager": createModuleProxy(() => (init_BubbleHookManager(), __toCommonJS(BubbleHookManager_exports))),
