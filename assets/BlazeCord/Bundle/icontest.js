...
(() => {
  ...
  var require_inspect = __commonJS({
    "node_modules/node-inspect-extracted/dist/inspect.js"(exports, module4) {
      !function(t4, e3) {
        "object" == typeof exports && "object" == typeof module4 ? module4.exports = e3() : "function" == typeof define && define.amd ? define([], e3) : "object" == typeof exports ? exports.util = e3() : t4.util = e3();
      }(exports, () => (() => {
        "use strict";
        var t4 = {
          765: (t5, e4) => {
  ...
  function getNativeModule(...names) {
    ...
    var module4 = names.find((name) => moduleProxy[name] !== null);
    return moduleProxy[module4];
  }
  ...
  function isModuleRegistered(module4) {
    return loaderPayload.loader.modules[module4] !== void 0;
  }
  function isFunctionRegistered(module4, function_) {
    return loaderPayload.loader.modules[module4]?.functions[function_] !== void 0;
  }
  function callFunction(module4, functionName, args) {
    return _callFunction.apply(this, arguments);
  }
  function _callFunction() {
    _callFunction = _async_to_generator(function* (module4, functionName, args) {
      if (!isFunctionRegistered(module4, functionName)) {
        throw new Error(`Function ${module4}.${functionName} is not registered`);
      }
      ...
      if ("cancelled" in result) {
        throw new Error(`Function ${module4}.${functionName} was cancelled: ${result.reason}`);
      }
      if ("err" in result) {
  ...
  function getModule({ name, argumentProcessors: processArgs }) {
    ...
    var module4 = loaderPayload.loader.modules[name];
    if (!module4) {
    ...
    for (var [functionName] of Object.entries(module4.functions)) _loop(functionName);
    return baseObject;
  }
  ...
  var require_synchronous_promise = __commonJS({
    "node_modules/synchronous-promise/index.js"(exports, module4) {
      "use strict";
  ...
  var init_lazy2 = __esm({
    "src/metro/lazy.ts"() {
      ...
      LazyModuleContext = /* @__PURE__ */ function() {
        "use strict";
        function LazyModuleContext2(module4) {
  ...
  function getPropLazy(prop) {
    return lazyValue(() => module2.load()[prop]);
  }
  var module2, AlertModal, AlertModalContainer, AlertActionButton, AlertActions, useDismissModalCallback;
  var init_AlertModal = __esm({
    "src/components/Discord/AlertModal/AlertModal.tsx"() {
      "use strict";
      init_wrappers();
      init_lazy();
      module2 = lookupByProps("AlertModal", "AlertActions");
  ...
  var module3, useSegmentedControlState;
  var init_SegmentedControlState = __esm({
    "src/components/Discord/SegmentedControl/SegmentedControlState.tsx"() {
      "use strict";
      init_wrappers();
      module3 = lookupByProps("useSegmentedControlState");
      useSegmentedControlState = /* @__PURE__ */ __name((args) => {
        return module3.load().useSegmentedControlState(args);
  ...
  var require_react_native = __commonJS({
    "globals:react-native"(exports, module4) {
      module4.exports = (init_depsModule(), __toCommonJS(depsModule_exports)).default["react-native"];
    }
  });

  // globals:react
  var require_react = __commonJS({
    "globals:react"(exports, module4) {
      module4.exports = (init_depsModule(), __toCommonJS(depsModule_exports)).default["react"];
    }
  });
  ...
  var require_i18n_util = __commonJS({
    "lazy-resolver:./i18n-util"(exports, module4) {
      module4.exports = (init_lazy(), __toCommonJS(lazy_exports)).createLazyImportProxy(
  ...
  var require_i18n_util2 = __commonJS({
    "lazy-resolver:./i18n-util.sync"(exports, module4) {
      module4.exports = (init_lazy(), __toCommonJS(lazy_exports)).createLazyImportProxy(
  ...
  var CirclePlusIcon, CircleMinusIcon, ArrowSmallLeftIcon, ActivitiesIcon, WrenchIcon, DownloadIcon, PaintPaletteIcon, PuzzlePieceIcon, CircleInformationIcon, CircleCheckIcon, WarningIcon;
  ...
  var require_flash_list = __commonJS({
    "globals:@shopify/flash-list"(exports, module4) {
      module4.exports = (init_depsModule(), __toCommonJS(depsModule_exports)).default["@shopify/flash-list"];
    }
  });
...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context20 = (0, import_react13.useContext)(HighlightContext);
    if (!context20) {
  ...
  var require_fuzzysort = __commonJS({
    "node_modules/fuzzysort/fuzzysort.js"(exports, module4) {
      init_call_super();
      init_class_call_check();
      init_create_class();
      init_inherits();
      ...
      ((root, UMD) => {
        ...
        else if (typeof module4 === "object" && module4.exports) module4.exports = UMD();
    ...
    "node_modules/immer/dist/immer.mjs"() {
      ...
      Immer2 = /* @__PURE__ */ function() {
        ...
        _create_class(Immer22, [
          ...
          {
            key: "applyPatches",
            value: /* @__PURE__ */ __name(function applyPatches2(base, patches2) {
              var i2;
              for (i2 = patches2.length - 1; i2 >= 0; i2--) {
                var patch = patches2[i2];
              ...
              if (i2 > -1) {
                patches2 = patches2.slice(i2 + 1);
              }
              var applyPatchesImpl = getPlugin("Patches").applyPatches_;
              if (isDraft(base)) {
                return applyPatchesImpl(base, patches2);
              }
              return this.produce(base, (draft) => applyPatchesImpl(draft, patches2));
            }, "applyPatches")
          }
        ]);
        return Immer22;
  ...
  var require_react_native_reanimated = __commonJS({
    "globals:react-native-reanimated"(exports, module4) {
      module4.exports = (init_depsModule(), __toCommonJS(depsModule_exports)).default["react-native-reanimated"];
    }
  });

  // globals:react-native-gesture-handler
  var require_react_native_gesture_handler = __commonJS({
    "globals:react-native-gesture-handler"(exports, module4) {
      module4.exports = (init_depsModule(), __toCommonJS(depsModule_exports)).default["react-native-gesture-handler"];
    }
  });
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_13316524972762_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx2","e","translationX","__closure","value"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.16.7"
      };
      ...
      _worklet_7325651134036_init_data = {
        ...
        location: "/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx6","event","translationY","__closure","value","y"],"sources":["/home/blaze/coding/discord/blazecord/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.16.7"
      };
  ...
  var byStoreName, UserStore, ChannelStore, SelectedChannelStore, GuildStore, SelectedGuildStore, DeveloperExperimentStore, ToastStore, PermissionStore, EmojiStore, ThemeStore;
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              patcher20.after(module4, "type", (_, res) => {
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "1edca4d1adf72b16898dab7a8945a57a65867d43";
      branch = "emojis";
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(TableRowGroup_default, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              icon: /* @__PURE__ */ jsx(TableRow_default.Icon, {
                source: findAssetId("img_account_sync_paypal_light")
              }),
              arrow: true,
              trailing: /* @__PURE__ */ jsx(TableRow_default.TrailingText, {
                text: Links.PAYPAL
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              var origRendererConfig = module4.SETTING_RENDERER_CONFIG;
              Object.defineProperty(module4, "SETTING_RENDERER_CONFIG", {
                enumerable: true,
                configurable: true,
                get: /* @__PURE__ */ __name(() => ({
                  ...origRendererConfig,
              ...
              patcher20.attachDisposer(() => {
                module4.SETTING_RENDERER_CONFIG = origRendererConfig;
              });
            }
          },
          {
            ...
            patch(module4, patcher20) {
              patcher20.after(module4, "default", (_, ret) => {
            ...
            registerSettingSection({
              ...
              settings: [
                registerSettingRenderer("BLAZECORD", {
                  ...
                  screen: {
                    route: "BLAZECORD",
                    getComponent: /* @__PURE__ */ __name(() => /* @__PURE__ */ (0, import_react19.lazy)(() => Promise.resolve().then(() => (init_General(), General_exports))), "getComponent")
                  }
                }),
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              patcher20.after(module4, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module4, patcher20) {
              patcher20.after(module4, "MessageReactionsContent", (_, { props }) => {
  ...
  // plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/index.tsx
  var context6, meta6, definePlugin6, definePluginSettings6, logger10, patcher6;
  var init_nitro_emoji = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/index.tsx"() {
      init_shared();
      context6 = getPluginContext("nitro-emoji");
  ...
  // plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/patches/nitroChecks.ts
  var context7, meta7, definePlugin7, definePluginSettings7, logger11, patcher7;
  var init_nitroChecks = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/patches/nitroChecks.ts"() {
      init_shared();
      context7 = getPluginContext("nitro-emoji");
  ...
  // src/plugins/nitro-emoji/patches/nitroChecks.ts
  var nitroInfo, nitroChecks_default;
  var init_nitroChecks2 = __esm({
    "src/plugins/nitro-emoji/patches/nitroChecks.ts"() {
      "use strict";
      init_filters2();
      init_nitroChecks();
      ...
      nitroChecks_default = [
        patcher7.instead(module, "canUseEmojisEverywhere", () => nitroInfo, true),
        patcher7.instead(module, "canUseAnimatedEmojis", () => nitroInfo, true)
      ];
    }
  });

  // plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/patches/sendMessage.ts
  var context8, meta8, definePlugin8, definePluginSettings8, logger12, patcher8;
  var init_sendMessage = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/patches/sendMessage.ts"() {
      init_shared();
      context8 = getPluginContext("nitro-emoji");
  ...
  // plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/settings.ts
  var context9, meta9, definePlugin9, definePluginSettings9, logger13, patcher9;
  var init_settings4 = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emoji/settings.ts"() {
      init_shared();
      context9 = getPluginContext("nitro-emoji");
  ...
  // src/plugins/nitro-emoji/settings.ts
  var settings3;
    ...
    "src/plugins/nitro-emoji/settings.ts"() {
      ...
      settings3 = definePluginSettings9({
        emojiSize: {
          type: "select",
          label: "Emoji Size",
          description: "Choose your emoji preview size.",
          options: [
            {
              label: "Tiny",
              value: 16
        ...
        hyperlink: {
          ...
          description: "Make emoji links clickable and less distracting",
          default: true
        },
        forceMoji: {
          type: "boolean",
          label: "Force Freemoji",
          description: "Force emoji spoofing even if you have Nitro (for testing)",
          default: false
        }
      });
    }
  ...
  // src/plugins/nitro-emoji/msgProcessor.ts
  function extractUnusableEmojis(messageString, size) {
    var emojiMatches = messageString.matchAll(/<a?:(\w+):(\d+)>/gi);
    var currentChannelId = SelectedChannelStore.getChannelId();
    var currentGuildId = ChannelStore.getChannel(currentChannelId)?.guild_id;
    for (var match of emojiMatches) {
      var [full, name, id] = match;
      var emoji = EmojiStore.getCustomEmojiById?.(id);
      if (!emoji) continue;
      var isExternal = emoji.guildId !== currentGuildId || emoji.animated;
      if (!isExternal) continue;
      var ext = emoji.animated ? "gif" : "webp";
      var url = `https://cdn.discordapp.com/emojis/${id}.${ext}?size=${size}&quality=lossless&name=${name}`;
      messageString = messageString.replace(full, settings3.get().hyperlink ? `[${name}](${url})` : url);
    }
    return {
  ...
  function modifyIfNeeded(msg) {
    ...
    if (!settings3.get().forceMoji && haveNitro) return;
    var size = Number(settings3.get().emojiSize) || 48;
    var { newContent } = extractUnusableEmojis(msg.content, size);
    msg.content = newContent;
    msg.invalidEmojis = [];
  }
  var hasEmotesRegex;
  var init_msgProcessor = __esm({
    "src/plugins/nitro-emoji/msgProcessor.ts"() {
      "use strict";
      init_settings5();
      init_nitro_emoji2();
      ...
      __name(extractUnusableEmojis, "extractUnusableEmojis");
      __name(modifyIfNeeded, "modifyIfNeeded");
    }
  });

  // src/plugins/nitro-emoji/patches/sendMessage.ts
  var MessageActions, UploadActions, sendMessage_default;
  var init_sendMessage2 = __esm({
    "src/plugins/nitro-emoji/patches/sendMessage.ts"() {
      ...
      init_filters2();
      init_msgProcessor();
      MessageActions = byProps([
        "sendMessage",
        "receiveMessage"
      ]);
      UploadActions = byProps([
        "uploadLocalFiles"
      ]);
      sendMessage_default = [
        patcher8.before(MessageActions, "sendMessage", ([channelId, msg]) => {
          modifyIfNeeded(msg);
        }),
        ...UploadActions ? [
          patcher8.before(UploadActions, "uploadLocalFiles", ([args]) => {
            if (args?.parsedMessage) modifyIfNeeded(args.parsedMessage);
          })
        ] : []
      ];
    }
  ...
  // src/plugins/nitro-emoji/index.tsx
  var nitro_emoji_exports = {};
  __export(nitro_emoji_exports, {
    default: () => nitro_emoji_default,
    haveNitro: () => haveNitro
  });
  var patches, haveNitro, nitro_emoji_default;
  var init_nitro_emoji2 = __esm({
    "src/plugins/nitro-emoji/index.tsx"() {
      "use strict";
      init_nitro_emoji();
      init_stores();
      ...
      haveNitro = UserStore.getCurrentUser()?.premiumType !== null;
      nitro_emoji_default = definePlugin6({
        name: "Nitro Emoji",
        id: "nitro-emoji",
        description: "Spoof Nitro emoji checks and customize emoji behavior",
        authors: [
          Devs.Blaze
        ],
        settings: settings3,
        onUnload() {
          patches.forEach((p2) => p2());
        }
      });
    }
  });
  ...
  var init_devtoolkit = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/devtoolkit/index.ts"() {
      init_shared();
      context10 = getPluginContext("devtoolkit");
  ...
  var init_devtoolkit2 = __esm({
    "src/plugins/devtoolkit/index.ts"() {
      ...
      init_node_inspect_extracted();
      init_repl_client();
      devtoolkit_default = definePlugin10({
        name: "DevToolkit",
        ...
        start() {
          ...
          Object.assign(window, {
            ...
            dk: {
              patcher: patcher10,
              snipe(mod, prop) {
                patcher10.after(mod, prop, (args, ret) => {
                  logger14.info(`Sniped ${prop}
${inspect({
                    args,
                    ret
                  })}`);
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      nitro_icons_default = definePlugin11({
        name: "Nitro AppIcons",
        description: "Unlock all AppIcons by spoofing Nitro checks.",
        authors: [
          Devs.Blaze
        ],
        patches: [
          {
            ...
            patch(module4, patcher20) {
              var altIcons = module4.getOfficialAlternateIcons();
              var mainIcons = module4.getIcons();
              ...
              patcher20.instead(module4, "getIcons", () => mainIcons);
              patcher20.instead(module4, "getOfficialAlternateIcons", () => altIcons);
              patcher20.after(module4, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
          ...
          {
            id: "unlock-app-icon-ids",
            target: byProps([
              "FreemiumAppIconIds",
              "MasterAppIconIds"
            ]),
            patch(module4) {
              originalFreemiumAppIconIds = module4.FreemiumAppIconIds;
              module4.FreemiumAppIconIds = module4.MasterAppIconIds;
            }
          }
        ],
        start() {
  ...
  var init_experiments = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/experiments/index.ts"() {
      init_shared();
      context12 = getPluginContext("experiments");
  ...
  function reinitStore() {
    waitFor(byStoreName("DeveloperExperimentStore", {
      ...
      var unpatch2 = patcher12.detached.instead(Object, "defineProperties", () => {
      });
  ...
  var init_experiments2 = __esm({
    "src/plugins/experiments/index.ts"() {
      ...
      experiments_default = definePlugin12({
        name: "Experiments",
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              patcher20.instead(module4, "isStaffEnv", ([user]) => {
  ...
  var init_chat_bubbles = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/chat-bubbles/index.ts"() {
      init_shared();
      context13 = getPluginContext("chat-bubbles");
    ...
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      settings4 = definePluginSettings13({
        ...
        bubbleChatColor: {
          ...
          description: "Desired chat bubble color (#RRGGBBAA format). Defaults to BG_BASE_TERTIARY",
          validate: /* @__PURE__ */ __name((value) => /^#[0-9A-Fa-f]{8}$/.test(value), "validate")
        }
      });
      chat_bubbles_default = definePlugin13({
        name: "ChatBubbles",
        description: "Adds customizable Kik-style chat bubbles.",
        authors: [
          Devs.Blaze
        ],
        start() {
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              patcher20.after(module4.prototype, "render", function() {
                var { state: { error } } = this;
                if (!error) return null;
                logger18.error(error.stack);
        ...
        patches: [
          {
            ...
            patch(module4, patcher20) {
              patcher20.instead(module4, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module4, patcher20) {
              patcher20.instead(module4, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchDefinitionAndResolver() {
    ...
    patcher17.instead(tokensModule.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/discord/blazecord/src/plugins"() {
      plugins_default = {
        ...
        "nitro-emoji": (init_nitro_emoji2(), __toCommonJS(nitro_emoji_exports)).default("/nitro-emoji"),
  ...
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      ...
      var apply = /* @__PURE__ */ __name(() => {
        ...
        patcher20.reuse();
        waitFor(pluginPatch2.target, (module4) => {
          pluginPatch2.patch(module4, patcher20);
        });
      }, "apply");
  ...
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger23 = wtlogger.createChild("PluginStore");
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      logger25 = wtlogger.createChild("useThemeStore");
