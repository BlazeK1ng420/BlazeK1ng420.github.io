...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "0e870db7b02b65f585e143d90ffa385ec5f25378";
      branch = "emojis";
...
(${discord.build})`,
  ...
  function modifyIfNeeded(msg) {
    ...
    var emojiMod = lookupByProps("getCustomEmojiById");
    var guildMod = lookupByProps("getGuildId");
    var getCustomEmojiById = emojiMod.getCustomEmojiById;
    var getGuildId = guildMod.getGuildId;
    var size = settings3.get().emojiSize;
