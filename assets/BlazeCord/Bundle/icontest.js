...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "c09535e9252c327b589e57f5b3e11eaeed84aea3";
      branch = "emojis";
...
(${discord.build})`,
  ...
  var nitroModule, nitroChecks_default;
  var init_nitroChecks = __esm({
    "src/plugins/nitro-emoji/patches/nitroChecks.ts"() {
      ...
      nitroChecks_default = [
        {
          id: "nitro-canUseEmojisEverywhere",
          target: nitroModule,
          patch(module3, patcher18) {
            return patcher18.instead(module3, "canUseEmojisEverywhere", () => true);
          }
        },
        {
          id: "nitro-canUseAnimatedEmojis",
          target: nitroModule,
          patch(module3, patcher18) {
            return patcher18.instead(module3, "canUseAnimatedEmojis", () => true);
          }
        }
      ];
    }
  ...
  var MessageModule, UploadModule, sendMessage_default;
  var init_sendMessage = __esm({
    "src/plugins/nitro-emoji/patches/sendMessage.ts"() {
      "use strict";
      init_filters2();
      init_msgProcessor();
      MessageModule = byProps([
        "sendMessage",
        "receiveMessage"
      ]);
      UploadModule = byProps([
        "uploadLocalFiles"
      ]);
      sendMessage_default = [
        {
          id: "patch-sendMessage",
          target: MessageModule,
          patch(module3, patcher18) {
            return patcher18.before(module3, "sendMessage", (args) => {
        ...
        ...UploadModule ? [
          {
            id: "patch-uploadLocalFiles",
            target: UploadModule,
            patch(module3, patcher18) {
              return patcher18.before(module3, "uploadLocalFiles", (args) => {
                var parsedMessage = args[0]?.parsedMessage;
                if (parsedMessage) modifyIfNeeded(parsedMessage);
              });
            }
          }
        ] : []
  ...
  var haveNitro, nitro_emoji_default;
