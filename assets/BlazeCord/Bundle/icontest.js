...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "e758a1a6af1fd1214e41dc08bb29900317cfd968";
      branch = "Gradients";
  ...
  var init_nitro_emoji2 = __esm({
    "src/plugins/nitro-emoji/index.ts"() {
      ...
      settings3 = definePluginSettings6({
        ...
        hyperlink: {
          type: "boolean",
          label: "Hyperlink Emojis",
          description: "Use markdown link [name](url)",
          default: true
        },
        forceMoji: {
          type: "boolean",
          label: "Override Nitro",
          description: "Apply plugin even if user has Nitro",
          default: false
        }
      });
      haveNitro = false;
      nitro_emoji_default = definePlugin6({
        name: "Unlock NitroMoji's",
        description: "Use any emoji anywhere, even without Nitro.",
        authors: [
          Devs.Blaze
        ],
        patches: [
          {
            id: "disable-nitro-checks",
            target: byProps([
          ...
          },
          {
            ...
            patch(module3, patcher18) {
              patcher18.before(module3, "sendMessage", ([, msg]) => {
                var user = getStore("UserStore")?.getCurrentUser?.();
          ...
          {
            id: "intercept-upload-local-files",
            target: byProps([
              "uploadLocalFiles"
            ]),
            patch(module3, patcher18) {
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      nitro_themes_default = definePlugin9({
        name: "Free Client Themes",
        description: "Unlocks Discord's built-in client themes and restores your last used one on startup.",
        authors: [
          Devs.Blaze
        ],
        patches: [
          {
            id: "disable-appearance-sync",
            target: byProps([
