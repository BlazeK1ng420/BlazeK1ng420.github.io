...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "6bc21fc2ce5c6e229713642fa22bcd5f512ce64e";
      branch = "realshit";
  ...
  var init_expression_utils2 = __esm({
    "src/plugins/expression-utils/index.tsx"() {
      ...
      expression_utils_default = definePlugin4({
        ...
        description: "Clone, Upload, or copy links for Emojis & Stickers.",
        authors: [
          Devs.Blaze
        ],
        patches: [
...
${inspect({
  ...
  var init_nitro_themes = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-themes/index.ts"() {
      init_shared();
      context8 = getPluginContext("nitro-themes");
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      init_stores();
      init_constants();
      nitro_themes_default = definePlugin8({
  ...
  // plugins-context-provider:#plugin-context#src/plugins/nitro-real/index.ts
  var context9, meta9, definePlugin9, definePluginSettings9, logger13, patcher9;
  var init_nitro_real = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-real/index.ts"() {
      init_shared();
      context9 = getPluginContext("nitro-real");
  ...
  // src/plugins/nitro-real/parse.ts
  ...
  // src/plugins/nitro-real/realshit.ts
  ...
  // src/plugins/nitro-real/index.ts
  var nitro_real_exports = {};
  __export(nitro_real_exports, {
    default: () => nitro_real_default
  });
  var settings3, haveNitro, nitro_real_default;
  var init_nitro_real2 = __esm({
    "src/plugins/nitro-real/index.ts"() {
      "use strict";
      init_nitro_real();
      init_filters2();
      ...
      settings3 = definePluginSettings9({
        ...
        realshit: {
          ...
          description: "Render spoofed emoji as real, inline emoji on BlazeCord.",
          default: true
        },
        forceMoji: {
          type: "boolean",
      ...
      haveNitro = false;
      nitro_real_default = definePlugin9({
        name: "Unlock Nitro Emoji's",
        description: "Use any emoji by spoofing Nitro checks.",
        authors: [
          Devs.Blaze
        ],
        patches: [
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/discord/blazecord/src/plugins"() {
      plugins_default = {
        ...
        "nitro-real": (init_nitro_real2(), __toCommonJS(nitro_real_exports)).default("/nitro-real"),
