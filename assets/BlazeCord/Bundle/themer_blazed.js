...
(() => {
  ...
  var init_lazy = __esm({
    "src/utils/lazy.ts"() {
      "use strict";
      init_dist();
      originalFnSym = Symbol.for("blaze.lazy.originalFn");
  ...
  var init_constants = __esm({
    "src/data/constants.ts"() {
      ...
      Links = {
        ...
        DISCORD: "https://discord.gg/rUg5AvhwdQ",
        BLAZE: "https://blazek1ng420.github.io/"
      };
    }
  });
  ...
  function createModuleFilter({ filter, stringify: stringify2, getResolvers = /* @__PURE__ */ __name(() => defaultResolvers, "getResolvers") }) {
    var factory = Object.assign((arg, options = {}) => {
      var resolvers = getResolvers(arg, options);
      return {
        key: stringify2(arg, options),
        resolvers,
  ...
  var init_caches = __esm({
    "src/metro/internal/caches.ts"() {
      ...
      init_metro();
      CACHE_VERSION = 1;
      BLAZED_METRO_CACHE_KEY = "__blaze_metro_cache_key__";
  ...
  var init_patcher = __esm({
    "src/patcher/patcher.ts"() {
      ...
      init_emptyModule();
      init_hook();
      _patcherDelaySymbol = Symbol.for("blaze.patcher.delaysymbol");
  ...
  var init_lazy2 = __esm({
    "src/metro/lazy.ts"() {
      ...
      _define_property(LazyModuleContext, "ProxySymbol", Symbol.for("blaze.metro.lazyContext"));
  ...
  // src/components/Discord/ui-kit/ColorPicker.tsx
  var ColorPicker_exports = {};
  __export(ColorPicker_exports, {
    ColorPicker: () => ColorPicker
  });
  function ColorPicker(options) {
    picker.load().then((mod) => {
      mod.show({
  ...
  var init_ColorPicker = __esm({
    "src/components/Discord/ui-kit/ColorPicker.tsx"() {
      ...
      init_filters2();
      init_module();
      picker = new SingleMetroModule(byName("CustomColorPickerActionSheet"));
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "97c96eb74347c6f8913773294969ea69e3c50e0b";
      branch = "theme-test";
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native11.Platform.constants.reactNativeVersion;
    ...
    return {
      ...
      react: {
        version: import_react4.default.version
      },
      reactNative: {
  ...
  // src/components/Blaze/Settings/pages/More/InfoCard.tsx
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native12.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native12.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  // src/components/Blaze/Settings/pages/More/ClientInfoSheet.tsx
  ...
  function AlertModalWrapper({ children, dismissable }) {
    (0, import_react5.useEffect)(() => {
      if (dismissable === false) {
        var backHandler = import_react_native13.BackHandler.addEventListener("hardwareBackPress", () => true);
        return () => backHandler.remove();
      }
    }, [
      dismissable
    ]);
    return dismissable === false ? /* @__PURE__ */ jsx(import_react_native13.Pressable, {
      style: {
        position: "absolute",
        width: "100%",
        height: "100%",
  ...
  function showAlert(props) {
    ...
    if ("content" in props) {
      content = /* @__PURE__ */ jsx(AlertModal, {
        ...
        actions: props.actions?.map((a, i2) => /* @__PURE__ */ (0, import_react5.isValidElement)(a) ? a : /* @__PURE__ */ jsx(AlertActionButton, {
          ...a
        }, i2))
      });
  ...
  var import_react5, import_react_native13, logger2, AlertStore;
  ...
  function useStore(api, selector = identity) {
    var slice = import_react6.default.useSyncExternalStore(api.subscribe, () => selector(api.getState()), () => selector(api.getInitialState()));
    import_react6.default.useDebugValue(slice);
    return slice;
  }
  var import_react6, identity, createImpl, create;
  ...
  function createJSONStorage(getStorage, options) {
    ...
    var persistStorage = {
      getItem: /* @__PURE__ */ __name((name) => {
        var _a;
        var parse2 = /* @__PURE__ */ __name((str2) => {
          if (str2 === null) {
            return null;
          }
  ...
  var import_react_native14, import_react7;
...
${log.errorStack}`;
  ...
  var import_flash_list2, import_react8, import_react_native17;
  var init_Logs = __esm({
    "src/components/Blaze/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
  ...
  // src/components/Blaze/Settings/pages/More/index.tsx
  var More_exports = {};
...
(${blazecord.branch})`,
                ...
                onPress: /* @__PURE__ */ __name(() => {
                  navigation.push("BLAZED_CUSTOM_PAGE", {
                    title: t3.blaze(),
                    render: /* @__PURE__ */ (0, import_react9.lazy)(() => Promise.resolve().then(() => (init_Updater(), Updater_exports)))
                  });
                }, "onPress")
              }),
              /* @__PURE__ */ jsx(InfoCard, {
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsx(TableRowGroup_default, {
          children: /* @__PURE__ */ jsx(TableRow_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
              ...
              render: /* @__PURE__ */ (0, import_react9.lazy)(() => Promise.resolve().then(() => (init_Logs(), Logs_exports)))
            }), "onPress"),
            icon: /* @__PURE__ */ jsx(TableRow_default.Icon, {
  ...
  var import_react_native18, import_react9;
  var init_More = __esm({
    "src/components/Blaze/Settings/pages/More/index.tsx"() {
      "use strict";
      init_async_to_generator();
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native19.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast.update({
  ...
  var import_react10, import_react_native19, logger4;
  ...
  var import_react11, import_react_native20, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
      ...
      children: /* @__PURE__ */ jsx(TableRowGroup_default, {
        ...
        children: /* @__PURE__ */ jsx(TableRow_default, {
          ...
          onPress: /* @__PURE__ */ __name(() => {
            navigation.push("BLAZED_CUSTOM_PAGE", {
              title: "Colors",
              render: /* @__PURE__ */ (0, import_react13.lazy)(() => Promise.resolve().then(() => (init_Colors(), Colors_exports)))
            });
          }, "onPress")
        })
      })
  ...
  function DemoAlert() {
    var [understood, setUnderstood] = (0, import_react14.useState)(false);
          ...
          children: [
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
                ...
                render: /* @__PURE__ */ (0, import_react15.lazy)(() => Promise.resolve().then(() => (init_AssetBrowser(), AssetBrowser_exports)))
              }), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              arrow: true,
              ...
              onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
                title: "Token Browser",
                render: /* @__PURE__ */ (0, import_react15.lazy)(() => Promise.resolve().then(() => (init_TokenBrowser(), TokenBrowser_exports)))
              }), "onPress")
            })
          ]
        }),
          ...
          children: [
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
                ...
                render: /* @__PURE__ */ (0, import_react15.lazy)(() => Promise.resolve().then(() => (init_ToastPlayground(), ToastPlayground_exports)))
              }), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              arrow: true,
              ...
              onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
                ...
                render: /* @__PURE__ */ (0, import_react15.lazy)(() => Promise.resolve().then(() => (init_CalloutPlayground(), CalloutPlayground_exports)))
              }), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              arrow: true,
              ...
              onPress: /* @__PURE__ */ __name(() => navigation.push("BLAZED_CUSTOM_PAGE", {
                ...
                render: /* @__PURE__ */ (0, import_react15.lazy)(() => Promise.resolve().then(() => (init_AlertsPlayground(), AlertsPlayground_exports)))
              }), "onPress")
            })
          ]
        }),
  ...
  function HighlightProvider({ children, result, searchTerms }) {
    var contextValue = (0, import_react16.useMemo)(() => ({
      result,
      searchTerms
    }), [
      result,
  ...
  function useHighlight() {
    var context15 = (0, import_react16.useContext)(HighlightContext);
    if (!context15) {
  ...
  function useHighlightedSearchTerm(index) {
    ...
    return (0, import_react16.useCallback)((textProps) => {
  ...
  var import_react16, HighlightContext;
  var init_SearchTermHighlight = __esm({
    "src/components/Blaze/Settings/pages/Addon/SearchTermHighlight.tsx"() {
      ...
      HighlightContext = /* @__PURE__ */ (0, import_react16.createContext)(null);
  ...
  var import_react17, import_react_native22;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react18.memo)(/* @__PURE__ */ __name(function Toast({
        ...
        var {
          width
        } = (0, import_react_native23.useWindowDimensions)();
  ...
  var import_react_native24, isDiscordToastActive;
  ...
  var import_react_native25, showUserProfileActionSheet, useStyles3, maybeFetchUser;
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native27.View, {
          ...
          children: /* @__PURE__ */ jsx(Slider_default, {
            ...
            startIcon: /* @__PURE__ */ jsx(import_react_native27.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex - 1), "onPress"),
              children: /* @__PURE__ */ jsx(CircleMinusIcon, {})
            }),
            endIcon: /* @__PURE__ */ jsx(import_react_native27.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex + 1), "onPress"),
  ...
  function OptionSection({ plugin }) {
    ...
    return /* @__PURE__ */ jsx(InfoSection, {
      ...
      children: /* @__PURE__ */ jsx(import_react_native28.View, {
        ...
        children: options.map((group, i2) => /* @__PURE__ */ jsx(import_react_native28.View, {
          children: group.map(([key, opt], i3) => /* @__PURE__ */ jsx(import_react_native28.View, {
            ...
            registerSettingSection({
              ...
              settings: [
                registerSettingRenderer("BLAZED", {
                  type: "route",
                  title: /* @__PURE__ */ __name(() => t3.blaze(), "title"),
                  ...
                  screen: {
                    route: "BLAZED",
                    getComponent: /* @__PURE__ */ __name(() => /* @__PURE__ */ (0, import_react19.lazy)(() => Promise.resolve().then(() => (init_More(), More_exports))), "getComponent")
                  }
                }),
    ...
    "src/plugins/dummy/index.ts"() {
      ...
      settings2 = definePluginSettings3({
        ...
        frostyCoat: {
          type: "boolean",
          label: "Frosty Coat",
          description: "Does the strain have a frosty coat?",
          icon: "SnowflakeIcon"
        },
        favoriteSeason: {
          type: "select",
          label: "Favorite Method",
          description: "Select your favorite method.",
          options: [
            {
              label: "Smoke Flower",
            ...
            {
              label: "Eat/Drink",
              description: "The Heavy-weight",
              value: "eatdrink"
            },
            {
              label: "Other",
              description: "The Designated-Driver",
              value: "other"
            }
          ]
        },
        hibernation: {
          type: "radio",
          label: "Strain Type",
          description: "Is the strain Indica or Sativa??",
          options: [
            {
              label: "Indica",
              description: "It smells earthy and makes me sleepy.",
              value: "indica"
            },
            {
              label: "Sativa",
              description: "Its fruity and makes me social.",
              value: "sativa"
            }
          ]
        },
        energyLevel: {
          type: "slider",
          label: "Energy Level",
          description: "Set your energy level after using the strain.",
          points: [
            "0%",
            "25%",
            "50%",
      ...
      dummy_default = definePlugin3({
        ...
        patches: [
          {
            id: "sample-patch",
            predicate: /* @__PURE__ */ __name(() => settings2.get().frostyCoat === true, "predicate"),
            target: byProps([
              "toString"
            ]),
            patch(_, patcher15) {
  ...
  // src/plugins/chat-background/index.ts
  var chat_background_exports = {};
  var init_chat_background = __esm({
    "src/plugins/chat-background/index.ts"() {
      "use strict";
    }
  });
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native30.View, {
          style: styles3.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native30.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native30.View, {
          style: styles3.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native30.View, {
              style: styles3.rowContainer,
              children: [
                /* @__PURE__ */ jsx(import_react_native30.Image, {
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native30.View, {
              style: styles3.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native30.View, {
          style: styles3.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native30.View, {
              style: styles3.rowContainer,
  ...
  var import_react_native30, import_react_native_reanimated2, useStyles4;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native31.Keyboard.dismiss();
      ...
      children: /* @__PURE__ */ jsxs(import_react_native32.ScrollView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native32.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native32, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native34.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native34.Dimensions.get("window");
...
${inspect({
  ...
  var import_react_native35, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native35.processColor)(args[2]))
          ], "configure")
        }
      });
    }
    ...
    return /* @__PURE__ */ jsxs(import_react_native36.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native36.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native37.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native37.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native37.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react22, import_react_native37;
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react23.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native38.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react23, import_react_native38;
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native39.ScrollView, {
            fadingEdgeLength: 64,
            contentContainerStyle: {
              gap: 12
            },
  ...
  var import_react_native39, useStyles5;
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/blaze/coding/discord/redux/src/plugins"() {
      plugins_default = {
        ...
        "chat-background": (init_chat_background(), __toCommonJS(chat_background_exports)).default("/chat-background"),
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native40.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native40, tokensModule2, determineColorReference;
  ...
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      logger20 = blzlogger.createChild("useThemeStore");
      ...
      useThemeStore = create(persist((set2, get) => ({
        ...
        // ✅ Adds user theme to menu.
        addTheme: /* @__PURE__ */ __name((theme) => {
          var exists = get().themes.some((t4) => t4.id === theme.id);
          if (!exists) {
            set2((state2) => ({
              themes: [
                ...state2.themes,
        ...
        removeTheme: /* @__PURE__ */ __name((id) => {
          set2((state2) => ({
            themes: state2.themes.filter((t4) => t4.id !== id || t4.builtIn)
          }));
        }, "removeTheme")
      }), {
        name: "theme-store",
  ...
  var require_src = __commonJS({
    "node_modules/use-latest-callback/lib/src/index.js"(exports, module3) {
      "use strict";
      var React76 = require_react();
      var useClientLayoutEffect2 = typeof document !== "undefined" || typeof navigator !== "undefined" && navigator.product === "ReactNative" ? React76.useLayoutEffect : React76.useEffect;
      function useLatestCallback2(callback) {
        var ref = React76.useRef(callback);
        var latestCallback = React76.useRef(/* @__PURE__ */ __name(function latestCallback2() {
          var args = [];
        ...
        useClientLayoutEffect2(function() {
          ref.current = callback;
        });
        return latestCallback;
      }
      __name(useLatestCallback2, "useLatestCallback");
      module3.exports = useLatestCallback2;
    }
  });
  ...
  var init_checkSerializable = __esm({
    "node_modules/@react-navigation/core/lib/module/checkSerializable.js"() {
      "use strict";
    }
  });
  ...
  var init_createNavigationContainerRef = __esm({
    "node_modules/@react-navigation/core/lib/module/createNavigationContainerRef.js"() {
      "use strict";
      init_module2();
    }
  ...
  var React6;
  var init_DeprecatedNavigationInChildContext = __esm({
    "node_modules/@react-navigation/core/lib/module/DeprecatedNavigationInChildContext.js"() {
      "use strict";
  ...
  var React7;
  var init_EnsureSingleNavigator = __esm({
    "node_modules/@react-navigation/core/lib/module/EnsureSingleNavigator.js"() {
      "use strict";
  ...
  var init_findFocusedRoute = __esm({
    "node_modules/@react-navigation/core/lib/module/findFocusedRoute.js"() {
      "use strict";
    }
  });
  ...
  var React8;
  var init_NavigationBuilderContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationBuilderContext.js"() {
      "use strict";
  ...
  var React9, NavigationContainerRefContext;
  var init_NavigationContainerRefContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationContainerRefContext.js"() {
      "use strict";
      React9 = __toESM(require_react(), 1);
      NavigationContainerRefContext = /* @__PURE__ */ React9.createContext(void 0);
    }
  });

  // node_modules/@react-navigation/core/lib/module/NavigationIndependentTreeContext.js
  var React10;
  var init_NavigationIndependentTreeContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationIndependentTreeContext.js"() {
      "use strict";
  ...
  var React11;
  var init_NavigationStateContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationStateContext.js"() {
      "use strict";
  ...
  var React12, ThemeContext2;
  var init_ThemeContext = __esm({
    "node_modules/@react-navigation/core/lib/module/theming/ThemeContext.js"() {
      "use strict";
      React12 = __toESM(require_react(), 1);
      ThemeContext2 = /* @__PURE__ */ React12.createContext(void 0);
  ...
  var React14;
  var init_UnhandledActionContext = __esm({
    "node_modules/@react-navigation/core/lib/module/UnhandledActionContext.js"() {
      "use strict";
  ...
  var React15;
  var init_useChildListeners = __esm({
    "node_modules/@react-navigation/core/lib/module/useChildListeners.js"() {
      "use strict";
  ...
  var React16;
  var init_useEventEmitter = __esm({
    "node_modules/@react-navigation/core/lib/module/useEventEmitter.js"() {
      "use strict";
  ...
  var React17;
  var init_useKeyedChildListeners = __esm({
    "node_modules/@react-navigation/core/lib/module/useKeyedChildListeners.js"() {
      "use strict";
  ...
  var React21;
  var init_BaseNavigationContainer = __esm({
    "node_modules/@react-navigation/core/lib/module/BaseNavigationContainer.js"() {
      "use strict";
      init_module2();
      React21 = __toESM(require_react(), 1);
      init_esm2();
      init_checkDuplicateRouteNames();
      init_checkSerializable();
      init_createNavigationContainerRef();
      init_DeprecatedNavigationInChildContext();
      init_EnsureSingleNavigator();
      init_findFocusedRoute();
      init_NavigationBuilderContext();
      init_NavigationContainerRefContext();
      init_NavigationIndependentTreeContext();
      init_NavigationStateContext();
      init_ThemeProvider();
      init_UnhandledActionContext();
      init_useChildListeners();
      init_useEventEmitter();
      init_useKeyedChildListeners();
      init_useNavigationIndependentTree();
      init_useOptionsGetters();
      init_useSyncState();
      init_jsxRuntime();
    }
  });
  ...
  var init_createNavigatorFactory = __esm({
    "node_modules/@react-navigation/core/lib/module/createNavigatorFactory.js"() {
      "use strict";
      init_Group();
      init_Screen();
  ...
  var React22;
  var init_CurrentRenderContext = __esm({
    "node_modules/@react-navigation/core/lib/module/CurrentRenderContext.js"() {
      "use strict";
  ...
  var init_getActionFromState = __esm({
    "node_modules/@react-navigation/core/lib/module/getActionFromState.js"() {
      "use strict";
    }
  });
  ...
  var React23, CHILD_STATE;
  var init_useRouteCache = __esm({
    "node_modules/@react-navigation/core/lib/module/useRouteCache.js"() {
      "use strict";
      React23 = __toESM(require_react(), 1);
      init_isRecordEqual();
      CHILD_STATE = Symbol("CHILD_STATE");
    }
  });

  // node_modules/@react-navigation/core/lib/module/getFocusedRouteNameFromRoute.js
  var init_getFocusedRouteNameFromRoute = __esm({
    "node_modules/@react-navigation/core/lib/module/getFocusedRouteNameFromRoute.js"() {
      "use strict";
      init_useRouteCache();
    }
  ...
  var require_strict_uri_encode = __commonJS({
    "node_modules/strict-uri-encode/index.js"(exports, module3) {
      "use strict";
      module3.exports = (str) => encodeURIComponent(str).replace(/[!'()*]/g, (x) => `%${x.charCodeAt(0).toString(16).toUpperCase()}`);
    }
  });

  // node_modules/decode-uri-component/index.js
  var require_decode_uri_component = __commonJS({
    "node_modules/decode-uri-component/index.js"(exports, module3) {
      "use strict";
      var token = "%[a-f0-9]{2}";
  ...
  var require_split_on_first = __commonJS({
    "node_modules/split-on-first/index.js"(exports, module3) {
      "use strict";
      module3.exports = (string, separator) => {
  ...
  var require_filter_obj = __commonJS({
    "node_modules/filter-obj/index.js"(exports, module3) {
      "use strict";
      module3.exports = function(obj, predicate) {
        var ret = {};
  ...
  var require_query_string = __commonJS({
    "node_modules/query-string/index.js"(exports) {
      ...
      exports.stringify = (object, options) => {
        ...
        validateArrayFormatSeparator(options.arrayFormatSeparator);
        var shouldFilter = /* @__PURE__ */ __name((key2) => options.skipNull && isNullOrUndefined(object[key2]) || options.skipEmptyString && object[key2] === "", "shouldFilter");
      ...
      exports.stringifyUrl = (object, options) => {
        ...
        var queryString3 = exports.stringify(query, options);
        if (queryString3) {
      ...
      exports.pick = (input, filter, options) => {
        ...
        var { url, query, fragmentIdentifier } = exports.parseUrl(input, options);
  ...
  var init_getPatternParts = __esm({
    "node_modules/@react-navigation/core/lib/module/getPatternParts.js"() {
      "use strict";
    }
  });
  ...
  var init_validatePathConfig = __esm({
    "node_modules/@react-navigation/core/lib/module/validatePathConfig.js"() {
      "use strict";
    }
  });
  ...
  var queryString;
  var init_getPathFromState = __esm({
    "node_modules/@react-navigation/core/lib/module/getPathFromState.js"() {
      "use strict";
      queryString = __toESM(require_query_string(), 1);
      init_getPatternParts();
      init_validatePathConfig();
    }
  });

  // node_modules/escape-string-regexp/index.js
  var require_escape_string_regexp = __commonJS({
    "node_modules/escape-string-regexp/index.js"(exports, module3) {
      "use strict";
  ...
  var init_arrayStartsWith = __esm({
    "node_modules/@react-navigation/core/lib/module/arrayStartsWith.js"() {
      "use strict";
    }
  });
  ...
  var React24, NavigationContext;
  var init_NavigationContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationContext.js"() {
      "use strict";
      React24 = __toESM(require_react(), 1);
      NavigationContext = /* @__PURE__ */ React24.createContext(void 0);
    }
  });

  // node_modules/@react-navigation/core/lib/module/NavigationHelpersContext.js
  var React25;
  var init_NavigationHelpersContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationHelpersContext.js"() {
      "use strict";
  ...
  var React26, NavigationRouteContext;
  var init_NavigationRouteContext = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationRouteContext.js"() {
      "use strict";
      React26 = __toESM(require_react(), 1);
      NavigationRouteContext = /* @__PURE__ */ React26.createContext(void 0);
    }
  });

  // node_modules/@react-navigation/core/lib/module/NavigationIndependentTree.js
  var React27;
  var init_NavigationIndependentTree = __esm({
    "node_modules/@react-navigation/core/lib/module/NavigationIndependentTree.js"() {
      "use strict";
      React27 = __toESM(require_react(), 1);
      init_NavigationContext();
      init_NavigationIndependentTreeContext();
      init_NavigationRouteContext();
      init_jsxRuntime();
    }
  });
  ...
  var React28;
  var init_PreventRemoveContext = __esm({
    "node_modules/@react-navigation/core/lib/module/PreventRemoveContext.js"() {
      "use strict";
  ...
  var React29;
  var init_PreventRemoveProvider = __esm({
    "node_modules/@react-navigation/core/lib/module/PreventRemoveProvider.js"() {
      "use strict";
      init_non_secure();
      React29 = __toESM(require_react(), 1);
      init_esm2();
      init_NavigationHelpersContext();
      init_NavigationRouteContext();
      init_PreventRemoveContext();
      init_jsxRuntime();
    }
  });
  ...
  function useRoute() {
    var route = React30.useContext(NavigationRouteContext);
    if (route === void 0) {
  ...
  var React31, MemoizedScreen;
  var init_StaticNavigation = __esm({
    "node_modules/@react-navigation/core/lib/module/StaticNavigation.js"() {
      "use strict";
      React31 = __toESM(require_react(), 1);
      init_useRoute();
      init_jsxRuntime();
      MemoizedScreen = /* @__PURE__ */ React31.memo(({ component }) => {
        var route = useRoute();
        var children = /* @__PURE__ */ React31.createElement(component, {
          route
        });
        return children;
      });
  ...
  function useNavigation() {
    var root = React33.useContext(NavigationContainerRefContext);
    var navigation = React33.useContext(NavigationContext);
  ...
  var React36, useClientLayoutEffect;
  var init_useClientLayoutEffect = __esm({
    "node_modules/@react-navigation/core/lib/module/useClientLayoutEffect.js"() {
      "use strict";
      React36 = __toESM(require_react(), 1);
      useClientLayoutEffect = typeof document !== "undefined" || typeof navigator !== "undefined" && navigator.product === "ReactNative" ? React36.useLayoutEffect : React36.useEffect;
    }
  });
  ...
  var React40;
  var init_StaticContainer = __esm({
    "node_modules/@react-navigation/core/lib/module/StaticContainer.js"() {
      "use strict";
  ...
  var React41;
  var init_SceneView = __esm({
    "node_modules/@react-navigation/core/lib/module/SceneView.js"() {
      "use strict";
      React41 = __toESM(require_react(), 1);
      init_EnsureSingleNavigator();
      init_NavigationFocusedRouteStateContext();
      init_NavigationStateContext();
      init_StaticContainer();
      init_useOptionsGetters();
      init_jsxRuntime();
    }
  });
  ...
  var React42;
  var init_useNavigationCache = __esm({
    "node_modules/@react-navigation/core/lib/module/useNavigationCache.js"() {
      "use strict";
      init_module2();
  ...
  var React44;
  var init_useFocusedListenersChildrenAdapter = __esm({
    "node_modules/@react-navigation/core/lib/module/useFocusedListenersChildrenAdapter.js"() {
      "use strict";
  ...
  var React47;
  var init_useNavigationHelpers = __esm({
    "node_modules/@react-navigation/core/lib/module/useNavigationHelpers.js"() {
      "use strict";
      init_module2();
  ...
  var require_use_sync_external_store_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        var React76 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore3 = React76.useSyncExternalStore, useRef18 = React76.useRef, useEffect29 = React76.useEffect, useMemo19 = React76.useMemo, useDebugValue2 = React76.useDebugValue;
  ...
  var React52;
  var init_useOnRouteFocus = __esm({
    "node_modules/@react-navigation/core/lib/module/useOnRouteFocus.js"() {
      "use strict";
  ...
  var React53;
  var init_useRegisterNavigator = __esm({
    "node_modules/@react-navigation/core/lib/module/useRegisterNavigator.js"() {
      "use strict";
      init_non_secure();
  ...
  var React54;
  var init_useScheduleUpdate = __esm({
    "node_modules/@react-navigation/core/lib/module/useScheduleUpdate.js"() {
      "use strict";
  ...
  var React55;
  var init_useNavigationBuilder = __esm({
    "node_modules/@react-navigation/core/lib/module/useNavigationBuilder.js"() {
      "use strict";
      init_module2();
      ...
      init_NavigationRouteContext();
      init_NavigationStateContext();
      init_PreventRemoveProvider();
      init_Screen();
      init_types2();
      init_useChildListeners();
      init_useClientLayoutEffect();
      init_useComponent();
      init_useCurrentRender();
      init_useDescriptors();
      init_useEventEmitter();
      init_useFocusedListenersChildrenAdapter();
      init_useFocusEvents();
      init_useKeyedChildListeners();
      init_useLazyValue();
      init_useNavigationHelpers();
      init_useNavigationState();
      init_useOnAction();
      init_useOnGetState();
      init_useOnRouteFocus();
      init_useRegisterNavigator();
      init_useScheduleUpdate();
      init_jsxRuntime();
    }
  });
  ...
  var React56;
  var init_useNavigationContainerRef = __esm({
    "node_modules/@react-navigation/core/lib/module/useNavigationContainerRef.js"() {
      "use strict";
  ...
  var React57;
  var init_usePreventRemoveContext = __esm({
    "node_modules/@react-navigation/core/lib/module/usePreventRemoveContext.js"() {
      "use strict";
  ...
  var React58;
  var init_usePreventRemove = __esm({
    "node_modules/@react-navigation/core/lib/module/usePreventRemove.js"() {
      "use strict";
      init_non_secure();
  ...
  var React59;
  var init_useStateForPath = __esm({
    "node_modules/@react-navigation/core/lib/module/useStateForPath.js"() {
      "use strict";
  ...
  var init_module3 = __esm({
    "node_modules/@react-navigation/core/lib/module/index.js"() {
      "use strict";
      init_BaseNavigationContainer();
      init_createNavigationContainerRef();
      init_createNavigatorFactory();
      init_CurrentRenderContext();
      init_findFocusedRoute();
      init_getActionFromState();
      init_getFocusedRouteNameFromRoute();
      init_getPathFromState();
      init_getStateFromPath();
      init_NavigationContainerRefContext();
      init_NavigationContext();
      init_NavigationHelpersContext();
      init_NavigationIndependentTree();
      init_NavigationRouteContext();
      init_PreventRemoveContext();
      init_PreventRemoveProvider();
      init_StaticNavigation();
      init_ThemeContext();
      init_ThemeProvider();
      init_useTheme();
      init_types2();
      ...
      init_useIsFocused();
      init_useNavigation();
      init_useNavigationBuilder();
      init_useNavigationContainerRef();
      init_useNavigationIndependentTree();
      init_useNavigationState();
      init_usePreventRemove();
      init_usePreventRemoveContext();
      init_useRoute();
      init_useStateForPath();
      init_validatePathConfig();
      init_module2();
    }
  });
  ...
  var React60, MISSING_CONTEXT_ERROR, LinkingContext;
  var init_LinkingContext = __esm({
    "node_modules/@react-navigation/native/lib/module/LinkingContext.js"() {
      "use strict";
      React60 = __toESM(require_react(), 1);
      MISSING_CONTEXT_ERROR = "Couldn't find a LinkingContext context.";
      LinkingContext = /* @__PURE__ */ React60.createContext({
        get options() {
  ...
  var React61, LocaleDirContext;
  var init_LocaleDirContext = __esm({
    "node_modules/@react-navigation/native/lib/module/LocaleDirContext.js"() {
      "use strict";
      React61 = __toESM(require_react(), 1);
      LocaleDirContext = /* @__PURE__ */ React61.createContext("ltr");
      LocaleDirContext.displayName = "LocaleDirContext";
    }
  });

  // node_modules/@react-navigation/native/lib/module/theming/fonts.js
  var import_react_native41, WEB_FONT_STACK, fonts;
  var init_fonts = __esm({
    "node_modules/@react-navigation/native/lib/module/theming/fonts.js"() {
      "use strict";
      import_react_native41 = __toESM(require_react_native(), 1);
      WEB_FONT_STACK = 'system-ui, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"';
      fonts = import_react_native41.Platform.select({
        web: {
          regular: {
  ...
  var React62, MISSING_CONTEXT_ERROR2, UnhandledLinkingContext;
  var init_UnhandledLinkingContext = __esm({
    "node_modules/@react-navigation/native/lib/module/UnhandledLinkingContext.js"() {
      "use strict";
      React62 = __toESM(require_react(), 1);
      MISSING_CONTEXT_ERROR2 = "Couldn't find an UnhandledLinkingContext context.";
      UnhandledLinkingContext = /* @__PURE__ */ React62.createContext({
  ...
  var React63;
  var init_useDocumentTitle = __esm({
    "node_modules/@react-navigation/native/lib/module/useDocumentTitle.js"() {
      "use strict";
  ...
  var require_fast_deep_equal = __commonJS({
    "node_modules/fast-deep-equal/index.js"(exports, module3) {
      "use strict";
      module3.exports = /* @__PURE__ */ __name(function equal(a, b) {
        if (a === b) return true;
  ...
  var init_createMemoryHistory = __esm({
    "node_modules/@react-navigation/native/lib/module/createMemoryHistory.js"() {
      "use strict";
      init_non_secure();
    }
  ...
  var React67, import_react_native42;
  var init_NavigationContainer = __esm({
    "node_modules/@react-navigation/native/lib/module/NavigationContainer.js"() {
      "use strict";
      init_module3();
      ...
      init_esm2();
      init_LinkingContext();
      init_LocaleDirContext();
      init_DefaultTheme();
      init_UnhandledLinkingContext();
      init_useBackButton();
      init_useDocumentTitle();
      init_useLinking();
      init_useThenable();
      init_jsxRuntime();
  ...
  var React68;
  var init_createStaticNavigation = __esm({
    "node_modules/@react-navigation/native/lib/module/createStaticNavigation.js"() {
      "use strict";
      init_module3();
      React68 = __toESM(require_react(), 1);
      init_NavigationContainer();
      init_jsxRuntime();
    }
  });

  // node_modules/@react-navigation/native/lib/module/useLinkProps.js
  var React69, import_react_native43;
  var init_useLinkProps = __esm({
    "node_modules/@react-navigation/native/lib/module/useLinkProps.js"() {
      "use strict";
      init_module3();
  ...
  var React70, import_react_native44;
  var init_Link = __esm({
    "node_modules/@react-navigation/native/lib/module/Link.js"() {
      "use strict";
      init_module3();
  ...
  var React71;
  var init_ServerContainer = __esm({
    "node_modules/@react-navigation/native/lib/module/ServerContainer.js"() {
      "use strict";
      init_module3();
  ...
  var init_module4 = __esm({
    "node_modules/@react-navigation/native/lib/module/index.js"() {
      "use strict";
      init_createStaticNavigation();
      init_Link();
      init_LinkingContext();
      init_LocaleDirContext();
      init_NavigationContainer();
      init_ServerContainer();
      init_DarkTheme();
      init_DefaultTheme();
      init_types3();
      init_UnhandledLinkingContext();
  ...
  function CardHeader({ addon }) {
    ...
    return /* @__PURE__ */ jsx(import_react_native45.View, {
      style: {
        flexDirection: "row",
        alignItems: "center",
        gap: 6
  ...
  function CardActions({ addon, pageProps }) {
    var isUserTheme = !addon.builtIn;
    var removeTheme = useThemeStore((s) => s.removeTheme);
    ...
    return /* @__PURE__ */ jsxs(import_react_native45.View, {
      ...
      children: [
        pageProps.onPressInfo && /* @__PURE__ */ jsx(IconButton_default, {
          size: "sm",
          variant: "secondary",
          icon: findAssetId("CircleInformationIcon-primary"),
          onPress: /* @__PURE__ */ __name(() => pageProps.onPressInfo?.(addon), "onPress")
        }),
        isUserTheme && /* @__PURE__ */ jsxs(Fragment, {
          children: [
            /* @__PURE__ */ jsx(IconButton_default, {
              size: "sm",
              variant: "secondary",
              icon: findAssetId("PencilIcon"),
              onPress: /* @__PURE__ */ __name(() => navigation.navigate("ThemeCreator", {
                themeId: addon.asAddonMetadata().id
              }), "onPress")
            }),
            /* @__PURE__ */ jsx(IconButton_default, {
              size: "sm",
              ...
              onPress: /* @__PURE__ */ __name(() => removeTheme(addon.asAddonMetadata().id), "onPress")
            })
          ]
        })
      ]
  ...
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        ListHeaderComponent: /* @__PURE__ */ jsxs(import_react_native46.View, {
          style: {
            gap: 8
          },
          children: [
  ...
  var import_react_native46, ItemSeparator;
  var init_Addon = __esm({
    "src/components/Blaze/Settings/pages/Addon/index.tsx"() {
      ...
      init_SearchTermHighlight();
      init_loader();
      ItemSeparator = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native46.View, {
        style: {
          height: 8
        }
      }), "ItemSeparator");
  ...
  // src/components/Blaze/Settings/pages/Themes/ThemeCreator.tsx
  var ThemeCreator_exports = {};
  __export(ThemeCreator_exports, {
    default: () => ThemeCreator
  });
  function Header({ title, onBack }) {
    return /* @__PURE__ */ jsxs(import_react_native47.View, {
      style: styles.header,
      children: [
        /* @__PURE__ */ jsx(import_react_native47.TouchableOpacity, {
          onPress: onBack,
  ...
  function ThemeCreator() {
    var navigation = NavigationNative.useNavigation();
    var route = NavigationNative.useRoute();
    var { themeId } = route.params || {};
    var isEdit = !!themeId;
    var theme = useThemeStore((s) => s.themes.find((t4) => t4.id === themeId));
    var updateTheme = useThemeStore((s) => s.addTheme);
    var [workingTheme, setWorkingTheme] = (0, import_react24.useState)(() => {
      var base = theme ?? createBlankTheme();
      return JSON.parse(JSON.stringify(base));
    });
    var [pickerKey, setPickerKey] = (0, import_react24.useState)(null);
    var [pickerScope, setPickerScope] = (0, import_react24.useState)(null);
    (0, import_react24.useEffect)(() => {
      if (workingTheme.id) applyTheme(workingTheme.id, true);
    }, [
      workingTheme.id
    ]);
    var handleColorChange = /* @__PURE__ */ __name((key, scope) => {
      setPickerKey(key);
      setPickerScope(scope);
      var initialColor = scope === "semantic" ? workingTheme.main.colors.semantic[key]?.value.replace("$", "") ?? "#000000" : workingTheme.main.colors.raw[key] ?? "#000000";
      ColorPicker({
        color: initialColor,
        onSelect: /* @__PURE__ */ __name((newColor) => {
          setWorkingTheme((prev) => {
            var updated = {
              ...prev
            };
            if (scope === "semantic") {
              updated.main.colors.semantic[key] = {
                value: newColor
              };
            } else {
              updated.main.colors.raw[key] = newColor;
            }
            return updated;
          });
          setPickerKey(null);
    ...
    var saveTheme = /* @__PURE__ */ __name(() => {
      if (!workingTheme.display.name.trim()) return;
      var id = isEdit ? workingTheme.id : generateThemeId(workingTheme.display.name);
      var final = {
        ...workingTheme,
        id
      };
      updateTheme(final);
      applyTheme(final.id, true);
      navigation.pop();
    }, "saveTheme");
    return /* @__PURE__ */ jsxs(import_react_native47.View, {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsx(Header, {
          ...
          onBack: /* @__PURE__ */ __name(() => navigation.pop(), "onBack")
        }),
        /* @__PURE__ */ jsxs(import_react_native47.ScrollView, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(import_react_native47.TextInput, {
              style: styles.input,
              placeholder: "Name",
              placeholderTextColor: "#888",
              value: workingTheme.display.name,
              onChangeText: /* @__PURE__ */ __name((t4) => setWorkingTheme({
                ...workingTheme,
                display: {
                  ...workingTheme.display,
                  name: t4
                }
              }), "onChangeText")
            }),
            ...
            /* @__PURE__ */ jsx(import_react_native47.TextInput, {
              ...
              placeholderTextColor: "#888",
              value: workingTheme.display.description,
              multiline: true,
              onChangeText: /* @__PURE__ */ __name((t4) => setWorkingTheme({
                ...workingTheme,
                display: {
            ...
            Object.entries(workingTheme.main.colors.semantic).map(([key, val]) => /* @__PURE__ */ jsxs(import_react_native47.TouchableOpacity, {
              style: styles.colorRow,
              onPress: /* @__PURE__ */ __name(() => handleColorChange(key, "semantic"), "onPress"),
              children: [
                /* @__PURE__ */ jsx(Text_default, {
                ...
                /* @__PURE__ */ jsx(import_react_native47.View, {
                  style: [
                    styles.colorSwatch,
                    {
                      backgroundColor: val.value.replace("$", "")
                    }
                  ]
                })
              ]
            ...
            Object.entries(workingTheme.main.colors.raw).map(([key, val]) => /* @__PURE__ */ jsxs(import_react_native47.TouchableOpacity, {
              style: styles.colorRow,
              onPress: /* @__PURE__ */ __name(() => handleColorChange(key, "raw"), "onPress"),
              children: [
                /* @__PURE__ */ jsx(Text_default, {
                  style: styles.colorKey,
                  children: key
            ...
            /* @__PURE__ */ jsx(import_react_native47.TouchableOpacity, {
              ...
              children: /* @__PURE__ */ jsx(Text_default, {
                ...
                children: isEdit ? "Save Changes" : "Create Theme"
              })
            })
          ]
        })
  ...
  var import_react24, import_react_native47, styles;
  var init_ThemeCreator = __esm({
    "src/components/Blaze/Settings/pages/Themes/ThemeCreator.tsx"() {
      "use strict";
      init_jsxRuntime();
      ...
      __name(generateThemeId, "generateThemeId");
      __name(createBlankTheme, "createBlankTheme");
      __name(ThemeCreator, "ThemeCreator");
      styles = import_react_native47.StyleSheet.create({
        container: {
          padding: 16,
          gap: 12
        },
  ...
  function Themes() {
    var navigation = NavigationNative.useNavigation();
    return /* @__PURE__ */ jsxs(import_react_native48.View, {
      style: {
        flex: 1
      },
      children: [
        /* @__PURE__ */ jsx(AddonPage, {
        ...
        /* @__PURE__ */ jsx(import_react_native48.Pressable, {
          style: styles2.fab,
          onPress: /* @__PURE__ */ __name(() => {
            navigation.push("BLAZED_CUSTOM_PAGE", {
              title: "Create Theme",
              render: /* @__PURE__ */ (0, import_react25.lazy)(() => Promise.resolve().then(() => (init_ThemeCreator(), ThemeCreator_exports)))
            });
          }, "onPress"),
          children: /* @__PURE__ */ jsx(import_react_native48.Text, {
            style: styles2.fabText,
            children: "\uFF0B"
          })
        })
      ]
  ...
  var import_react_native48, import_react25, themeCollectionManager, styles2;
  var init_Themes = __esm({
    "src/components/Blaze/Settings/pages/Themes/index.tsx"() {
      ...
      styles2 = import_react_native48.StyleSheet.create({
        fab: {
          position: "absolute",
          bottom: 24,
          right: 24,
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "components/Discord/ui-kit/ColorPicker": createModuleProxy(() => (init_ColorPicker(), __toCommonJS(ColorPicker_exports))),
        ...
        "components/Blaze/Settings/pages/More/": createModuleProxy(() => (init_More(), __toCommonJS(More_exports))),
        "components/Blaze/Settings/pages/More/ClientInfoSheet": createModuleProxy(() => (init_ClientInfoSheet(), __toCommonJS(ClientInfoSheet_exports))),
        "components/Blaze/Settings/pages/More/InfoCard": createModuleProxy(() => (init_InfoCard(), __toCommonJS(InfoCard_exports))),
        ...
        "components/Blaze/Settings/pages/Themes/ThemeCreator": createModuleProxy(() => (init_ThemeCreator(), __toCommonJS(ThemeCreator_exports))),
  ...
  var init_globals2 = __esm({
    "src/globals.ts"() {
      ...
      init_lazy();
      init_emptyModule();
      blazedGlobalExports = window.__blaze_exports = lazyValue(() => (init_globals(), __toCommonJS(globals_exports)).default);
  ...
  function initializeBlazeCord() {
    try {
      ...
      initializePlugins();
      initCheckForUpdates();
      window.blaze = blazedGlobalObject();
      blzlogger.info(`Fully initialized BlazeCord in ${(nativePerformanceNow() - BLAZED_START_TIME).toFixed(2)}ms!`);
    } catch (e3) {
