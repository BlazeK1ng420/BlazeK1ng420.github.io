        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger18 = new Logger2(name);
              logger18.parent = this;
              logger18.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger18;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger18) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger18.logHandlers.size > 0) {
                  for (var handler of logger18.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger18.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger18) => {
                logger18.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger18) => {
                logger18.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger18) => {
                if (logger18 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger18.logHandlers.has(handler)) {
                    logger18.logHandlers.delete(handler);
                  }
                }
              });
...
${log.errorStack}`;
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "ecb662bf816152cd13f1576ab9613eb4e325fbd1";
      branch = "refactor";
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native18.Platform.constants.reactNativeVersion;
    ...
    return {
      ...
      react: {
        version: import_react11.default.version
      },
      reactNative: {
  ...
  function getDebugInfo() {
    return {
      ...getVersions(),
      ...import_react_native18.Platform.select({
        android: getAndroidDebugInfo(),
        ios: getIOSDebugInfo()
      })
    };
  }
  var import_react11, import_react_native18;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  var import_react_native19, import_react12;
  ...
  function useHighlight() {
    var context13 = (0, import_react13.useContext)(HighlightContext);
    if (!context13) {
  ...
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        ListHeaderComponent: /* @__PURE__ */ jsxs(import_react_native21.View, {
          style: {
            gap: 8
          },
          children: [
  ...
  var import_react_native21, ItemSeparator;
  var init_Addon = __esm({
    "src/components/Blaze/Settings/pages/Addon/index.tsx"() {
      ...
      init_SearchTermHighlight();
      init_loader();
      ItemSeparator = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native21.View, {
        style: {
          height: 8
        }
      }), "ItemSeparator");
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native22.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native22.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  function openURL(url) {
    import_react_native23.Linking.openURL(url);
  }
...
(${discord.build})`,
  ...
  var import_react_native25, showUserProfileActionSheet, useStyles2, maybeFetchUser;
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher13 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger5.debug(`Applying ${patcher13.id} patch`);
        patcher13.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher13);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger5.debug(`Disposing ${patcher13.id} patch`);
            patcher13.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    ...
    try {
      var patcher13 = getContextualPatcher(id, false);
      if (patcher13) {
        patcher13.dispose();
        patcher13.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher13 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher13.parent = this;
        this.children.push(patcher13);
        return patcher13;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher13);
    return patcher13;
  }
  ...
  var import_react14, import_react_native26;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react15.memo)(/* @__PURE__ */ __name(function Toast({
        ...
        var {
          width
        } = (0, import_react_native27.useWindowDimensions)();
  ...
  var import_react_native28, isDiscordToastActive;
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              patcher13.after(module3, "type", (_, res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              ...
              patcher13.attachDisposer(() => void uninject());
            }
          }
        ]
      });
      ...
      settings_default = definePlugin3({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher13) {
              patcher13.after(module3, "default", (_, ret) => {
  ...
  var init_silent_typing = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/silent-typing/index.ts"() {
      init_shared();
      context4 = getPluginContext("silent-typing");
  ...
  var toast, settings2, silent_typing_default;
  var init_silent_typing2 = __esm({
    "src/plugins/silent-typing/index.ts"() {
      ...
      silent_typing_default = definePlugin4({
        name: "SilentTyping",
        ...
        flux: {
          TYPING_START_LOCAL: /* @__PURE__ */ __name(() => {
            if (settings2.get().silentTypingActive) return false;
            toast.show();
          }, "TYPING_START_LOCAL")
        }
      });
  ...
  var init_dummy = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/dummy/index.ts"() {
      init_shared();
      context5 = getPluginContext("dummy");
  ...
  var init_dummy2 = __esm({
    "src/plugins/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings3 = definePluginSettings5({
        bunnyName: {
          type: "string",
          label: "Bunny Name",
      ...
      dummy_default = definePlugin5({
        ...
        patches: [
          {
            id: "sample-patch",
            predicate: /* @__PURE__ */ __name(() => settings3.get().winterCoat === true, "predicate"),
            target: byProps([
              "toString"
            ]),
            patch(_, patcher13) {
              patcher13.after(window, "sampleMethod", () => {
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native29.View, {
          style: styles.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native29.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native29.View, {
          ...
          children: [
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native29.View, {
              style: styles.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native29.View, {
          style: styles.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native29.View, {
              style: styles.rowContainer,
  ...
  var import_react_native29, import_react_native_reanimated2, useStyles4;
      ...
      children: /* @__PURE__ */ jsxs(import_react_native31.ScrollView, {
        ...
        children: [
          /* @__PURE__ */ jsx(import_react_native31.View, {
            ...
            children: /* @__PURE__ */ jsxs(Text_default, {
              ...
              children: [
                ...
                ":",
                "  ",
                /* @__PURE__ */ jsx(import_react_native31.Image, {
                  resizeMode: "contain",
                  source: {
                    uri: emojiNode.src
                  },
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native31.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native31, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native33.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function openMediaModal(src) {
    return _async_to_generator(function* () {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native33.Dimensions.get("window");
  ...
  function openEmojiActionSheet({ id, name, animated }) {
    try {
      ...
      logger12.error(`Failed to open emoji action sheet: ${err}`);
    }
  }
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              patcher13.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher13) {
              patcher13.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher13.detached.after(props.header, "type", (_2, res) => {
                  ...
                  try {
                    ...
                    logger11.error`Failed to patch reaction header: ${e3}`;
                  }
                });
              });
            }
...
${inspect({
  ...
  var init_experiments = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/experiments/index.ts"() {
      init_shared();
      context9 = getPluginContext("experiments");
  ...
  function reinitStore() {
    waitFor(byStoreName("DeveloperExperimentStore", {
      ...
      var unpatch2 = patcher9.detached.instead(Object, "defineProperties", () => {
      });
  ...
  var init_experiments2 = __esm({
    "src/plugins/experiments/index.ts"() {
      ...
      experiments_default = definePlugin9({
        name: "Experiments",
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              patcher13.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var init_chat_bubbles = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/chat-bubbles/index.ts"() {
      init_shared();
      context10 = getPluginContext("chat-bubbles");
  ...
  var import_react_native34, BubbleModule_default;
      ...
      BubbleModule_default = getModule({
        ...
        argumentProcessors: {
          configure: /* @__PURE__ */ __name((args) => [
            args[0],
            args[1],
            Number((0, import_react_native34.processColor)(args[2]))
          ], "configure")
        }
      });
    }
  ...
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      init_modules();
      init_shallow3();
      settings4 = definePluginSettings10({
        avatarRadius: {
          type: "slider",
          label: "Avatar Curve",
          points: [
      ...
      chat_bubbles_default = definePlugin10({
        name: "ChatBubbles",
  ...
  var init_error_boundary = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/error-boundary/index.tsx"() {
      init_shared();
      context11 = getPluginContext("error-boundary");
    ...
    return /* @__PURE__ */ jsxs(import_react_native35.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native35.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native36.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native36.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native36.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react19, import_react_native36;
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react20.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native37.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react20, import_react_native37;
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native38.ScrollView, {
            fadingEdgeLength: 64,
            contentContainerStyle: {
              gap: 12
            },
  ...
  var import_react_native38, useStyles5;
  ...
  var init_error_boundary2 = __esm({
    "src/plugins/_core/error-boundary/index.tsx"() {
      ...
      init_wrappers();
      error_boundary_default = definePlugin11({
        name: "ErrorBoundary",
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              patcher13.after(module3.prototype, "render", function() {
        ...
        start() {
          ...
          patcher11.after.async(jsxRuntime2, "jsx", callback);
          patcher11.after.async(jsxRuntime2, "jsxs", callback);
        }
      });
    }
  });
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context12 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin12({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher13) {
              patcher13.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher13) {
              patcher13.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
