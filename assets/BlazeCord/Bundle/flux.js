...
(() => {
        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger27 = new Logger2(name);
              logger27.parent = this;
              logger27.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger27;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger27) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger27.logHandlers.size > 0) {
                  for (var handler of logger27.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger27.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger27) => {
                logger27.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger27) => {
                logger27.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger27) => {
                if (logger27 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger27.logHandlers.has(handler)) {
                    logger27.logHandlers.delete(handler);
                  }
                }
              });
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher21 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher21.parent = this;
        this.children.push(patcher21);
        return patcher21;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher21);
    return patcher21;
  }
      ...
      chat_bubbles_default = definePlugin({
        ...
        start() {
          ...
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            ...
            BubbleModule_default.configure(avatarRadius, bubbleChatRadius, color).catch(logger4.error);
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(_, patcher21) {
              patcher21.after(window, "sampleMethod", () => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.instead(module3, "isStaffEnv", ([user]) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher21.detached.after(props.header, "type", (_2, res) => {
  ...
  var init_nitro_emojis = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\nitro-emojis\\index.ts"() {
      init_shared();
      context7 = getPluginContext("nitro-emojis");
  ...
  function patchRealmoji(module3, patcher21, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher21.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher21.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      haveNitro = false;
      nitro_emojis_default = definePlugin7({
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher21.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher21) {
              patcher21.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher21) {
              patcher21.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher21) {
              patchRealmoji(module3, patcher21, () => settings3.get().realshit);
            }
          }
        ],
        start() {
  ...
  var init_nitro_icons = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\nitro-icons\\index.ts"() {
      init_shared();
      context8 = getPluginContext("nitro-icons");
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      init_toasts();
      init_constants();
      nitro_icons_default = definePlugin8({
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              ...
              patcher21.instead(module3, "getIcons", () => mainIcons);
              patcher21.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher21.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
  ...
  var init_nitro_themes = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\nitro-themes\\index.ts"() {
      init_shared();
      context9 = getPluginContext("nitro-themes");
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      init_stores();
      init_constants();
      nitro_themes_default = definePlugin9({
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              ...
              patcher21.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher21) {
              patcher21.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              ...
              patcher21.attachDisposer(() => void uninject());
            }
          }
        ]
      });
  ...
  var init_settings = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_api\\settings\\index.tsx"() {
      init_shared();
      context11 = getPluginContext("settings");
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "3a412ab3db863c8a5730279466148a945b386050";
      branch = "refacor";
...
(${discord.build})`,
  ...
  function useHighlight() {
    var context21 = (0, import_react11.useContext)(HighlightContext);
    if (!context21) {
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger15.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var logger16, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger16 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta21 = a.asAddonMetadata();
              return meta21.name.localeCompare(meta21.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native34.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native34.View, {
            ...
            children: [
              /* @__PURE__ */ jsxs(import_react_native34.Text, {
                children: [
                  "Opacity: ",
                  opacity.toFixed(1)
                ]
  ...
  var import_react13, import_react_native34, DocumentPicker, styles;
  var init_AddWallpaperSheet = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/AddWallpaperSheet.tsx"() {
      ...
      styles = import_react_native34.StyleSheet.create({
        container: {
          padding: 16,
          gap: 12
        },
  ...
  function WallpaperPreviewSheet({ wallpaper }) {
    ...
    return /* @__PURE__ */ jsxs(import_react_native35.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(import_react_native35.Image, {
          source: {
            uri: wallpaper.image
          },
          style: [
  ...
  var import_react14, import_react_native35, styles2;
  var init_WallpaperPreviewSheet = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/WallpaperPreviewSheet.tsx"() {
      ...
      styles2 = import_react_native35.StyleSheet.create({
        container: {
          flex: 1
        },
        previewImage: {
  ...
  function WallpaperManager() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native36.ScrollView, {
      ...
      children: [
        ...
        categories.map((category) => /* @__PURE__ */ jsxs(import_react_native36.View, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(import_react_native36.ScrollView, {
              ...
              children: category.wallpapers.map((wallpaper) => /* @__PURE__ */ jsxs(import_react_native36.TouchableOpacity, {
                onPress: /* @__PURE__ */ __name(() => showSheet("WallpaperPreviewSheet", WallpaperPreviewSheet, {
                  wallpaper
                }), "onPress"),
                style: styles3.wallpaperThumb,
                children: [
                  /* @__PURE__ */ jsx(import_react_native36.Image, {
                    source: {
                      uri: wallpaper.image
                    },
  ...
  var import_react15, import_react_native36, styles3;
  var init_Wallpapers = __esm({
    "src/components/Blaze/Settings/pages/Wallpapers/index.tsx"() {
      ...
      styles3 = import_react_native36.StyleSheet.create({
        container: {
          padding: 16
        },
        categoryContainer: {
  ...
  var import_react16, import_react_native37, import_flash_list4, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetDisplay = /* @__PURE__ */ __name(({ asset, start, end }) => /* @__PURE__ */ jsx(TableRow_default, {
        ...
        trailing: /* @__PURE__ */ jsx(import_react_native37.Image, {
          source: asset.id,
          style: {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native37.useWindowDimensions)().width - 24;
        var imageSize = {
          ...
          children: /* @__PURE__ */ jsxs(Stack_default, {
            children: [
              /* @__PURE__ */ jsx(import_react_native37.View, {
                ...
                children: /* @__PURE__ */ jsx(import_react_native37.Image, {
                  source: asset.id,
                  style: imageSize,
                  resizeMode: "contain"
                })
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native38.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list5, import_react_native38;
  ...
  function ToastPlayground() {
    ...
    var handleShowToast = /* @__PURE__ */ __name(() => {
      var options = {
        ...
        onDismiss() {
          logger17.info("Toast dismissed");
        },
        onPress() {
          logger17.info("Toast pressed");
        },
        onTimeout() {
          logger17.info("Toast timed out");
        }
      };
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsxs(import_react_native39.ScrollView, {
        contentContainerStyle: {
          gap: 12
        },
        style: {
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native39.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast.update({
  ...
  var import_react17, import_react_native39, logger17;
  var init_ToastPlayground = __esm({
    "src/components/Blaze/Settings/pages/Developer/ToastPlayground.tsx"() {
      ...
      logger17 = blzlogger.createChild("ToastPlayground");
  ...
  var init_settings3 = __esm({
    "src/plugins/_api/settings/index.tsx"() {
      ...
      settings_default = definePlugin11({
        name: "Settings",
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3, "default", (_, ret) => {
                var { props } = findInReactTree(ret, (i2) => i2.props?.sections);
                if (!props) {
                  logger14.warn("Failed to find settings sections in SettingsOverviewScreen");
                  return;
                }
                props.sections = [
                  ..._registeredSettingSections,
  ...
  var init_toasts2 = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_api\\toasts\\index.tsx"() {
      init_shared();
      context13 = getPluginContext("toasts");
  ...
  function ToastIcon({ icon }) {
    ...
    if (typeof icon === "number" || typeof icon === "object" && "uri" in icon) {
      return /* @__PURE__ */ jsx(import_react_native40.Image, {
        style: {
          width: 18,
          height: 18
        },
  ...
  var import_react20, import_react_native40;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      Toast_default = /* @__PURE__ */ (0, import_react21.memo)(/* @__PURE__ */ __name(function Toast({
        ...
        var {
          width
        } = (0, import_react_native41.useWindowDimensions)();
        ...
        return /* @__PURE__ */ jsx(import_react_native_gesture_handler.GestureDetector, {
          ...
          children: /* @__PURE__ */ jsx(import_react_native_reanimated2.default.View, {
            ...
            children: /* @__PURE__ */ jsx(PressableScale_default, {
              ...
              children: /* @__PURE__ */ jsx(import_react_native_reanimated2.default.View, {
                layout: import_react_native_reanimated2.LinearTransition.springify(500).dampingRatio(0.5),
                style: [animatedStyles, styles4.container, toast.contentContainerStyle],
  ...
  var import_react_native42, isDiscordToastActive;
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3, "type", (_, res) => {
  ...
  var init_error_boundary = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\error-boundary\\index.tsx"() {
      init_shared();
      context14 = getPluginContext("error-boundary");
    ...
    return /* @__PURE__ */ jsxs(import_react_native43.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native43.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native44.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native44.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native44.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react22, import_react_native44;
  ...
  function ErrorStackCard(props) {
    ...
    return /* @__PURE__ */ jsx(Card_default, {
      children: /* @__PURE__ */ jsxs(import_react_native45.View, {
        style: {
          gap: 12
        },
        children: [
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react23.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native45.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react23, import_react_native45;
  ...
  function ErrorBoundaryScreen(props) {
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        style: styles4.container,
        children: [
          /* @__PURE__ */ jsxs(import_react_native46.View, {
            style: {
              gap: 4
            },
            children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native46.ScrollView, {
            fadingEdgeLength: 64,
            contentContainerStyle: {
              gap: 12
            },
  ...
  var import_react_native46, useStyles5;
  ...
  var init_error_boundary2 = __esm({
    "src/plugins/_core/error-boundary/index.tsx"() {
      ...
      init_wrappers();
      error_boundary_default = definePlugin14({
        name: "ErrorBoundary",
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.after(module3.prototype, "render", function() {
        ...
        start() {
          ...
          patcher14.after.async(jsxRuntime2, "jsx", callback);
          patcher14.after.async(jsxRuntime2, "jsxs", callback);
        }
      });
    }
  });
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\no-track\\index.ts"() {
      init_shared();
      context15 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin15({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher21) {
              patcher21.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher21) {
              patcher21.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  var init_painter = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\painter\\index.ts"() {
      init_shared();
      context16 = getPluginContext("painter");
  ...
  var init_resolver = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\painter\\patches\\resolver.ts"() {
      init_shared();
      context17 = getPluginContext("painter");
  ...
  var init_stores2 = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\painter\\patches\\stores.ts"() {
      init_shared();
      context18 = getPluginContext("painter");
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher18.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher18.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher17.before(isThemeModule, "isThemeDark", callback);
    patcher17.before(isThemeModule, "isThemeLight", callback);
    patcher17.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher17.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin16({
        name: "Painter",
  ...
  var init_wallpapers = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\wallpapers\\index.ts"() {
      init_shared();
      context19 = getPluginContext("wallpapers");
  ...
  var init_background = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\wallpapers\\patches\\background.tsx"() {
      init_shared();
      context20 = getPluginContext("wallpapers");
  ...
  function ChatBackgroundWrapper({ children }) {
    ...
    return /* @__PURE__ */ jsx(import_react_native47.ImageBackground, {
      source: {
        uri: bg.uri
      },
  ...
  var import_react24, import_react_native47, Messages;
  ...
  var init_wallpapers2 = __esm({
    "src/plugins/_core/wallpapers/index.ts"() {
      ...
      init_constants();
      init_background2();
      wallpapers_default = definePlugin19({
        name: "Wallpapers",
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger26.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger26.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger26.warn(`${plugin.$id} already started`);
      return;
    }
    logger26.debug(`Starting plugin '${plugin.$id}'`);
    try {
      ...
      logger26.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
    ...
    var _loop = /* @__PURE__ */ __name(function(eventName2, cb2) {
      var unintercept = interceptFluxEvent((event) => {
        try {
          ...
          logger26.error`${id}: Error while handling ${event.type}: ${e3}`;
        }
      });
      logger26.debug(`Intercepted flux event '${eventName2}' for plugin '${id}'`);
      pluginPatcherContext.attachDisposer(() => {
        unintercept();
        logger26.debug(`Intercepted from flux event '${eventName2}' for plugin '${id}'`);
      });
    }, "_loop");
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher21 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger26.debug(`Applying ${patcher21.id} patch`);
        patcher21.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher21);
        });
      }, "apply");
      ...
      if (settings4 && pluginPatch2.predicate) {
        ...
        var unsub = settings4.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger26.debug(`Disposing ${patcher21.id} patch`);
            patcher21.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger26.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger26.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger26.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher21 = getContextualPatcher(id, false);
      if (patcher21) {
        patcher21.dispose();
        patcher21.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger26.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger26, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_utils2();
      init_flux();
      logger26 = blzlogger.createChild("PluginStore");
