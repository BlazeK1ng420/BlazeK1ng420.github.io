...
(() => {
        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger23 = new Logger2(name);
              logger23.parent = this;
              logger23.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger23;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger23) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger23.logHandlers.size > 0) {
                  for (var handler of logger23.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger23.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger23) => {
                logger23.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger23) => {
                logger23.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger23) => {
                if (logger23 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger23.logHandlers.has(handler)) {
                    logger23.logHandlers.delete(handler);
                  }
                }
              });
      ...
      en = {
        ...
        error_boundary: {
          ...
          screen: {
            ...
            description: "Something fucked up renderiing some shit. Could've been caused by Discord, or because Blaze is a skid-tard."
          }
        },
        actions: {
          nevermind: "Nevermind",
        ...
        updater: {
          ...
          new_version: "New BlazeCord version available!",
          update_now: "Update Now",
          update_and_restart: "Update & Restart",
          already_latest: "Already up to date!",
          failed_to_check: "Wow i fucked that up. Try again later~",
          error_alert: "An error occurred while checking for an update."
        },
        settings: {
          sections: {
            plugins: "Plugins",
          ...
          plugins: {
            ...
            safe_mode_callout_desc: "Only important shit will load in safe mode. (Use when shit breaks, because it will lol.)",
            info_sheet: {
              details: "Details",
              more_info: "More Info",
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher17 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher17.parent = this;
        this.children.push(patcher17);
        return patcher17;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher17);
    return patcher17;
  }
  ...
  var init_constants = __esm({
    "src/data/constants.ts"() {
      ...
      Links = {
        GITHUB: "github.com/BlazeCordMod/BlazeCord",
...
${inspect({
        ...
        patches: [
          {
            ...
            patch(_, patcher17) {
              patcher17.after(window, "sampleMethod", () => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              patcher17.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var MagnifyingGlassIcon, CirclePlusIcon, CircleMinusIcon, ArrowSmallLeftIcon, ActivitiesIcon, WrenchIcon, DownloadIcon, PaintPaletteIcon, PuzzlePieceIcon, CircleInformationIcon, CircleCheckIcon, WarningIcon;
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              patcher17.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher17) {
              patcher17.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher17.detached.after(props.header, "type", (_2, res) => {
  ...
  var init_silent_typing = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\silent-typing\\index.ts"() {
      init_shared();
      context7 = getPluginContext("silent-typing");
  ...
  var toast, settings3, silent_typing_default;
  var init_silent_typing2 = __esm({
    "src/plugins/silent-typing/index.ts"() {
      ...
      silent_typing_default = definePlugin7({
        name: "SilentTyping",
        ...
        flux: {
          TYPING_START_LOCAL: /* @__PURE__ */ __name(() => {
            if (settings3.get().silentTypingActive) return false;
            toast.show();
          }, "TYPING_START_LOCAL")
        }
      });
  ...
  var init_flux2 = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_api\\flux\\index.tsx"() {
      init_shared();
      context8 = getPluginContext("flux");
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              ...
              patcher17.attachDisposer(() => void uninject());
            }
          }
        ]
      });
  ...
  var init_settings = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_api\\settings\\index.tsx"() {
      init_shared();
      context9 = getPluginContext("settings");
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "5c11c68f781c6c58b7ed4154d3edca7c0817de5f";
      branch = "main";
...
(${discord.build})`,
  ...
  function useHighlight() {
    var context17 = (0, import_react11.useContext)(HighlightContext);
    if (!context17) {
  ...
  var init_parser = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\painter\\parser.ts"() {
      init_shared();
      context10 = getPluginContext("painter");
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger13.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var logger14, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_parser2();
      logger14 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta17 = a.asAddonMetadata();
              return meta17.name.localeCompare(meta17.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
  ...
  function AssetBrowser() {
    ...
    var assets = (0, import_react13.useMemo)(() => sortAssets(getAssets()).filter((a) => a.name.toLowerCase().includes(ref.query.toLowerCase()) || a.id.toString() === ref.query), [
      ref.query
    ]);
    return /* @__PURE__ */ jsxs(PageWrapper, {
      containerStyle: {
  ...
  var import_react13, import_react_native34, import_flash_list4, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Blaze/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetDisplay = /* @__PURE__ */ __name(({ asset, start, end }) => /* @__PURE__ */ jsx(TableRow_default, {
        ...
        trailing: /* @__PURE__ */ jsx(import_react_native34.Image, {
          source: asset.id,
          style: {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native34.useWindowDimensions)().width - 24;
        var imageSize = {
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native35.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list5, import_react_native35;
  ...
  function DemoToastComponent(props) {
    var [count, setCount] = (0, import_react14.useState)(0);
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react14.useState)({
      id: "toast-demo",
    ...
    var handleShowToast = /* @__PURE__ */ __name(() => {
      var options = {
        ...
        onDismiss() {
          logger15.info("Toast dismissed");
        },
        onPress() {
          logger15.info("Toast pressed");
        },
        onTimeout() {
          logger15.info("Toast timed out");
        }
      };
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast2 = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native36.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast2.update({
  ...
  var import_react14, import_react_native36, logger15;
  var init_ToastPlayground = __esm({
    "src/components/Blaze/Settings/pages/Developer/ToastPlayground.tsx"() {
      ...
      logger15 = blzlogger.createChild("ToastPlayground");
  ...
  function DemoAlert() {
    var [understood, setUnderstood] = (0, import_react15.useState)(false);
  ...
  function CountdownDemoAlert() {
    var [count, setCount] = (0, import_react15.useState)(0);
    var dismissModal = useDismissModalCallback();
  ...
  var import_react16, settings4, settings_default;
  var init_settings3 = __esm({
    "src/plugins/_api/settings/index.tsx"() {
      ...
      settings4 = definePluginSettings9({
        onTop: {
          label: "Put on top",
      ...
      settings_default = definePlugin9({
        name: "Settings",
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher17) {
              patcher17.after(module3, "default", (_, ret) => {
                var { props } = findInReactTree(ret, (i2) => i2.props?.sections);
                if (!props) {
                  logger12.warn("Failed to find settings sections in SettingsOverviewScreen");
                  return;
                }
                if (!settings4.get().onTop) {
                  try {
                    ...
                    logger12.warn`Failed to insert settings sections next to account section: ${e3}`;
                  }
                }
                props.sections = [
                  ..._registeredSettingSections,
          ...
          setImmediate(() => {
            registerSettingRenderer("BLAZECORD_CUSTOM_PAGE", {
              ...
              screen: {
                ...
                getComponent: memoize(() => /* @__PURE__ */ (0, import_react16.memo)(() => {
                  var navigation = NavigationNative.useNavigation();
                  var route = NavigationNative.useRoute();
                  var { render: PageComponent, ...args } = route.params;
                  (0, import_react16.useLayoutEffect)(() => void navigation.setOptions({
                    ...args
                  }), [
                    navigation
                  ]);
  ...
  var init_toasts2 = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_api\\toasts\\index.tsx"() {
      init_shared();
      context11 = getPluginContext("toasts");
  ...
  function ToastIcon({ icon }) {
    ...
    if (typeof icon === "number" || typeof icon === "object" && "uri" in icon) {
      return /* @__PURE__ */ jsx(import_react_native37.Image, {
        style: {
          width: 18,
          height: 18
        },
    ...
    if (/* @__PURE__ */ (0, import_react17.isValidElement)(icon) && typeof icon.type === "object") {
      return icon;
    }
    var Icon = icon;
  ...
  function GenericToast({ toast: toast2 }) {
    ...
    var [isMultiline, setIsMultiline] = (0, import_react17.useState)(false);
  ...
  var import_react17, import_react_native37;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_10575445024011_init_data = {
        ...
        location: "C:\\Users\\wilso\\OneDrive\\Desktop\\update-new\\silent-typing\\src\\plugins\\_api\\toasts\\components\\Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx1","translationX","translationY","__closure","transform","translateX","value","translateY"],"sources":["C:/Users/wilso/OneDrive/Desktop/update-new/silent-typing/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAwC0C,SAAAA,UAAA,QAAAC,YAAA,CAAAC,YAAA,OAAAC,SAAA,OAAK,CACnCC,SAAS,CAAE,CACP,CACIC,UAAU,CAAEJ,YAAY,CAACK,KAC7B,CAAC,CACD,CACIC,UAAU,CAAEL,YAAY,CAACI,KAC7B,CAAC,CAET,CAAC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12707892542287_init_data = {
      ...
      _worklet_2394815801719_init_data = {
        ...
        location: "C:\\Users\\wilso\\OneDrive\\Desktop\\update-new\\silent-typing\\src\\plugins\\_api\\toasts\\components\\Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx3","event","translationX","__closure","value","changeX"],"sources":["C:/Users/wilso/OneDrive/Desktop/update-new/silent-typing/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDwG,SAAAA,SAAQA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,CACxGD,YAAY,CAACE,KAAK,EAAIH,KAAK,CAACI,OAAO,CACvC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1148071943580_init_data = {
        ...
        location: "C:\\Users\\wilso\\OneDrive\\Desktop\\update-new\\silent-typing\\src\\plugins\\_api\\toasts\\components\\Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["C:/Users/wilso/OneDrive/Desktop/update-new/silent-typing/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "C:\\Users\\wilso\\OneDrive\\Desktop\\update-new\\silent-typing\\src\\plugins\\_api\\toasts\\components\\Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["C:/Users/wilso/OneDrive/Desktop/update-new/silent-typing/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1700014798715_init_data = {
        ...
        location: "C:\\Users\\wilso\\OneDrive\\Desktop\\update-new\\silent-typing\\src\\plugins\\_api\\toasts\\components\\Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx8","finished","runOnJS","onceOnDismiss","__closure"],"sources":["C:/Users/wilso/OneDrive/Desktop/update-new/silent-typing/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAuEuE,SAAAA,UAAQC,QAAG,QAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CACtE,GAAIH,QAAQ,CAAE,CACVC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
      Toast_default = /* @__PURE__ */ (0, import_react18.memo)(/* @__PURE__ */ __name(function Toast({
        toast: toast2
      }) {
        var styles = useStyles4();
        var {
          width
        } = (0, import_react_native38.useWindowDimensions)();
        ...
        var onceOnDismiss = (0, import_react18.useCallback)(() => {
          toast2.onDismiss?.();
          hideToast(toast2.id);
        }, [hideToast, toast2]);
        ...
        return /* @__PURE__ */ jsx(import_react_native_gesture_handler.GestureDetector, {
          ...
          children: /* @__PURE__ */ jsx(import_react_native_reanimated2.default.View, {
            ...
            children: /* @__PURE__ */ jsx(PressableScale_default, {
              ...
              children: /* @__PURE__ */ jsx(import_react_native_reanimated2.default.View, {
                layout: import_react_native_reanimated2.LinearTransition.springify(500).dampingRatio(0.5),
                style: [animatedStyles, styles.container, toast2.contentContainerStyle],
  ...
  function ToastContainer() {
    ...
    return /* @__PURE__ */ jsx(import_react_native39.View, {
      style: {
        marginTop,
        gap: 4
      },
  ...
  var import_react_native39, isDiscordToastActive;
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              patcher17.after(module3, "type", (_, res) => {
    ...
    return /* @__PURE__ */ jsxs(import_react_native40.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native40.Image, {
            resizeMode: "contain",
  ...
  function ErrorComponentStackCard(props) {
    var [collapsed, setCollapsed] = (0, import_react19.useState)(true);
    var stack;
    try {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native41.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native41.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native41.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react19, import_react_native41;
  ...
  function ErrorStackCard(props) {
    var [collapsed, setCollapsed] = (0, import_react20.useState)(true);
    var stack;
    try {
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react20.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native42.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
    ...
    return /* @__PURE__ */ jsx(SafeAreaProvider, {
      children: /* @__PURE__ */ jsxs(SafeAreaView, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(import_react_native43.ScrollView, {
            fadingEdgeLength: 64,
            contentContainerStyle: {
              gap: 12
            },
  ...
  var import_react_native43, useStyles5;
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              patcher17.after(module3.prototype, "render", function() {
                var { state: { error } } = this;
                if (!error) return null;
                logger17.error(error.stack);
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src\\plugins\\_core\\no-track\\index.ts"() {
      init_shared();
      context13 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin13({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher17) {
              patcher17.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher17) {
              patcher17.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher16.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher16.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher15.before(isThemeModule, "isThemeDark", callback);
    patcher15.before(isThemeModule, "isThemeLight", callback);
    patcher15.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher15.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin14({
        name: "Painter",
  ...
  // plugins-importer:C:\Users\wilso\OneDrive\Desktop\update-new\silent-typing\src/plugins
  var plugins_exports = {};
  __export(plugins_exports, {
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger22.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger22.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger22.warn(`${plugin.$id} already started`);
      return;
    }
    logger22.debug(`Starting plugin '${plugin.$id}'`);
    try {
      ...
      logger22.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
    ...
    var _loop = /* @__PURE__ */ __name(function(eventName2, cb2) {
      var unintercept = interceptFluxEvent((event) => {
        try {
          ...
          logger22.error`${id}: Error while handling ${event.type}: ${e3}`;
        }
      });
      logger22.debug(`Intercepted flux event '${eventName2}' for plugin '${id}'`);
      pluginPatcherContext.attachDisposer(() => {
        unintercept();
        logger22.debug(`Intercepted from flux event '${eventName2}' for plugin '${id}'`);
      });
    }, "_loop");
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher17 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger22.debug(`Applying ${patcher17.id} patch`);
        patcher17.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher17);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger22.debug(`Disposing ${patcher17.id} patch`);
            patcher17.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger22.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger22.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger22.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher17 = getContextualPatcher(id, false);
      if (patcher17) {
        patcher17.dispose();
        patcher17.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger22.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger22, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_utils2();
      init_flux();
      logger22 = blzlogger.createChild("PluginStore");
