...
(() => {
        ...
        _create_class(Logger2, [
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function createChild(name) {
              var logger28 = new Logger2(name);
              logger28.parent = this;
              logger28.breadcrumbs = [
                ...this.breadcrumbs,
                name
              ];
              return logger28;
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function log(level, message, ...substitutions) {
              ...
              this.executeOnSelfAndAncestors((logger28) => {
                var logParameters = {
                  message,
                  level,
                  timestamp: Date.now(),
                ...
                if (logger28.logHandlers.size > 0) {
                  for (var handler of logger28.logHandlers) {
                    handler(logParameters);
                  }
                }
                logger28.logs.push(logParameters);
              });
            }, "log")
          },
          {
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function pipe(logHandler) {
              this.executeOnSelfAndAncestors((logger28) => {
                logger28.logHandlers.add(logHandler);
              });
          ...
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipe(logHandler) {
              this.executeOnSelfAndAncestors((logger28) => {
                logger28.logHandlers.delete(logHandler);
              });
            }, "unpipe")
          },
          {
            ...
            value: /* @__PURE__ */ __name(function unpipeAll() {
              this.executeOnSelfAndAncestors((logger28) => {
                if (logger28 === this) return;
                for (var handler of this.logHandlers) {
                  if (logger28.logHandlers.has(handler)) {
                    logger28.logHandlers.delete(handler);
                  }
                }
              });
  ...
  // src/metro/common/libraries/React.ts
  var React_exports = {};
  ...
  var React3, ReactNative2, AssetsRegistry;
  var init_React = __esm({
    "src/metro/common/libraries/React.ts"() {
      "use strict";
      init_wrappers();
  ...
  var semver, chroma, Reanimated2, NavigationNative;
...
${log.errorStack}`;
  ...
  function useHighlight() {
    var context22 = (0, import_react14.useContext)(HighlightContext);
    if (!context22) {
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_10575445024011_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx1","translationX","translationY","__closure","transform","translateX","value","translateY"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAwC0C,SAAAA,UAAA,QAAAC,YAAA,CAAAC,YAAA,OAAAC,SAAA,OAAK,CACnCC,SAAS,CAAE,CACP,CACIC,UAAU,CAAEJ,YAAY,CAACK,KAC7B,CAAC,CACD,CACIC,UAAU,CAAEL,YAAY,CAACI,KAC7B,CAAC,CAET,CAAC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12707892542287_init_data = {
      ...
      _worklet_2394815801719_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx3","event","translationX","__closure","value","changeX"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDwG,SAAAA,SAAQA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,CACxGD,YAAY,CAACE,KAAK,EAAIH,KAAK,CAACI,OAAO,CACvC","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1148071943580_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_12633554293434_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx5","finished","willDisappear","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AA+D8D,SAAAA,UAAQC,QAAG,QAAAC,aAAA,CAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CAC7D,GAAIJ,QAAQ,EAAIC,aAAa,CAAE,CAC3BC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "3.17.4"
      };
      _worklet_1700014798715_init_data = {
        ...
        location: "/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx8","finished","runOnJS","onceOnDismiss","__closure"],"sources":["/home/blaze/coding/blazecord_new/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAuEuE,SAAAA,UAAQC,QAAG,QAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CACtE,GAAIH,QAAQ,CAAE,CACVC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "3.17.4"
      };
  ...
  var byStoreName, UserStore, SelectedUserStore, ChannelStore, GuildStore, SelectedGuildStore, DeveloperExperimentStore, ToastStore, PermissionStore, EmojiStore, ThemeStore;
  var init_stores = __esm({
    "src/metro/common/stores.ts"() {
      ...
      SelectedUserStore = getStore("SelectedUserStore", (m2) => SelectableUserStore = m2);
      ChannelStore = getStore("ChannelStore", (m2) => ChannelStore = m2);
      GuildStore = getStore("GuildStore", (m2) => GuildStore = m2);
      SelectedGuildStore = getStore("SelectedGuildStore", (m2) => SelectableUserStore = m2);
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3, "type", (_, res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              ...
              patcher22.attachDisposer(() => void uninject());
            }
          }
        ]
      });
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "ca7ce0b7f8480677ddbcc7589569d85039457078";
      branch = "flux";
...
(${discord.build})`,
      ...
      settings_default = definePlugin3({
        ...
        patches: [
          ...
          },
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3, "default", (_, ret) => {
  ...
  var toast, settings, silent_typing_default;
  var init_silent_typing2 = __esm({
    "src/plugins/silent-typing/index.ts"() {
      ...
      settings = definePluginSettings4({
        silentTypingActive: {
          label: "Silent Typing",
  ...
  var init_dummy2 = __esm({
    "src/plugins/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings2 = definePluginSettings5({
        bunnyName: {
          type: "string",
          label: "Bunny Name",
        ...
        patches: [
          {
            ...
            patch(_, patcher22) {
              patcher22.after(window, "sampleMethod", () => {
  ...
  var init_nitro_emojis = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-emojis/index.ts"() {
      init_shared();
      context6 = getPluginContext("nitro-emojis");
  ...
  function patchRealmoji(module3, patcher22, getSetting) {
    var { getCustomEmojiById } = getStore("EmojiStore");
    patcher22.before(module3.prototype, "generate", ([data]) => {
    ...
    patcher22.after(module3.prototype, "generate", ([data], row) => {
      if (!getSetting()) return;
  ...
  var init_nitro_emojis2 = __esm({
    "src/plugins/nitro-emojis/index.ts"() {
      ...
      haveNitro = false;
      nitro_emojis_default = definePlugin6({
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.instead(module3, "canUseEmojisEverywhere", () => true);
              patcher22.instead(module3, "canUseAnimatedEmojis", () => true);
            }
          },
          {
            id: "hook-message",
            ...
            patch(module3, patcher22) {
              patcher22.before(module3, "sendMessage", ([, msg]) => {
          ...
          },
          {
            ...
            patch(module3, patcher22) {
              patcher22.before(module3, "uploadLocalFiles", ([uploadArgs]) => {
                haveNitro = getStore("UserStore").getCurrentUser()?.premiumType != null;
          ...
          },
          {
            ...
            patch(module3, patcher22) {
              patchRealmoji(module3, patcher22, () => settings3.get().realshit);
            }
          }
        ],
        start() {
  ...
  var init_openEmojiActionSheet = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/utils/openEmojiActionSheet.tsx"() {
      init_shared();
      context8 = getPluginContext("expression-utils");
  ...
  var init_expression_utils2 = __esm({
    "src/plugins/expression-utils/index.tsx"() {
      ...
      expression_utils_default = definePlugin7({
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3, "default", ([{ emojiNode }], res) => {
                if (!emojiNode) return;
          ...
          },
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher22.detached.after(props.header, "type", (_2, res) => {
  ...
  var init_devtoolkit = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/devtoolkit/index.ts"() {
      init_shared();
      context9 = getPluginContext("devtoolkit");
  ...
  var init_devtoolkit2 = __esm({
    "src/plugins/devtoolkit/index.ts"() {
      ...
      init_node_inspect_extracted();
      init_repl_client();
      devtoolkit_default = definePlugin9({
        name: "DevToolkit",
        ...
        start() {
          ...
          Object.assign(window, {
            ...
            dk: {
              patcher: patcher9,
              snipe(mod, prop) {
                patcher9.after(mod, prop, (args, ret) => {
...
${inspect({
  ...
  var init_nitro_icons = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-icons/index.ts"() {
      init_shared();
      context10 = getPluginContext("nitro-icons");
  ...
  var init_nitro_icons2 = __esm({
    "src/plugins/nitro-icons/index.ts"() {
      ...
      init_toasts();
      init_constants();
      nitro_icons_default = definePlugin10({
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              ...
              patcher22.instead(module3, "getIcons", () => mainIcons);
              patcher22.instead(module3, "getOfficialAlternateIcons", () => altIcons);
              patcher22.after(module3, "getIconById", (_args, ret) => {
                ret.isPremium = false;
                return ret;
              });
            }
  ...
  var init_nitro_themes = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/nitro-themes/index.ts"() {
      init_shared();
      context11 = getPluginContext("nitro-themes");
  ...
  var init_nitro_themes2 = __esm({
    "src/plugins/nitro-themes/index.ts"() {
      ...
      init_stores();
      init_constants();
      nitro_themes_default = definePlugin11({
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              ...
              patcher22.instead(module3, "setShouldSyncAppearanceSettings", () => false);
            }
          },
          {
            ...
            patch(module3, patcher22) {
              patcher22.instead(module3, "canUseClientThemes", () => true);
            }
          },
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3, "getUserExperimentDescriptor", ([expName], res) => {
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.instead(module3, "isStaffEnv", ([user]) => {
  ...
  var init_chat_bubbles2 = __esm({
    "src/plugins/chat-bubbles/index.ts"() {
      ...
      chat_bubbles_default = definePlugin13({
        name: "ChatBubbles",
        description: "Adds custom message bubbles & avatars in chats.",
        authors: [
          Devs.Blaze
        ],
        start() {
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.after(module3.prototype, "render", function() {
  ...
  function patchChatBackground() {
    patcher16.after(Messages, "render", (_, ret) => {
  ...
  var init_wallpapers2 = __esm({
    "src/plugins/_core/wallpapers/index.ts"() {
      ...
      init_constants();
      init_background2();
      wallpapers_default = definePlugin15({
        name: "Wallpapers",
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context17 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin17({
        name: "NoTrack",
        ...
        patches: [
          {
            ...
            patch(module3, patcher22) {
              patcher22.instead(module3, "initSentry", () => void 0);
            }
          },
          {
            id: "no-tracker",
            ...
            patch(module3, patcher22) {
              patcher22.instead(module3, "track", () => Promise.resolve());
            }
          }
        ]
      });
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher20.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher20.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver(tokensModule2) {
    ...
    patcher19.before(isThemeModule, "isThemeDark", callback);
    patcher19.before(isThemeModule, "isThemeLight", callback);
    patcher19.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher19.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin18({
        name: "Painter",
  ...
  // plugins-importer:/home/blaze/coding/blazecord_new/src/plugins
  var plugins_exports = {};
  __export(plugins_exports, {
  ...
  function startPlugin(draft, id) {
    ...
    if (isSafeModeEnabled() && !plugin.required) {
      logger25.info(`Plugin ${plugin.$id} is not required and safe mode is enabled, skipping`);
      return;
    }
    if (plugin.isAvailable?.() === false) {
      logger25.warn(`Plugin ${plugin.$id} is not available, skipping`);
      return;
    }
    if (draft.states[id].running) {
      logger25.warn(`${plugin.$id} already started`);
      return;
    }
    logger25.debug(`Starting plugin '${plugin.$id}'`);
    try {
      ...
      logger25.error`Failed to start ${plugin.$id}: ${e3}`;
      return;
    }
    return;
  }
    ...
    var _loop = /* @__PURE__ */ __name(function(eventName2, cb2) {
      var unintercept = interceptFluxEventType(eventName2, (event) => {
        try {
          ...
          logger25.error`${id}: Error while handling ${event.type}: ${e3}`;
        }
      });
      logger25.debug(`Intercepted flux event '${eventName2}' for plugin '${id}'`);
      pluginPatcherContext.attachDisposer(() => {
        unintercept();
        logger25.debug(`Unintercepted from flux event '${eventName2}' for plugin '${id}'`);
      });
    }, "_loop");
  ...
  function applyPluginPatches(id, plugin, pluginPatcherContext) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      var patcher22 = pluginPatcherContext.createChild({
        id: pluginPatch2.id ?? pluginPatch2.target.key
      });
      var apply = /* @__PURE__ */ __name(() => {
        logger25.debug(`Applying ${patcher22.id} patch`);
        patcher22.reuse();
        waitFor(pluginPatch2.target, (module3) => {
          pluginPatch2.patch(module3, patcher22);
        });
      }, "apply");
      ...
      if (settings5 && pluginPatch2.predicate) {
        ...
        var unsub = settings5.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger25.debug(`Disposing ${patcher22.id} patch`);
            patcher22.dispose();
          }
        }, {
  ...
  function cleanupPlugin(draft, id) {
    var plugin = PLUGINS[id];
    if (plugin.required) {
      logger25.warn(`Cannot stop required plugin '${plugin.$id}'`);
      if (true) throw new Error(`Cannot stop required plugin '${plugin.$id}'`);
      return;
    }
    if (!draft.states[id].running) {
      logger25.warn(`${plugin.$id} already stopped`);
      return;
    }
    logger25.info(`Cleaning up plugin ${plugin.$id}`);
    try {
      var patcher22 = getContextualPatcher(id, false);
      if (patcher22) {
        patcher22.dispose();
        patcher22.children.length = 0;
      }
      plugin.cleanup?.();
    } catch (e3) {
      logger25.error(`Failed to cleanup ${plugin.$id}: ${e3}`);
      return;
    }
  ...
  var logger25, PLUGINS, usePluginStore, usePluginStore_default;
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_utils2();
      init_flux();
      logger25 = blzlogger.createChild("PluginStore");
  ...
  function createContextualPatcher({ id }) {
    ...
    var contextualPatcher = {
      ...
      createChild(options) {
        var patcher22 = createContextualPatcher({
          ...options,
          id: `${id}/${options.id}`
        });
        patcher22.parent = this;
        this.children.push(patcher22);
        return patcher22;
      }
    };
  ...
  function getContextualPatcher(id, create2 = true) {
    ...
    patcherRegistry.set(id, patcher22);
    return patcher22;
  }
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger26.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  var logger27, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      init_solar_bloom();
      init_aurora_violet();
      logger27 = blzlogger.createChild("ThemeStore");
        ...
        sortOptions: [
          {
            ...
            label: /* @__PURE__ */ __name(() => "A-Z", "label"),
            compareFn: /* @__PURE__ */ __name((a, b) => {
              var meta22 = a.asAddonMetadata();
              return meta22.name.localeCompare(meta22.name);
            }, "compareFn")
          },
          {
            key: "Z-A",
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "metro/common/libraries/React": createModuleProxy(() => (init_React(), __toCommonJS(React_exports))),
